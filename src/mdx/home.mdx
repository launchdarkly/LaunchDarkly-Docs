---
path: '/quickstart'
breadcrumbs: [{ label: 'Documentation', path: '/' }, { label: 'Quickstart', path: '/' }]
---
...
<Frontmatter timeToRead={props.timeToRead} lastModifiedDateFormatted={props.lastModifiedDateFormatted} />

Welcome to LaunchDarkly! We're excited to partner with you as you use feature flags to make high-impact changes with
