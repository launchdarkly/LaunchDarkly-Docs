...
import { jsx, ThemeProvider, Styled, Layout } from 'theme-ui'
import {
  Box,
  Flex,
  Grid,
              ...
              <Box>
                <Flex>
                  <Image
                    variant="icon"
                    sx={{ marginRight: 2 }}
                    src="https://75oio.csb.app/toggles-multiple-solid.svg"
                  />
          ...
          <Flex sx={{ flexDirection: 'column' }}>
            ...
            >
              <Box>
                ...
                <Styled.p>
                  Welcome to LaunchDarkly! We're excited to partner with you as you use feature flags to make
                  high-impact changes with minimal risk and maximum control. It only takes a few minutes to get started
                  with LaunchDarkly and control your first feature flag.
                </Styled.p>
                <Card>
                ...
                <Styled.p>
                  ...
                  <Styled.ol>
                    <Styled.li>
                      Install the LaunchDarkly SDK in your application using your project's dependency manager. This
                      lets your application access the LaunchDarkly SDK.
                    </Styled.li>
                    <Styled.li>
                    ...
                    <Styled.li>
                      ...
                      client. Your SDK key, Client-side ID, and Mobile key uniquely identify your project and
                      environment, and they authorize your application to connect to LaunchDarkly.
                    </Styled.li>
                  </Styled.ol>
                </Styled.p>
                ...
                <Styled.p>
                  If the SDK you're using loses the connection with LaunchDarkly, your feature flags will still work.
                  The SDK relies on its stored state to evaluate flags.
                </Styled.p>
              </Box>
            </Box>
          </Flex>
