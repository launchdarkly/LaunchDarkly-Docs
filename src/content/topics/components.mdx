...
The docs site supports PNGs and GIFs. Just use Markdown images:

```
![Here is helpful alt text. Always use this--it's kind to folks with accessibility requirements.](path/to/image.png)
```
