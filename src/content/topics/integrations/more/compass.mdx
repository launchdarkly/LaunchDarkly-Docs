...
8. Enter your LaunchDarkly API access token in the **Access token** field.
9. Click **Submit**.
...
Verify that the component was successfully disconnected by clicking on the **LaunchDarkly** tab in the left navigation. You should no longer see feature flag information on this tab.
