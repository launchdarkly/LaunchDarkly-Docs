...
2. Generate a LaunchDarkly [API access token](/home/account-security/api-access-tokens) for use with Compass.
* Create a token with the **Reader** role.
* If you are on an Enterprise plan, check the **This is a service token** option when creating your acesss token.
* If you are on a Pro plan, leave this option unchecked.
* Be sure to copy the new token to your clipboard.
...
2. Go to your Atlassian Compass site, e.g. https://mysite.atlassian.net/compass.
...
1. Navigate to your Compass site, e.g. https://mysite.atlassian.net/compass
2. Navigate to the Compass component you want to connect to LaunchDarkly.
...
The Compass integration stores your LaunchDarkly API access token (as described in the [Setting up the Compass integration](#setting-up-the-compass-integration)) section) to read data from the LaunchDarkly API. If you need to cycle your LaunchDarkly access token, or if you want to connect Compass to a different LaunchDarkly organization, you can disconnect your access token.

1. Go to your Atlassian Compass site, e.g. https://mysite.atlassian.net/compass.
2. In the top nagivation, click the **Apps** link.
3. Find **LaunchDarkly** in the list of apps and click the **Configure** button.
4. Click the **Disconnect access token** button.
...
1. Go to your Atlassian Compass site, e.g. https://mysite.atlassian.net/compass.
2. In the top nagivation, click the **Apps** link.
3. Find **LaunchDarkly** in the list of apps and click the **Uninstall** button.
