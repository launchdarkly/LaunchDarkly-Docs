...
Currently, this integration only supports boolean flag types. To learn more, read [Understanding flag types](/home/flags/variations#understanding-flag-types).
