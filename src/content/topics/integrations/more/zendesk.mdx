...
4. Enter a "Field title" shown to agents and a "Field key" in the "Properties" panel. These can be anything you want, but they should be descriptive enough for your agents to recognize them as LaunchDarkly user keys. Save the field key for the next section.
...
Unless the user is new or inactive, you may have entered an incorrect value in the **User key** field. You can find user keys on the Users dashboard in the **Key** column. To learn more, read [The Users dashboard](/home/managing-users/users-dashboard).
