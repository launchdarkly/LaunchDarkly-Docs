...
```
 ...
 To learn more about bootstrapping client side feature flags from the server, read [Bootstrapping from the server](/guides/flags/static-sites#bootstrapping-from-the-server).
