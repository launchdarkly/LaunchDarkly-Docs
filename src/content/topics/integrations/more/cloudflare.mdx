...
You must install and configure the Cloudflare SDK in your Cloudflare Worker to use this integration. To learn more, read [Cloudflare SDK](/sdk/server-side/cloudflare).
...
You can evaluate flags using the flag data that is set up to write to your Worker KV using the [Cloudflare SDK](/sdk/server-side/cloudflare).
