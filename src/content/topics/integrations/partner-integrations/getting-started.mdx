...
1. [Forking the LaunchDarkly Integration Framework repository](#fork-the-launchdarkly-integration-framework-repository)
2. [Creating a new directory](#create-a-new-directory)
3. [Creating an integration manifest](#create-an-integration-manifest)
4. [Collecting integration configuration data](#collect-integration-configuration-data)
5. [Defining the integration's capabilities](#define-the-integrations-capabilities)
6. [Validating the integration](#validate-the-integration)
7. [Creating end-user documentation and README](#create-end-user-documentation-and-readme)
8. [Submitting the integration](#submit-the-integration)
...
After you finish building your integration, you will submit a pull request to LaunchDarkly to have it approved and deployed. To learn more about submitting a pull request, read [Submit the integration](#submit-the-integration).
