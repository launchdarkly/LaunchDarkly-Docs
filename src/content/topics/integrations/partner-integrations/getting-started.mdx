...
7. [Creating integration user documentation and README](#7-create-your-integration-user-documentation-and-readme)
...
### 7. Create your integration user documentation and README
