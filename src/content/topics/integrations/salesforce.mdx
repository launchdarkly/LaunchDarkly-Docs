...
2. In Salesforce, click the **nine dots in a square** icon to open the app launcher.
3. Search for and select **LaunchDarkly settings**.

![The search bar in the App Launcher.](../images/salesforce-search-launchdarkly-settings.png)

4. Click **Edit**. A text field appears.
5. Enter your LaunchDarkly service token in the text field and click **Save**.


![A service token entered into the LaunchDarkly settings tab.](../images/salesforce-launchdarkly-settings.png)
...
7. Click the **nine dots in a square** icon and choose **Service**.
