...
8. Nagivate out of **Setup** by clicking the “nine dots in a square” icon on top-left and then selecting **Service**. Go to **Case** and either create a new case or select an existing case and view.
