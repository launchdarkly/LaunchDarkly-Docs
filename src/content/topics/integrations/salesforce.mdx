...
6. Return to the Salesforce custom metadata form and create a new **LaunchDarkly Settings** custom metadata record with a **Label** and **LaunchDarkly Settings Name** of "Default" and the **Service Token** from step 13, above.
