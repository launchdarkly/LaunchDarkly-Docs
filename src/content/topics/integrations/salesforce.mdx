...
The LaunchDarkly Salesforce integration gives you and your account members a read-only view of your feature flags. You can see the flag variations LaunchDarkly serves to your customers without leaving Salesforce. This is useful for customer success and support teams working with customers to debug issues or access new features.
