...
If you are unsure what the **Key** field should look like, visit the **Users** list in LaunchDarkly and inspect the **Key** column. To learn more, read [The Users dashboard](/home/managing-users/users-dashboard).
