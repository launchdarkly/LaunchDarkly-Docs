...
5. at 10.29.02 AM.png",
   ...
   [/block]
6. Click **Revoke**. A confirmation screen appears.
7. Review the impact of revoking the app. and type "yes" to confirm if you still wish to revoke the app.
