...
<Callout intent="alert">
  ...
  <CalloutDescription>
    You cannot associate rollouts with collections that are not the default, otherwise the rollout won't be able to find the collection.
  </CalloutDescription>
</Callout> 
...
2. Enter the **launchdarkly-account-name**. This stands for the account name of the Azure DevOps account.
3. Enter the **launchdarkly-project-name**. This stands for the project name of the Azure DevOps project.
