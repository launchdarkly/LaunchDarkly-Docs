...
![SignalFx with a LaunchDarkly event](../../images/signalfx-marker-1.png)
...
![SignalFx integration configuration](../../images/signalfx-ld-config.png)
...
![SignalFx with LaunchDarkly event details](../../images/signalfx-marker-2.png)
