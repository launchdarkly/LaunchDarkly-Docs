...
If you use Jira Cloud, you may use other Atlassian products. You can also set up integrations for those. To learn more, read about the LaunchDarkly integrations with [Compass](/integrations/compass), [Confluence](/integrations/confluence), and [Trello](/integrations/trello).
...
You can use JQL to query for Jira issues that are connected to feature flags. To learn more about JQL, read [Atlassian's documentation](https://support.atlassian.com/jira-work-management/docs/advanced-search-reference-jql-developer-status/).
