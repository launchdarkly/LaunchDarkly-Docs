...
JQL can be used to query for Jira issues that are connected to feature flags. To learn more about JQL, read [Atlassian's documentation](https://support.atlassian.com/jira-work-management/docs/advanced-search-reference-jql-developer-status/).
