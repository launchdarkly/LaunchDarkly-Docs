...
To remove a flag from a Jira issues:

1. Navigate to your Jira issue's Releases panel.
2. In the pop up modal select the name of your feature flag. This will take you to the LaunchDarkly feature flag page.
3. Click on the **settings** tab to access the flag settings page
4. Navigate to the `Jira Issues` panel under custom properties
5. Click the X on the top right to remove the Jira issues custom property
   ![The Jira issues custom properties field with delete custom property shown](jira-delete-custom-properties.png)
6. Click **Save with comment**
