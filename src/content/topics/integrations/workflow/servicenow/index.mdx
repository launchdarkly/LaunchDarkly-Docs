...
This topic explains how to configure and use the ServiceNow approvals integration for use with LaunchDarkly's approval workflows. To learn more, read [Approvals](/home/feature-workflows/approvals).
