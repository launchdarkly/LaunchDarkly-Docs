...
3. Click **enable** in the LaunchDarkly card in the **Flags** tab.
...
![A successfully connected LaunchDarkly integration card in Sleuth.](sleuth-ld-integration-success-dialog_3.png)
...
1. Navigate to the Integrations page in Sleuth and find the LaunchDarkly integration card in the **Flags** tab.
2. Click **Add feature flags**.

![The LaunchDarkly integration card in Sleuth.](sleuth-ld-integration-success-dialog_3.png)
