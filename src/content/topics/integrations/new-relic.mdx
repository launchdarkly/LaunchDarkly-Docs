...
<Callout intent="alert">
  ...
  <CalloutDescription>
    ...
    We have deprecated this integration. You can use it with the Java SDK in versions before 5.0. Support for this integration was removed in the 5.0 release of the Java SDK.<br/><br/> 
