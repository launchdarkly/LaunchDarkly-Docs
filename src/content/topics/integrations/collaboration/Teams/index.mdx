...
To access the Help menu, open a chat window with LaunchDarkly and type `help` in the text bar and press **Enter**. The LaunchDarkly help menu will appears with a list of available options.
