...
To access the Help menu, open a chat window with LaunchDarkly, type "help" in the text bar, and press **Enter**. The LaunchDarkly help menu appears with a list of available options.
