...
1. In Microsoft Teams, navigate to "Apps" on the left-hand side of the screen.
2. Search for the LaunchDarkly app and click **Add**. After installing the LaunchDarkly app, you are prompted to connect your LaunchDarkly account. 
...
6. Type the provided authentication code into Microsoft Teams in a chat window with LaunchDarkly.
   ...
   ![An authorization code message from LaunchDarkly.](teams-ld-authorization-code.png)

7. Press **Enter**.

   ![The authentication code screen in Microsoft Teams.](teams-ld-enter-auth-code.png)
