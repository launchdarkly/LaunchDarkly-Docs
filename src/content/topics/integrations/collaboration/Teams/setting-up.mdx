...
4. After installing the LaunchDarkly app, you will be prompted to connect your LaunchDarkly account. Click **Sign in** to connect your LaunchDarkly account to Microsoft Teams.
   ...
   ![Signing into the LaunchDarkly app in Microsoft Teams.](teams-ld-app-signin.png)
...
6. LaunchDarkly will display a message that the Microsoft Teams app would like permission to access your LaunchDarkly account. Click **Authorize** to grant access.
   ...
   ![The permissions authorization dialog](teams-ld-authorize.png)

7. To finish linking your account, LaunchDarkly will then display an authenticate code.

   ![Authorization code from LaunchDarkly](teams-ld-authorization-code.png)

8. Type the provided authentication code into Microsoft Teams in a chat window with LaunchDarkly. Press **Enter** to complete the authentication process.

   ![Entering the authentication code into Microsoft Teams](teams-ld-enter-auth-code.png)

9. The LaunchDarkly application will display a success message. You can now use the LaunchDarkly app in Microsoft Teams.

   ![Success message from LaunchDarkly](teams-ld-success.png)
...
![Disconnecting your LaunchDarkly account from Microsoft Teams](teams-ld-logout-message.png)
