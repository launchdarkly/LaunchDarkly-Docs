...
The Microsoft Teams integration sends you alerts when the LaunchDarkly resources you care about, such as feature flags, projects, and account members, change. This notification appears in your Teams space.
...
2. Paste your **Incoming webhook URL** into the field.
...
![The "Create Microsoft Teams configuration" panel.](ms-teams-ld-integration-config.png)
