...
2. Type `/launchdarkly subscribe` in your Slack client's text bar and press **Enter**. The filter modal appears.
...
4. Select **Remove flag from channel** in the dropdown menu beside the name of the flag.
