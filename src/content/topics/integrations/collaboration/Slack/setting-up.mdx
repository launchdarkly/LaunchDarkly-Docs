...
You can now use the LaunchDarkly Slack app. The Slack app configuration appears in the "Slack App" section of the Integrations dashboard.

![The "Slack App" section of the Integrations dashboard.](slack-integration-card.png)
