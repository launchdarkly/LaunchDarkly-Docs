...
4. Use the dropdown menus to specify filtering criteria and click **Filter**.
5. Subscribe to any flags by selecting "Add flag to channel" from the dropdown.
6. Subscribe to all the flags from this filter by clicking **Add filter to channel**.
...
You can also use in-line commands to filter for flags and resources in Slack. All in-line commands start with `/launchdarkly` and typing `/launchdarkly` or `/ld` will bring up a help menu listing the commands.
...
You can view more detail about any flag with the Flag Overview message. The Flag Overview message is available from the list of filtered flags and any flag update notification by clicking **View details**.
