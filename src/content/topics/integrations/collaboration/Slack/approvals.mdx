...
2. Request approval for your changes by clicking the **dropdown icon** on the **Review and save** button and choosing **Request approval**. For more details, read [Requesting approvals](/home/feature-workflows/approvals#requesting-approvals).
