...
To use this feature, you must have installed and configured the LaunchDarkly Slack app. To learn more, read [Setting up the Slack app](/integrations/slack/setting-up#setting-up-the-slack-app).
