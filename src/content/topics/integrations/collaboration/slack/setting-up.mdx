...
3. Review the permissions required and click **Authorize**.

![The permissions authorization dialog.](slack-ld-authorize.png)

A confirmation dialog appears in your browser and the Slack app's username appears in the **Apps** section of your Slack client. You can now use the LaunchDarkly Slack app. The Slack app configuration appears in the "Slack App" section of the **Integrations** list.
