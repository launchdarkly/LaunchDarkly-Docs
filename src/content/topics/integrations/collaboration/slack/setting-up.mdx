...
When you call the LaunchDarkly Slack app for the first time you will be prompted to log in to your LaunchDarkly account and authorize the Slack app. To sign in to the LaunchDarkly Slack app:
