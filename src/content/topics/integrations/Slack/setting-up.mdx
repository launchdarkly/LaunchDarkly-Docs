...
![Signing into the LaunchDarkly Slack App.](../../images/slack-ld-connect.png)


4. Review the permissions required and click **Authorize** to authorize the Slack app.

![The permissions authorization screen](../../images/slack-ld-authorize.png)
...
![The Slack app under Webhooks on the Integrations dashboard.](../../images/integrations-webhooks-slack-app.png)
...
![An example of an account associated with the Slack app.](../../images/slack-ld-add-account.png)
...
To learn more about member permissions, read [Understanding Member Roles](/home/team/managing#understanding-member-roles).

![The Slack app, with limited permissions.](../../images/slack-ld-reader-authorization.png)
...
![The Slack app, displaying a webhook error.](../../images/slack-ld-failed-subscribe.png)
