...
This topic explains how to subscribe to flag notifications in Slack channels. You can receive notifications for when flags are created, updating, deleted, or ready for removal.
...
For more information about filter-based notifications, read [Managing flags with the Slack app](/integrations/slack/managing).
...
For more information about filtering flags, read [Viewing, monitoring, and subscribing to flags](/integrations/slack/managing).
...
Read about [deleting and archiving flags](https://docs.launchdarkly.com/home/managing-flags/flag-archive-delete) to learn how to keep your codebase clean. The Slack app makes it easy to receive notifications once flags are ready to remove.
...
1. Open the channel where you want to get notifcations on flags that are ready to remove.
2. Type `/launchdarkly susbcribe`and press **Enter**. The filter modal appears.
3. Filter on the flag, project, environment, or tags where you want to be notified when flags have become "inactive" or "launched".
...
7. You'll see a notification that your selections, along with the Action "ready for removal" has been added to the channel.
