...
For more information about filter-based notifications, read [Managing flags with the Slack app](/integrations/slack/managing-flags).
...
For more information about filtering flags, read [Viewing, monitoring, and subscribing to flags](/integrations/slack/managing-flags).
