...
description: 'This topic explains how to view and filter flags with the LaunchDarkly Slack app.'
published: true
---
...
You can use the four types of optional filters in any combination to view different flags. If you click **Filter** without specifying any of the fields, you'll be subscribing to changes in all flags. 
...
When you filter, the results appear in your Slack channel or DM. You can use the filter results to perform different actions.
