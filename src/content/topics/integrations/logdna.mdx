...
![The LogDNA UI with LaunchDarkly events.](../../images/logdna-events-no-details.png)
...
1. Navigate to the [Integrations](https://app.launchdarkly.com/default/integrations) page.
2. Click to expand the LogDNA card.
3. Click **+ Integration**.

![The LaunchDarkly LogDNA integration card.](../../images/logdna-card.png)
...
8. Click **Save LogDNA Configuration**.
...
The _Policy_ configuration field lets you control which kinds of events LaunchDarkly sends to LogDNA.
...
![The LogDNA UI with LaunchDarkly event details.](../../images/logdna-event-details.png)
