...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        This event type details about a user used in feature evaluation for a particular user key. This event kind is
        not available for Segment or mParticle destinations.
      </TableCell>
    </TableRow>
    <TableRow>
...
If a feature event was generated through a "variation detail" method, the event will have a `reason` property with the JSON representation of the [evaluation reason](/home/advanced/flag-evaluations).
