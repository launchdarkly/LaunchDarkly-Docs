...
If a feature event was generated through a "variation detail" method, the event will have a `reason` property with the JSON representation of the [evaluation reason](/sdk/concepts/flag-evaluations).
