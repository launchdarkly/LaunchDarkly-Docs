...
below may not appear identically in those integrations' UI. The `index`, `identify`, and `data` event types are **not available** in Segment or mParticle data export destinations. To learn more about mParticle's JSON schema
