---
path: '/integrations/data-export/segment/segment-schema-reference'
...
There are five different event kinds events exported to Segment. They are:
...
* [Alias events](#alias-events): This event is emitted when the LaunchDarkly
SDK calls the `Alias` method or automatically in clientside SDKs when an
anonymous user identifies as a non-anonyous user. Read more about Alias events
on [Segment's alias spec](https://segment.com/docs/connections/spec/alias/)

### Additional properties

Segment events include additional information about different LaunchDarkly properties. These properties are included in all event types. These properties are:
...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>The event type.</TableCell>
    </TableRow>
    <TableRow>
...
To learn more, read <a href="/sdk/concepts/evaluation-reasons">Evaluation reasons</a>.
    ...
    <TableRow>
      <TableCell><code>value</code></TableCell>
      <TableCell>Set to another flag’s key if this flag evaluation was only performed in order to determine whether the prerequisite values were met for the indicated flag. <br/> To learn more, read <a href="/home/managing-flags/flag-prerequisites">Flag prerequisites</a>.
</TableCell>
    </TableRow>
    <TableRow>
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>The CSS selector corresponding to the click event.</TableCell>
    </TableRow>
   </TableBody>
</Table>
...
The alias event schema is defined by [Segment's
spec](https://segment.com/docs/connections/spec/alias/). The following indicates
LaunchDarkly's usage of the schema.
