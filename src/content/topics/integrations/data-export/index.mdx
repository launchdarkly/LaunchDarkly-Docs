...
To learn more about event formatting, read [Export format reference](/integrations/data-export/schema-reference).
...
<Callout intent="alert">
  ...
  <CalloutDescription>
    ...
    <ol>
      <li>Update your SDKs to the latest version.\n2. Contact support@launchdarkly.com to enable the feature.</li>
    </ol>
  </CalloutDescription>
</Callout>
...
![The flag's Settings tab with the targeting rules link called out.](../images/flag-settings-experiments-targeting-rules.png)
