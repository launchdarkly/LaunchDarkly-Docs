...
The LaunchDarkly IntelliJ plugin supports code references. Configuring aliases for projects with code references makes the informational hover card available wherever that alias is used. To learn more, read [Finding flag aliases](/home/code/code-references#finding-flag-aliases).
