...
![The LaunchDarkly VSCode extension](../images/vscode-overview.png)

![Treeview right click options](../images/vscode-treeview-right-click.png)
...
The LaunchDarkly VSCode extension supports code references. If you use code references, configuring aliases makes the informational hover card available wherever an alias appears in your code. Aliases appear under the flag entry in the Explorer view. To learn more, read [Finding flag aliases](/home/code/code-references#finding-flag-aliases).
