...
1. Navigate to the [Integrations page](https://app.launchdarkly.com/default/integrations) page and find the SignalFx card.
3. Click **Add integration**. The integration configuration screen appears.

![The SignalFx integration configuration screen.](../../images/signalfx-integration-panel.png)
