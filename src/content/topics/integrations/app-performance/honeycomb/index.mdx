...
The Honeycomb integration is available to customers on a Pro or Enterprise plan. To learn more, [read about our pricing](https://launchdarkly.com/pricing/). To upgrade your plan, [contact Sales](https://launchdarkly.com/contact-sales/).
...
To learn more, read
[Feature flag actions](/home/team/role-actions#feature-flags-actions).
...
You can use LaunchDarkly's triggers feature with Honeycomb to automatically perform actions on feature flags.

To learn more, read [Using triggers with Honeycomb](/integrations/honeycomb/triggers).
...
roles](/home/team/role-resources).
