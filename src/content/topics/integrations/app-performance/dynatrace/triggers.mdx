...
5. Return to the LaunchDarkly flag settings page and check that the test notification has been received by clicking on the overflow menu on your LaunchDarkly trigger and confirming that the execution count has incremented.
