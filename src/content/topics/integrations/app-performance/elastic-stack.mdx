...
![The Elastic Time Series Visualization Builder with LaunchDarkly annotations.](../../images/elastic-annotated-graph.png)
...
1. Navigate to the [Integrations page](https://app.launchdarkly.com/default/integrations) and expand the Elastic (ELK) Stack card.
3. Click **Add integration**. The integration configuration screen appears.
...
2. Find the integration you wish to modify and click **Edit integration configuration**. The "Edit Elastic (ELK) Stack configuration" screen appears.
