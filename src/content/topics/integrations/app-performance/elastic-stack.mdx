...
2. Click **Add integration**. The "Create Elastic (ELK) Stack configuration" panel appears.
...
7. When you've added all the policies you wish, click **Save configuration**.
