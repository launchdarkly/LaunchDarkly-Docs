...
published: true
tags: ['widget', 'dashboard', 'datadog', 'integration', 'dashboard', 'pro', 'enterprise']
---
...
![The "Save with comment" dialog for making flag changes within the Datadog dashboard widget.](datadog-dashboard-widget.png)
...
![The LaunchDarkly editor configuration page in Datadog, configured with sample settings.](datadog-widget-configuration.png)

9. Click **Save**.

## Demonstration video

This video presents a demonstration of the Datadog events and dashboard widget integrations. To read along, enable YouTube's closed captioning feature on the video.

<iframe width="100%" height="315" src="https://www.youtube.com/embed/l9WJUf-TyUY?cc_load_policy=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
