...
3. Click the edit button. The Edit integration screen appears.
4. Toggle to turn the integration **off**.

![The Datadog integration with the edit button called out.](../images/integration-edit-callout.png)
