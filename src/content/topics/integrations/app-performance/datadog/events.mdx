...
1. Navigate to the [Integrations page](https://app.launchdarkly.com/default/integrations) and find the Datadog card.
...
6. (Optional) Configure a custom policy to control which events LaunchDarkly sends to Datadog. To learn more, read [Filtering the events you send to Datadog](#filtering-the-events-you-send-to-datadog).


![The Datadog integration configuration screen.](../images/datadog-config.png)
...
![A Datadog integration in the integrations section.](../images/datadog-integration.png)
...
![The Datadog configuration screen with the Edit integration configuration option called out.](../images/datadog-integration-edit-callout.png)

3. Click **Advanced editor**. The Advanced editor opens.
4. Enter your custom policy.

![The Create a Datadog configuration screen with the Advanced editor open and a policy inside it.](../images/datadog-custom-policy.png)
...
![A Datadog integration on the Integrations page.](../images/datadog-integration.png)

3. Click the **Edit integration configuration** button. The "Edit Datadog configuration" screen appears.
