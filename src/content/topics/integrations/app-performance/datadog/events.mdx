...
![The "Datadog configuration" panel with the "Edit integration configuration" option called out.](datadog-integration-edit-callout.png)

3. Click **Advanced editor**. The Advanced editor appears.
4. Enter your custom policy.

![The "Create a Datadog configuration" panel with the Advanced editor open and a policy inside it.](datadog-custom-policy.png)
