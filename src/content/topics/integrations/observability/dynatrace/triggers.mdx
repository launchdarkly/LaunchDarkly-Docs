...
To learn more about how Dynatrace uses triggers, read [Dynatrace's documentation on webhooks](https://www.dynatrace.com/support/help/how-to-use-dynatrace/problem-detection-and-analysis/notifications-and-alerting/problem-notifications/webhook-integration).
...
1. Create a new webhook in Dynatrace. To learn how, read [Dynatrace's Webhook integration documentation](https://www.dynatrace.com/support/help/how-to-use-dynatrace/problem-detection-and-analysis/notifications-and-alerting/problem-notifications/webhook-integration).
