...
<CalloutTitle>You must customize the payload to see trigger details in LaunchDarkly</CalloutTitle>
<CalloutDescription>
...
5. Click the **three-dot** dropdown menu on your LaunchDarkly trigger to confirm that the execution count has incremented. Sending a test notification does not trigger the flag action, so don't worry that you might toggle a flag by testing the configuration.
