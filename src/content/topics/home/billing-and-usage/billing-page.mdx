...
- Your total client-side monthly context instances (MCI) or client-side monthly active users (MAU), depending on your billing model. To learn more, read [Account usage metrics](/home/billing/usage-metrics).
...
For more information about MCI and how this update impacts your LaunchDarkly plan, read <a href="/home/billing/usage-metrics#calculating-client-side-mci-and-mau">Calculating client-side MCI and MAU</a>.

</CalloutDescription>
</Callout>

- (If applicable) Your total monthly Experimentation events or total monthly Experimentation keys. To learn more, read [Experiment pricing](/home/about-experimentation#experiment-pricing).
