...
- Depending on your billing model, your total client-side monthly context instances (MCI) or client-side monthly active users (MAU) for your current billing period. To learn more, read [Account usage metrics](/home/billing/usage-metrics).
...
For more information about MCI and how this update impacts your LaunchDarkly plan, read <a href="/home/billing/usage-metrics#changes-to-the-launchdarkly-billing-model">Changes to the LaunchDarkly billing model</a>.

</CalloutDescription>
</Callout>

- (If applicable) Your total monthly Experimentation events or total monthly Experimentation keys, depending on your billing model. To learn more about pricing, read [Experiment pricing](/home/about-experimentation#experiment-pricing).
