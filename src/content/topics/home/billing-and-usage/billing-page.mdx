...
From the "Plan options" screen you can view your current usage, upgrade options, and add-on options.
...
The "Plan summary" section lists the number of seats in your account and any add-ons.
...
1. In the "Plan summary" section, click **Review your changes**. A "Review your subscription changes" dialog appears.
