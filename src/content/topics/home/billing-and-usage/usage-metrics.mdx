...
When you exceed your MAU, new users and changes to existing users, such as new attributes, do not appear in the dashboard. The user information on the dashboard has a Time to Live (TTL) of 30 days. No users receive updates while you are over your MAU limit, so all of your users become stale after 30 days and will be removed until you are back under your contracted MAU limit.
