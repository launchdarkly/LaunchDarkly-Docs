...
- For Experimentation, you can view the number of experiment events, as well as the average over the last hour, up to the last 60 days. To learn more about managing Experimentation events, read [Managing Experimentation event counts](/home/experimentation/events#managing-experimentation-event-counts).
