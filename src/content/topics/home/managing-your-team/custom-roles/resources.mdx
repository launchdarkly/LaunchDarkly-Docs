...
To learn more about how resources are structured within custom role policies, read [Custom role concepts](/home/team/role-concepts).  
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        <code>relay-proxy-config</code> is a top-level resource. Write it as <code>relay-proxy-config/*</code>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
