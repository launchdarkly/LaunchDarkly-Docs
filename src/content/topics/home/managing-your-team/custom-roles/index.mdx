...
- Create private projects that only the team members you select can see. To learn more, read [Creating private projects with custom roles](/home/organize/private-projects).
...
To learn more about what each of these roles can do, read [Understanding member roles](/home/team/managing#understanding-member-roles).
...
For templates that match these permission levels, read [Example policies](/home/team/example-policies).
...
We strongly recommend familiarizing yourself with the concepts that power custom roles first. To learn more, read [Custom role concepts](/home/team/role-concepts).
