...
The Relay Proxy automatic configuration feature is only available for customers on an Enterprise plan. To enable it on your plan, [contact Sales](https://launchdarkly.com/contact-sales/).
