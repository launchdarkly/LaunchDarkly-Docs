...
[experiment flag](https://pkg.go.dev/internal/goexperiment) when building your Go (1.19+) code. The [Relay Proxy](/home/relay-proxy) is a great example of such an application, written in Go, using the 
LaunchDarkly Go SDK.
