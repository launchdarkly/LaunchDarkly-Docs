...
If you are using the LaunchDarkly Relay Proxy or Code Refernces, you may need to take [additional
steps](/home/advanced/fips-140-2-encryption) to ensure these components are using FIPS 140-2 validated 
encryption modules. The LaunchDarkly federal instance itself uses FIPS 140-2 valided encryption
