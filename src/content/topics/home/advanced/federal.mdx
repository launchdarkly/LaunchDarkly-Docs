...
* [Enabling SCIM provisioning](/home/account-security/sso/scim)
...
For additional language syntax examples for setting configuration options, read [Using proxy mode](/sdk/features/relay-proxy-configuration/proxy-mode). To use the examples, change the Relay Proxy URLs to the respective federal instance URLs, or change this site's version dropdown to "Federal docs." To learn more, read [Using the federal version of this docs site](#using-the-federal-version-of-this-docs-site).

For a list of available service endpoints, read [Understanding federal instance URLs](#understanding-federal-instance-urls).
