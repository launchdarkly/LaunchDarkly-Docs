...
We recommend that you configure the Relay Proxy to be highly available, which reduces load on any particular server. To learn more, read [Best practices for using the relay proxy](/home/advanced/relay-proxy#best-practices-for-using-the-relay-proxy).
