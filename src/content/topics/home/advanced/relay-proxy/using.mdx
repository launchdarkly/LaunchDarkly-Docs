...
This topic explains how to set up and use the Relay Proxy. It also explains the proxy's two modes and gives detail on how to perform flag evaluations with the Relay Proxy.
...
```bash
go get -u gopkg.in/launchdarkly/ld-relay.v6/...
```
