...
description: 'This topic explains how to set up and use the Relay Proxy. It explains the proxy''s two modes and how to perform flag evaluations with the Relay Proxy.'
published: true
---

## Overview

This topic explains how to use the Relay Proxy. It also explains the proxy's two modes and gives detail on how to perform flag evaluations with the Relay Proxy.

To learn more about deploying the Relay Proxy, read [Deploying the Relay Proxy](/home/advanced/relay-proxy/deploying).
...
Each SDK requires a different property or set of properties during configuration. Depending on which SDK you use, you may need to set different properties.<br/><br/>

You do not need to set all the properties listed above to successfully configure an SDK, but all SDKs require a streaming connection. Precise implementation details to establish a connection vary depending on which SDK you use.<br/><br/>

To learn more, read [your SDK's documentation](sdk#available-sdks).
