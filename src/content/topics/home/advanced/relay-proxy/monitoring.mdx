...
To learn more about the status resource, read the information in our [GitHub repository](https://github.com/launchdarkly/ld-relay/blob/v6/docs/endpoints.md#status-health-check).
