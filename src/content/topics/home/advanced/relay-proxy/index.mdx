...
To learn more about performance expectations once the Relay Proxy is running, read [Monitoring and troubleshooting the Relay Proxy](/home/advanced/relay-proxy/monitoring).
