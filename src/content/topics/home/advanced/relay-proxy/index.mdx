...
Another deciding factor which of LaunchDarkly's [client-side and server-side SDKs](/sdk/concepts/client-side-server-side#understanding-the-different-types-of-sdks) you use. The Relay Proxy provides performance and resilience improvements for all server-side SDKs and for SDKs configured to poll. 
