...
Some Relay Proxy features, including automatic configuration, are only available for customers on Enterprise plans. To learn more, read [Automatic configuration](/home/advanced/relay-proxy/automatic-configuration).
