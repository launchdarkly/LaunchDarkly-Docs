...
<CodeSample>
<CSTab label="Download and build Relay Proxy">
...
1. Confirm that all of your Relay Proxy configuration values are specified with the appropriate environment variables.
  ...
  ```bash
  export LD_ENV_environment-key-123abc=<sdk-key-123abc>
  ```
...
To learn more, read [Persistent storage](https://github.com/launchdarkly/ld-relay/blob/v6/docs/persistent-storage.md) and [Big Segments](/home/contexts/big-segments).
