...
<CodeTabs
  defaultValue="relay"
  values={[
    { label: 'Add chart repository', value: 'relay', },
  ]
}>
<CodeTabItem value="relay">
...
<CodeTabs
  defaultValue="flags"
  values={[
    { label: 'Using command line flags', value: 'flags', },
    { label: 'Using values file', value: 'file', },
  ]
}>
<CodeTabItem value="flags">

```bash
helm install relay --set relay.environment.LD_ENV_MyEnvironment=sdk-key launchdarkly-ld-relay/ld-relay
```
</CodeTabItem>
