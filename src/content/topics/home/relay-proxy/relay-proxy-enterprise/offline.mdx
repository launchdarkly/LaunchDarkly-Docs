...
This allows you to run the Relay Proxy in a highly secure system, such as in an air-gapped or a FedRAMP-compliant system. By using offline mode, you can secure the Relay Proxy away from any external touchpoints.
