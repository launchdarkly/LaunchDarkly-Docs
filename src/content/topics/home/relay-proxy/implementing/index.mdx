...
1. Decide whether to run the Relay Proxy in [proxy mode or daemon mode](/home/relay-proxy/using#using-the-relay-proxy-in-different-modes).
1. Plan your Relay Proxy architecture, including:
    - [Whether to use a persistent store](/home/relay-proxy/using#using-a-persistent-store).
    - What servers to use.
