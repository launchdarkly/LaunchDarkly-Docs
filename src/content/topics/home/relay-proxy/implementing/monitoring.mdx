...
The Relay Proxy exposes a status resource containing details about its health. To learn about the status resource, read the Relay Proxy GitHub repository's [Status (health check)](https://github.com/launchdarkly/ld-relay/blob/v7/docs/endpoints.md#status-health-check).
...
To view an example output for this request, read the Relay Proxy GitHub repository's [Service endpoints](https://github.com/launchdarkly/ld-relay/blob/v7/docs/endpoints.md).
...
To learn more about configuring the Relay Proxy to export metrics and traces, read the Relay Proxy GitHub repository's [Metrics integrations](https://github.com/launchdarkly/ld-relay/blob/v7/docs/metrics.md).