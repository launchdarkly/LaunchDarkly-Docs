...
The persistent store will contain the flag and segment rules for your configured environments. The amount of data is typically quite small. The data will be the same information returned by the streaming and polling endpoints.
...
You can use either DynamoDB or Redis as a persistent store with the Relay Proxy.
...
To learn more, read [Persistent storage](https://github.com/launchdarkly/ld-relay/blob/v7/docs/persistent-storage.md).
