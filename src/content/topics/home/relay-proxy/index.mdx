...
If you are using the LaunchDarkly Relay Proxy in an environment that requires the use of FIPS 140-2 
validated encrytpion modules, you may need to take [additional steps](/home/advanced/fips-140-2-encryption) 
