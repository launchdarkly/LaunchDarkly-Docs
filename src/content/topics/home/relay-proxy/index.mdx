...
Some Relay Proxy features, including automatic configuration and offline mode, are only available for customers on Enterprise plans. To learn more, read [Relay Proxy Enterprise](/home/relay-proxy/enterprise).
