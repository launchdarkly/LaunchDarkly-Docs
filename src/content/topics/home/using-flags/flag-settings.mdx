...
The flag's maintainer can be updated on the flag's **Settings** tab, or from the header of any of the flag's tabs:

![Clicking the pencil icon in the header of the flag page allows the member to set a new flag maintainer.](edit-flag-maintainer.png)
