...
6. Enter a list of user keys or email addresses in the **these users** field, separated by a comma or new line. LaunchDarkly looks up users by key or email and displays them in the list on the right. If you want to target a user that has not been seen by LaunchDarkly, you must enter their key.
