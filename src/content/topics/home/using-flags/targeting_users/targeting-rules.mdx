...
<CalloutTitle>Attributes cannot share the same key</CalloutTitle>
<CalloutDescription>

Assigning a custom attribute a key already used by a built-in attribute causes the SDK to ignore the custom attribute during feature flag evaluation.
