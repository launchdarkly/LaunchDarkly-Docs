...
description: This topic explains how to use a flag's Targeting tab to control which individual users receive a variation of a feature flag.
published: true
tags: ['target', 'user', 'targeting rule']
---
...
The "Individual targeting" section of the **Targeting** tab allows you to assign individual users to a particular flag variation.
...
2. In the "Individual targeting" section, search for the new user you want to target or click the name of an existing user you want to set a removal date for.
