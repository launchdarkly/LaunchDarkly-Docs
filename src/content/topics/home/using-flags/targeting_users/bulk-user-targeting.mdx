...
Very large lists of named users increase the size of the payload the SDK fetches when initializing, as well as the memory footprint of the SDK. Lists of over 50,000 individual users are not supported for flags or segments in LaunchDarkly.
