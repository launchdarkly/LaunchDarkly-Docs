...
To learn more about custom attributes, read [Targeting users based on custom attributes](/home/flags/targeting-rules#targeting-users-based-on-custom-attributes).
