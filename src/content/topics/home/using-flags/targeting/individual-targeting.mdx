...
Instead, we recommend using targeting rules or segments to target large numbers of contexts. To learn how, read [Creating targeting rules](/home/flags/targeting-rules#creating-targeting-rules) and [Segments](/home/contexts/segments).
