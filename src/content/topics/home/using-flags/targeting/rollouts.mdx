...
<Details summary="Expand Understanding percentage rollout logic">
...
1. Store a unique identifier for the anonymous end user. A session ID or UUID works well.
  ...
  * If you are using a mobile SDK, the SDK can generate the unique identifier for you and use it as the context key. To learn more, read about [setting anonymous contexts in client-side SDKs](/sdk/features/anonymous#client-side-sdks).
