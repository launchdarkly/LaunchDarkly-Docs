...
You can also use the REST API: [List dependent feature flags](https://apidocs.launchdarkly.com/tag/Feature-flags-(beta)#operation/getDependentFlags), [List dependent feature flags by environment](https://apidocs.launchdarkly.com/tag/Feature-flags-(beta)#operation/getDependentFlagsByEnv)
