...
published: true
tags: ['variation', 'flag', 'boolean', 'multivariate', 'default']
---
...
After a feature flag has been created, you cannot change the type of its variations. For example, you can't edit a feature flag that returns numbers to make it return strings instead. To learn more about creating flags, read [Creating feature flags](/home/flags/feature-flags).
...
<CalloutTitle>Do not edit flag variations that are in use</CalloutTitle>
<CalloutDescription>
...
You can also use multivariate flags to perform testing with LaunchDarkly's Experimentation feature. To learn more, read [Creating Experiments](/home/creating-experiments).
