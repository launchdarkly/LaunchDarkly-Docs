...
2. In the "Connect LaunchDarkly to your app" panel, select **Connect**.

![The "Connect LaunchDarkly to your app" panel.](connect-an-sdk-panel.png)
...
2. In the "Try an interactive demo" panel, select **Begin**.
