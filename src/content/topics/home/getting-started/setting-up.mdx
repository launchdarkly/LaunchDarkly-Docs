...
SDK documentation appears in your editor if the editor supports surfacing doc comments. LaunchDarkly offers further integrations for [VSCode](https://docs.launchdarkly.com/integrations/vscode#installing-the-vscode-extension) or [IntelliJ(beta)](https://docs.launchdarkly.com/integrations/intellij).
...
After you have set up an SDK, you can manage features on your dashboard. To learn more, read [The flags dashboard](/home/organize/dashboard).
