...
12. (Optional) Select the **SDKs using mobile key** and/or **SDKs using Client-side ID** checkboxes. If you choose this option, the flag will be pushed out to the type of SDKs you selected. You must make available each flag that you want client-side or mobile SDKs to be able to access.
13. Click **Save Flag**:
