...
8. Choose an option in the **Flag variations** dropdown. To learn more, read [Flag variations](/home/managing-flags/flag-variations).
9. (Optional) Specify details for your **Variation**. To learn more, read [Flag variations](/home/managing-flags/flag-variations).
...
When you create a flag, you can choose to expose the flag to SDKs which use client-side ID, SDKs which use mobile keys, or both. By default, flags are only available to server-side SDKs. If you're using a client-side SDK, you must make each flag you wish to appear on the frontend available to the client.
