...
The procedures in this topic assume that you have already configured a LaunchDarkly SDK and are ready to use the LaunchDarkly UI. For an example tutorial of how to configure a LaunchDarkly SDK, read [Getting started: Configuring an SDK and creating a flag](/guides/tutorials/sdk-flag).
