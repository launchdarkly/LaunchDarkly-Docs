...
![The expanded account owner dropdown with a different account member selected.](account-settings-team-change-owner-dropdown.png)

5. Choose a new account member from the dropdown by clicking or searching.
