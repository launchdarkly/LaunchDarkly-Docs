...
Members with this role can't access any part of the LaunchDarkly platform. This role is for members who shouldn't be able to view or modify anything until an admin grants them access to specific areas of LaunchDarkly. To learn more, read [Configuring roles with no access](/guides/teams-roles/no-access).
