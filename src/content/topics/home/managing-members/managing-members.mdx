...
4. Enter one or more email addresses. If you are inviting multiple members, separate email addresses with a comma or new line.
   ![The "Invite members" dialog with email input called out.](invite-members-email-highlight.png)
5. Choose an initial built-in role or custom role from the **Member role** dropdown.
   ![The "Invite members" dialog with member role called out.](invite-members-role-highlight.png)
6. (Optional) Select the team(s) to add these members to.
   ![The "Invite members" dialog with teams dropdown called out.](invite-members-team-highlight.png)
