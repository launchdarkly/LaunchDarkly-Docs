...
The **Members** list is only accessible if you're a LaunchDarkly Admin. To learn more, read [Understanding member roles](#understanding-member-roles).
...
4. Enter one or more email addresses. If you are inviting multiple members, separate email addresses with a comma or new line.
   ![The "Members" tab with "Invite members" email input called out](invite-members-email-highlight.png)
5. Choose an initial built-in role or custom role from the **Member role** dropdown.
   ![The "Members" tab with "Invite members"member role called out](invite-members-role-highlight.png)
6. (Optional) Select the team(s) to add these members to.
   ![The "Members" tab with "Invite members" team dropdown called out](invite-members-team-highlight.png)
