...
3. In the "User profile" section, type in the **First name**, **Last name**, and/or **Email address** fields to change them.
...
To do this, navigate to your profile. In the "User profile" section, click **Access**. The "Permissions" page opens.

![The "User profile" section with the "Access" link called out.](account-settings-profile-access-callout.png)
...
You can set your LaunchDarkly password from the **Profile** tab in the **Account settings** page. You must have your current password to reset your password while logged in.
