...
When you update your email address, the address is case sensitive. Future attempts to log in with that email address will fail if you use different casing.<br /><br />
...
<Callout intent="alert">
  ...
  If you don't know your current password, [contact Support](https://support.launchdarkly.com/hc/en-us/requests/new).
