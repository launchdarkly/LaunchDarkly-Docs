...
To view an individual member's roles from the Members tab:

1. Navigate to the [Members](https://app.launchdarkly.com/settings/members) tab in Account Settings.
2. Click the name of the member you want to view. The member's "Permissions" screen opens.
3. View the member's individually assigned built-in and custom roles the "Member roles" section.
5. (Optional) View the member's roles granted from belonging to any teams in the "Team roles" section.
