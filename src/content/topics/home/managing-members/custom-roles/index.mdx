...
You can use the LaunchDarkly API to get member details, including the last built-in role the member had. You can use this information to determine what role would be restored if you removed the all custom roles from that member.
