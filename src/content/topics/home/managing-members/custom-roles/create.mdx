...
You can also create custom roles with no access to any LaunchDarkly resources by unchecking the base role option checkbox. To learn how, read [Configuring roles with no access](/guides/best-practices/no-access).
