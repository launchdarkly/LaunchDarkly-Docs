...
4. Click **Edit member roles**. A modal appears.
5. Choose **Custom**. A dropdown menu containing your organization's custom roles appears.
...
Use the Teams feature to group a set of members and assign them all the same custom roles. To learn more, read [Teams](/home/teams).
...
![The "Edit custom role policy" screen.](settings-roles-edit.png)
