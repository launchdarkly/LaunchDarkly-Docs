...
To learn more, read [Writing policies in the advanced editor](/home/members/role-policies#writing-policies-in-the-advanced-editor).
...
3. Click **Create Role**. The "Create a role" screen appears.
...
To learn more, read [Finding resource IDs](/home/members/role-policies#finding-resource-ids).
