...
<Callout intent="info">
<CalloutTitle>The base role setting is for Early Access Program customers only</CalloutTitle>
<CalloutDescription>
...
![The base role option checkbox in the "Create custom role" screen.](settings-roles-base-role-custom.png)
