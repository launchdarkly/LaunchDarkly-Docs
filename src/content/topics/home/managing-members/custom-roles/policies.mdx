...
You can only create a statement using `notActions` or `notResources` in the advanced editor. To learn more about the advanced editor, read [Using the advanced editor](/home/members/advanced-editor).
...
You can create detailed and complex policies with the advanced editor. To learn more, read [Using the advanced editor](/home/members/advanced-editor).
