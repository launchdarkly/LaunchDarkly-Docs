...
This topic explains how policies work in custom roles, integrations access, and Rely Proxy access.
...
To learn more about creating policies in LaunchDarkly, read [Creating custom roles and policies](/home/members/role-create).
