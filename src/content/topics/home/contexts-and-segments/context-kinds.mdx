...
8. (Optional) Uncheck the "Available for targeting" checkbox if you do not want members to be able to use this context kind in flag and segment targeting rules.
