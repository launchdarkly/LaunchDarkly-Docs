...
You can also use the REST API: [Get context attribute names](https://apidocs.launchdarkly.com/tag/Contexts/#operation/getContextAttributeNames), [Get context attribute values](https://apidocs.launchdarkly.com/tag/Contexts/#operation/getContextAttributeValues)
...
You can also use the REST API: [Get context instances](https://apidocs.launchdarkly.com/tag/Contexts/#operation/getContextInstances)
...
Deleting a context instance deletes all versions of that instance. Deleting context instances from the **Contexts** list does not decrease your monthly context instances (MCI) count.
...
Try it in your SDK: [Flag evaluation reasons](/sdk/features/evaluation-reasons)
