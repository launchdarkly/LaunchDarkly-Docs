...
<Callout intent="info">
<CalloutTitle>In order to see the context name</CalloutTitle>
<CalloutDescription>

You must send the context name in the <strong>variation</strong> call in the LaunchDarkly SDK for the name to display in the LaunchDarkly user interface (UI). To learn more, read [Example: Contexts that affect Anna's experience](/home/contexts#example-contexts-that-affect-annas-experience).
</CalloutDescription>
</Callout>
