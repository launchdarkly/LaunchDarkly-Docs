...
You can filter contexts on the **Contexts** list by context kind, name, or attribute.

To filter contexts:

1. In the filter field, enter all or the beginning of a context kind, name, or attribute. 
