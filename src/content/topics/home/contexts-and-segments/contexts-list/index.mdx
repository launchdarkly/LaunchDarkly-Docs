...
<Table>
  ...
  <TableRow>
    ...
    <TableCell>
      Returns true if any of the values in a field match any of the values in the match value. Only works for fields like kindkeys, applicationid, id, key, kind, kindkey
    </TableCell>
    <TableCell>
  ...
  <TableRow>
    ...
    <TableCell>
      Returns true if all the match values are also found in the values of the field. Only works for fields like kinds, kindkeys 
    </TableCell>
    <TableCell>
