...
You must send the context name in the <strong>variation</strong> call in the LaunchDarkly SDK in order to see the name on the U.I. To learn more, read [Contexts](/home/contexts#example-contexts-that-affect-annas-experience).
</CalloutDescription>
</Callout>
