...
published: true
tags: ['context', 'user', 'custom context', 'context kind', 'multi-context', 'segment']
---
...
Configure your SDK: [User and context configuration](/sdk/features/user-context-config), [Evaluating flags](/sdk/features/evaluating)
