...
<CalloutTitle>Adding LaunchDarkly as a destination from Segment is currently unavailable</CalloutTitle>
<CalloutDescription>

Configuring your existing Segment account to send events to LaunchDarkly experiments is currently unavailable in the Destination Catalog within Segment’s app. If you need to configure this immediately, [contact LaunchDarkly Support](https://support.launchdarkly.com/hc/en-us) to request access.

If you already have a Segment account configured to send events to LaunchDarkly, no action is required.

If you have additional questions, [contact LaunchDarkly Support](https://support.launchdarkly.com/hc/en-us).
