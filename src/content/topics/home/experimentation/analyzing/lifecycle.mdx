...
published: true
tags: ['lifecycle', 'start', 'stop', 'experiment', 'experimentation', 'enterprise']
---
...
You can also use the REST API: [Stopping an experiment](https://apidocs.launchdarkly.com/tag/Experiments-(beta)#section/Stopping-an-experiment)
