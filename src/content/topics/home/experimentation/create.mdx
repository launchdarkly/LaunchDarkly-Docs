...
After you've connected a metric to a flag, you can start your experiment whenever you want. Click the **Start Recording** button in every environment where you want to record data.
