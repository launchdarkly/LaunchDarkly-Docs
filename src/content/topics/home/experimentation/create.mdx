...
The method to create a custom experiment population is different depending on whether or not your LaunchDarkly account has allocation enabled. Most accounts use allocation. If you are unsure whether your account has allocation enabled, [contact Support](https://support.launchdarkly.com/hc/en-us).
...
To learn how to define the experiment audience with allocation, read [Using experiment allocation](/home/experimentation/allocation#using-experiment-allocation). Most LaunchDarkly accounts use this method.
