...
It takes four steps to create an experiment. You must:
...
3. [Start recording the metric](#starting-your-experiment), and
4. [Turn on the feature flags](/home/managing-flags/flag-toggle)
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>You specify: <code>example.com</code>.<br />  Views or clicks at <code>example.com</code>, and <br />
        <code>example.com#signin</code> trigger events.<br /> You specify: <code>example.com</code> and <br />
    ...
    <TableRow>
      ...
      <TableCell>
        You specify: <code>example.com</code>.<br /> Only views or clicks at <code>example.com</code> trigger events.<br /> Views and clicks at <code> www.example.com/signup
        </code> and <br /><code>https://www.example.com</code> do not trigger events.
      </TableCell>
    </TableRow>
    <TableRow>
      ...
      <TableCell>
        ...
        </code> Because all of these URLs contain <code>your-substring</code>, clicks on the CSS selectors you specify on each
        page trigger events.
      </TableCell>
    </TableRow>
    <TableRow>
...
![The Experiments dashboard with the "+ Experiment" button called out.](../../images/experiment-dashboard-new-callout.png)
...
To learn more, read [Starting your experiment](#starting-your-experiment).
