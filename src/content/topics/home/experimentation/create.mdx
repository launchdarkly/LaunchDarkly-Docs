...
Including only a subset of users in your experiments allows you to get accurate experiment results more quickly. This subset of users is called an experiment population. You can create a custom experiment population by selecting specific flag targeting rules to include in your active experiments.

The method to create a custom experiment population is different depending on whether or not your LaunchDarkly account has allocation enabled. If you are unsure whether your account has allocation enabled, [contact Support](https://support.launchdarkly.com/hc/en-us). To learn more about allocation, read [Allocating experiment traffic](/home/experimentation/allocation).

### Defining an experiment audience with allocation

To learn how to define the experiment audience with allocation, read [Using experiment allocation](/home/experimentation/allocation#using-experiment-allocation).

### Defining an experiment audience without allocation

To learn how to define the experiment audience without allocation, read [Customizing experiment populations](/home/experimentation/populations#customizing-experiment-populations).
