...
Monitor existing experiments from the **Experiments** dashboard, accessible in the sidebar menu.

![Flags + metrics = experiments.](experiment-splash-image.png)
...
<ChildPageList path="/home/experimentation" />
