...
The number of experiments per flag, the user engagement with that flag, and the target groups included in the experiment can all affect the volume of events LaunchDarkly sends.
