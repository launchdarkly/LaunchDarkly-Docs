...
LaunchDarkly uses variation calls to correlate conversions and impressions within a three-minute window. If there is more than three minutes between the time of a variation call and a track call on a user key, then LaunchDarkly does not register them in the experiment.
...
Experimentation includes a built-in feature that lets you refine the users included in an experiment based on the flag's targeting rules. To learn more, read [Controlling experiment populations](/home/experimentation/populations).
...
- [Managing experiments](/home/experimentation)
