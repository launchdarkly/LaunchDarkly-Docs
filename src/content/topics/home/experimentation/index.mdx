...
[contact our Sales team](mailto:sales@launchdarkly.com).
...
As always, LaunchDarkly is an API-first product. Everything you see in the experimentation UI is powered by a fully
supported API endpoint. To learn more, read our [API docs](https://apidocs.launchdarkly.com/reference).
...
![An active multivariate experiment.](../../images/experiment-multivariate.png) 
