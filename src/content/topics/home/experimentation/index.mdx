...
LaunchDarkly uses variation calls to correlate conversions and impressions within a 24-hour window. If there is more than 24 hours between the time of a variation call and a track call on a user key, then LaunchDarkly does not register them in the experiment.
