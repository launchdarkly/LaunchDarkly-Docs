...
Each experiment shows details about what data the experiment is collecting and what that data means. You can see information about the experiment, like its name and experiment type, in the section header.

Here is an image of an experiment:

![An experiment's section, on the "Experimentation".](experiment-card.png)
