...
which data LaunchDarkly exports](/home/data-export#customizing-which-data-launchdarkly-exports).
...
to Experimentation results or Data Export streams. To learn more, read [Targeting users](/home/flags/targeting-users).
...
2. Click on the flag's **Experiments** tab.
