...
description: 'This topic explains how to start recording data in an experiment and pause the experiment when you''re finished.'
published: true
---
...
Here is an image of the stop recording option and confirmation modal:
