...
description: 'This topic explains how to include specific groups of users in an experiment using experiment allocation.'
published: true
---

## Overview

This topic explains how to include specific groups of users in an experiment using experiment allocation.
...
After experiment allocation is enabled, all new or paused experiments will require an experiment allocation before you can begin recording.

<Callout intent="info">
<CalloutTitle>Experiment allocation</CalloutTitle>
<CalloutDescription>

If you do not have experiment allocation enabled, customizing your experiment populations works differently than described below. To learn how to customize your experiments without experiment allocation enabled, read [Controlling experiment populations](/home/experimentation/populations).
...
![The experiment dropdown with the "Run an experiment" option called out.](experiment-run-experiment-callout.png)
...
![The experiment allocation screen.](experiment-allocation.png)
...
![Experiment allocation at 6%](experiment-allocation-six-percent.png)
...
![Experiment allocation at 30%](experiment-allocation-thirty-percent.png)
...
![Experiment allocation at 50%](experiment-allocation-fifty-percent.png)
...
![Experiment allocation at 30%](experiment-allocation-thirty-percent-no-reshuffle.png)
