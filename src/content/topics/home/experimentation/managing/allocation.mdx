...
![The experiment menu with the "Run an experiment" option called out.](experiment-run-experiment-callout.png)
...
![The experiment allocation section of a flag's "Targeting" tab.](experiment-allocation.png)
