...
3. Navigate to the selected project by clicking the name of the project.

![The "Projects" list page with link callout to chosen project.](select-project-callout.png)

4. Click **Create environment**. The "Create an environment" panel appears:

![The "Project settings" page with the "Create environment" button called out.](create-environment-callout.png)
...
3. In the **Projects** results click on a project name to navigate to that project.
4. Click the **overflow menu** next to your environment.
5. Select "Edit environment." An "Edit environment" panel appears.
...
4. Click the **overflow menu** next to your environment.
5. Select "Edit environment." An "Edit environment" panel appears.
6. Enter a value in the **TTL input** and once done click **Save Environment**.
   ![The TTL settings input.](ttl-settings.png)
