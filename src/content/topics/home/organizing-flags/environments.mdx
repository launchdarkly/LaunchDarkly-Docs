...
3. Click **Create environment**. The "Create an environment" panel appears:

![The "Account settings" page with the "Create environment" button called out.](env-new-callout.png)
...
You can migrate some, but not all, content between environments from the flags dashboard. To learn more, read [Compare and copy flag settings](/home/organize/flag-compare-copy).
...
4. Select "Edit environment." An "Edit environment" panel appears.
5. In the "Keys" section click **Reset SDK key** or **Reset mobile key**.
6. (Optional) If you are resetting an SDK key, choose how many hours to keep the current SDK key active for, up to 720 hours (30 days).
6. Enter the name or key of your environment:
