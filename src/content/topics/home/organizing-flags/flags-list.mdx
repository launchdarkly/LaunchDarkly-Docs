...
published: true
tags: ['dashboard', 'flag', 'tag', 'filter']
---
...
To learn how to create a new flag, read [Creating a feature flag](/home/flags/feature-flags#creating-a-feature-flag). To learn how to archive a flag, read [Archiving flags](/home/code/flag-archive#archiving-flags).
...
<Callout intent="info">
<CalloutTitle>Filtering by maintainer includes teams</CalloutTitle>
<CalloutDescription>
...
Here is an example of the flags list filtered by tags:
...
![A set of filters applied to the flags list.](flags-list-filtered.png)
...
<Callout intent="info">
<CalloutTitle>Sharing filtered flag lists with team members</CalloutTitle>
<CalloutDescription>
