...
published: true
tags: ['project', 'private', 'viewproject', 'custom role']
---
...
<CodeSample>
<CSTab label="Restrict access to a project">
...
<CodeSample>
<CSTab label="Restrict access to all projects">
...
You can restrict individual members' or teams' access to certain projects by explicitly denying view access to projects you do not want them to view. Excluding most projects effectively creates a flags list and project picker that only displays the projects you want a given user or group to view.
...
<CodeSample>
<CSTab label="Restrict access to some projects">
