...
Customers on a Pro or Enterprise plan have access to 300 projects per account by default. Customers on a Starter plan have access to one project. To request an increase to your project limit, [contact Support](https://support.launchdarkly.com/hc/en-us/requests/new).
