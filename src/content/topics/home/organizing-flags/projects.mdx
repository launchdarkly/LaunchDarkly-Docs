...
- The **Default on behavior** determines which variation a new flag will serve when the flag's targeting is on and the user did not match any targeting rules.
