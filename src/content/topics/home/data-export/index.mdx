...
You can control which users send event data to destinations by choosing a group of users affected by certain flag targeting rules. To learn more, read [Allocating experiment traffic](/home/experimentation/allocation).
