...
Your Data Export costs are based on the number of events you send per month to external destinations. To learn more about the events you can send to a destination, read [Data Export schema reference](/home/data-export/schema-reference).
