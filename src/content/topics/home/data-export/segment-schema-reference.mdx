...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>The event kind. This field maps onto <a
      href="https://segment.com/docs/connections/spec/track/>Segment's event
      field</a></TableCell>.
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      For example, in clientside SDKs, this is the key of the currently
      identified user. This field maps onto <a
      href="https://segment.com/docs/connections/spec/track/">Segment's userId
      field</a>.</TableCell>
    </TableRow>
   </TableBody>
</Table>
