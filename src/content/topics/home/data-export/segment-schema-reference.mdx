...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>
        The event kind. This field maps onto
        <a href="https://segment.com/docs/connections/spec/track/">Segment's event field</a>.
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
    ...
    <TableRow>
      ...
      <TableCell>
        The flag key corresponding to the event. In the case of Experimentation events, this will be the metric key for
        the experiment.
      </TableCell>
    </TableRow>
    <TableRow>
      ...
      <TableCell>
        The key of the user object associated with the emitted event. For example, in client-side SDKs, this is the key
        of the currently identified user. This field maps onto{' '}
        <a href="https://segment.com/docs/connections/spec/track/">Segment's userId field</a>.
      </TableCell>
    </TableRow>
  </TableBody>
</Table>
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell>
        <code>flagVersion</code>
      </TableCell>
      <TableCell>The version of the evaluated flag.</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
        <code>inExperiment</code>
      </TableCell>
      <TableCell>
        <code>true</code> if this flag evaluation was allocated to an experiment. <br /> To learn more, read{' '}
        <a href="/home/creating-experiments/allocation">Allocating experiment audiences</a>.
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
        <code>reasonKind</code>
      </TableCell>
      <TableCell>
    ...
    <TableRow>
      ...
      <TableCell>
        Set to another flag’s key if this flag evaluation was only performed in order to determine whether the
        prerequisite values were met for the indicated flag. <br /> To learn more, read{' '}
        <a href="/home/flags/prerequisites">Flag prerequisites</a>.
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
    ...
    <TableRow>
      ...
      <TableCell>
        The variation of the flag requested. The SDK stores flag variation values in an array. This value corresponds to
        the index of the variation the array. Boolean flags show as <code>0</code> or <code>1</code> for{' '}
        <code>true</code> and <code>false</code>, and other flag types are numbered starting with <code>0</code> for
        their different variations.
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
        <code>variationName</code>
      </TableCell>
      <TableCell>
        The evaluated variation's name, if it exists. If the evaluated variation doesn't have a name, this field doesn't
        appear.
      </TableCell>
    </TableRow>
  </TableBody>
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        The CSS selector corresponding to the <code>click</code> event.
      </TableCell>
    </TableRow>
  </TableBody>
</Table>
...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>
        The numeric value of a metric if it is specified in the event. If no metric value was provided, this field
        doesn't appear.
      </TableCell>
    </TableRow>
  </TableBody>
