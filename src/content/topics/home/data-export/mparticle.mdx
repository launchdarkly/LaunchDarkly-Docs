...
1. Navigate to the **[Integrations page](https://app.launchdarkly.com/default/integrations)** and find "mParticle."

![mParticle on the Integrations screen.](mparticle-add-destination.png)
