...
tags: ['segment', 'destination', 'event', 'data export']
published: true
---
...
1. Navigate to the **[Integrations](https://app.launchdarkly.com/default/integrations)** page and find "Segment."
...
![The "Create a destination" panel.](integrations-segment-create.png)
...
![The "Send a test event" section of the "Edit destination" panel.](integrations-segment-test-event.png)
