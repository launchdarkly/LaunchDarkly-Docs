...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        This event kind contains the user attributes for a particular user, defined by a user key, when a feature flag evaluates the user. This event kind is not available for Segment or mParticle destinations. To export <code>index</code> events, contact <a href="https://support.launchdarkly.com">LaunchDarkly Support</a>.
      </TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>
        This event kind describes a roll-up of individual feature evaluations over an interval. To export <code>summary</code> events, contact <a href="https://support.launchdarkly.com">LaunchDarkly Support</a>.
      </TableCell>
    </TableRow>
  </TableBody>
</Table>
...
`custom` events are produced when the client application calls the SDK's track method. To learn more, read [Sending custom events](/sdk/features/events).
...
method. They are also emitted automatically by client-side SDKs when an anonymous user
...
By default, we do not export <code>summary</code> events. To export <code>summary</code> events, contact [LaunchDarkly Support](https://support.launchdarkly.com/).
