...
<CalloutTitle>You must use valid randomization units in your context kinds and metrics</CalloutTitle>
<CalloutDescription>

When creating a new metric or context kind for use in Experimentation, we recommend consulting with an Experimentation expert in your organization or with LaunchDarkly Support to be sure your randomization unit mapping is valid. Using non-standard randomization units will result in invalid experiment results.
