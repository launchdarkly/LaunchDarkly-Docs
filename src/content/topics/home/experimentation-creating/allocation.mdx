...
- To reduce the volume of users in an experiment to manage billing costs. To learn more, read [Experiment pricing](/home/about-experimentation#experiment-pricing).
...
<Callout intent="info">
<CalloutTitle>Verify that your SDK versions support Experimentation</CalloutTitle>
<CalloutDescription>
...
You determine the initial experiment audience when you create a new experiment. To learn how, read [Building experiments](/home/creating-experiments#building-experiments).
...
Finally, you roll out variations A and B to 50% of traffic each. In this case, the entire audience is reallocated randomly. For example, 0%-1% partition will not have the exact same set of users as the previous 0%-1% partition.
