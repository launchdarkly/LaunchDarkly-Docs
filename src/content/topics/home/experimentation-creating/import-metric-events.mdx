  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        ...
        <a href="https://app.launchdarkly.com/settings#/projects">
      ...
      <TableCell>
        <ul>
          <li>
            ...
            <a href="/home/members/role-actions#environment-actions">Environment actions</a>.
          </li>
          <li>
          ...
          <li>
            ...
            payload, which you can use to <a href="#retrying-failed-requests">retry failed requests</a>.
          </li>
          <li>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        ...
        exactly match this value. To learn more, read <a href="/home/creating-experiments/metrics">Creating metrics</a>.
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
    ...
    <TableRow>
      ...
      <TableCell>
        ...
        <br />
        <br />
        To learn more about using context kinds in experiments, read <a href="/home/creating-experiments/allocation#randomization-units">
          Randomization units
        </a>.
      </TableCell>
    </TableRow>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>
        ...
        if their format does not conform to the required JSON schema. To learn more, read <a href="#known-limitations">
          Known limitations
        </a>.{' '}
      </TableCell>
    </TableRow>
