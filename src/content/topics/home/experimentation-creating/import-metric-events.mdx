...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        <code>/import/environments/client-side-id-123abc/metrics</code>
        <br />
        <br /> Replace <code>client-side-id-123abc</code> with the client-side ID for the environment your metric events
        pertain to. Your client-side ID is available under <strong>Environments</strong> on the{' '}
        <strong>Projects</strong> tab on the{' '}
    ...
    <TableRow>
      ...
      <TableCell>
        <ul>
          ...
          <li>
            <code>LD-API-Version: beta</code>, required
          </li>
          <li>
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        A JSON object with two properties named <code>user</code> and <code>anonymousUser</code>. The value of the{' '}
        <code>user</code> property is the context key and must uniquely identify the context that the metric is about.
        The context key must exactly match the context key provided to any LaunchDarkly SDKs evaluating flags that will
...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>
        {' '}
        The request completed successfully and the metric events were accepted for import. Note that they may still not be
        recorded if their format does not confirm to the required JSON schema. To learn more, read <a href="#known-limitations">
          Known limitations
        </a>.{' '}
      </TableCell>
    </TableRow>
    ...
    <TableRow>
      ...
      <TableCell>
        {' '}
        Your account does not have access to the metric import API, or the <code>LD-API-Version</code> header is not set
        to <code>beta</code>.{' '}
      </TableCell>
    </TableRow>
    <TableRow>
      ...
      <TableCell>
        {' '}
        The <code>clientSideID</code> specified in the URL is invalid.{' '}
      </TableCell>
    </TableRow>
    <TableRow>
