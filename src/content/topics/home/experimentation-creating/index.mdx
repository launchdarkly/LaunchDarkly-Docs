...
Your anonymous contexts must have their own unique context keys to use Experimentation. To learn more, read [Designating anonymous contexts](/sdk/features/user-context-config#designating-anonymous-contexts).
...
3. The "Experiment details" step opens. Enter an **Experiment name**.
4. Enter a **Hypothesis** for your experiment.
5. Choose a context kind from the **Randomization unit for this experiment** menu. To learn more, read [Randomization units](/home/creating-experiments/allocation#randomization-units).
