...
You can designate only one metric as the primary metric in an experiment, but you can attach secondary metrics to your experiments if you want to track the performance of additional measurements.
...
11. Choose the audience to include in the experiment. The audience options are created from the targeting rules in the feature flag you connected in step 9.
12. Enter the percentage of traffic for each variation you want to include in the experiment.
