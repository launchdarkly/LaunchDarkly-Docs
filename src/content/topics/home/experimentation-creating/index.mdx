...
Archived experiments are hidden from the experiment dashboard by default, however you still cannot delete a flag or metric attached to an archived experiment.

![The experiment header with the "Archive experiment" button called out.](experiment-archive-callout.png)
