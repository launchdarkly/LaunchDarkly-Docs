...
Your anonymous users must have their own unique user keys to use Experimentation. To learn more, read [Designating anonymous users](/sdk/features/user-context-config#designating-anonymous-contexts).
