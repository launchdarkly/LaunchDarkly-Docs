...
You can send `custom` events using the track feature in your SDK. To learn more about Experimentation events, read [Experimentation events](/home/about-experimentation/events).
