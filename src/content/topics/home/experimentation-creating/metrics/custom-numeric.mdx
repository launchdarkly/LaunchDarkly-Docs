...
1. Follow steps 1-7 in [Creating click metrics](/home/creating-experiments/metrics/click) until you have configured the metric up to the "Event information" section.
