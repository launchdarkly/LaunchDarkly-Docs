...
Page view conversion metrics track how often users view an element on a page hosted at a specific URL. Page view conversion metrics must be used with either the JavaScript or React SDK.
