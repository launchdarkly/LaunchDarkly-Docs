...
Page view metrics track how often users view an element on a page hosted at a specific URL. Page view metrics must be used with either the JavaScript or React SDK.
...
3. Specify the type of **Target URL** you want to track behavior on. To learn about the different options for URL matching, read the table in [Creating click metrics](/home/creating-experiments/metrics/click).
