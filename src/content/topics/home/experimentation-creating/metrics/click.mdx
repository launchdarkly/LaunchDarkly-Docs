...
CSS selectors designate specific areas of your product UI, like buttons or images, that your users can interact with. You can create a metric that monitors interaction with any CSS selector.
