...
<Callout intent="info">
  ...
  <CalloutDescription>
    Custom roles are only available to customers on our enterprise plans. To learn more about enterprise plans, contact
    [sales@launchdarkly.com](mailto:sales@launchdarkly.com?Subject=Custom%20roles).
  </CalloutDescription>
</Callout> # Custom roles
...
To learn more, read [Configuring custom roles](/home/account-security/custom-roles/configure).
...
- [Resources in custom roles](/home/account-security/custom-roles/resources)
- [Tags in custom roles](/home/account-security/custom-roles/tags)
- [Actions in custom roles](/home/account-security/custom-roles/actions)tions-in-custom-roles)
