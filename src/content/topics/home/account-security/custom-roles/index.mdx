...
Custom roles are only available to customers on our Enterprise plans. To learn more about Enterprise plans, [contact Support](http://support.launchdarkly.com) or your LaunchDarkly account representative.
...
- Create private projects that only the team members you select can see. To learn more, read [Creating private projects with custom roles](/home/account-security/custom-roles/private-projects).
...
To learn more about what each of these roles can do, read [Understanding member roles](/home/account-security/managing-your-team#understanding-member-roles).
...
For templates that match these permission levels, read [Example policies](/home/account-security/custom-roles/example-policies).
...
3. Assign the role to the team member or resource who needs it.
...
We strongly recommend familiarizing yourself with the concepts that power custom roles first. To learn more, read [Custom role concepts](/home/account-security/custom-roles/concepts).
