...
This topic uses the `viewProject` action to restrict and grant access to projects. To learn more about this action, read [Actions in custom roles](/home/account-security/custom-roles/actions).
...
<Callout intent="info">
  ...
  <CalloutDescription>
    ...
    in any way. You can use the policies below to control who can access and modify the feature flags or other child
