...
This topic uses the `viewProject` action to restrict and grant access to projects. To learn more about it, read [Actions in custom roles](/home/account-security/custom-roles/actions).
