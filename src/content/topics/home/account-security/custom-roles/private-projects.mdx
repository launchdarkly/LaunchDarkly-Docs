...
This topic uses the `viewProject` action to restrict and grant access to projects. To learn more about this action, read [Using actions](/home/account-security/custom-roles/actions).
