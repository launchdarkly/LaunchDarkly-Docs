...
To learn more about how tags work within custom role policies, read [Custom role concepts](/home/account-security/custom-roles/concepts).  

## Adding tags to resources

You can add tags to resources in LaunchDarkly with the UI or API. To learn more, read [Other flag settings](/home/managing-flags/flag-settings).
