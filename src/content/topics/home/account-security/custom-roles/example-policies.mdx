...
This topic shows some examples of different types of policies you can implement with custom roles. 
...
For a complete list of flag actions, read the [Feature flag actions list](/home/account-security/custom-roles/actions#feature-flags-actions).
...
[
  ...
  },
  {
    ...
    "notActions": ["createFlag", "updateFlagVariations", "updateTags"],
    "effect": "deny"
  }
]
```
