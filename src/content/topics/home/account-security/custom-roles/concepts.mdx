---
path: '/home/account-security/custom-roles/concepts'
...
To learn more about specific resources, read [Using resources](/home/account-security/custom-roles/resources).
...
To learn more about specific actions, read [Using actions](/home/account-security/custom-roles/actions).
...
To learn more about configuring the `viewProject` action, read [Creating private projects with custom roles](/home/account-security/custom-roles/private-projects).
...
To learn more about specific policies, read [Using policies](/home/account-security/custom-roles/policies).
...
To learn more about specific tags, read [Using tags](/home/account-security/custom-roles/tags).