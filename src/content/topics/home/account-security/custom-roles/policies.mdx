...
To learn more, read [Custom role concepts](/home/account-security/custom-roles/concepts).

To learn how to create a policy, read [Creating custom roles and policies](/home/account-security/custom-roles/create).
...
For a more detailed explanation of the policy above, read [Granting all actions to just one flag while showing only one project](/home/account-security/custom-roles/policies#granting-all-actions-to-just-one-flag-while-showing-only-one-project). 
...
To learn more about creating policies in LaunchDarkly, read [Configuring custom roles](/home/account-security/custom-roles).
