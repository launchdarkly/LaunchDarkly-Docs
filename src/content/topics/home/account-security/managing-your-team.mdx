...
dashboard](/home/managing-users/users-dashboard).
...
Use the **Team** tab to invite new team members to LaunchDarkly, remove old team members, or manage access controls for team members by setting roles. You can also use this dashboard to see when members last accessed LaunchDarkly.
...
* To invite new team members to LaunchDarkly, enter their email address and click **Send Invitation** 
* To delete team members or manage their access controls, click **Edit** next to an existing user to modify their information.
* To view and export team members in a csv file, click **Export CSV**. The file will export with your filters and sorting applied.
...
You can export a csv file of LaunchDarkly members on the **Team** tab. To access the list:
