...
<Callout intent="info">
  ...
  <CalloutDescription>
    ...
    more about our enterprise plans, contact
...
6. at 4.06.41 PM.png",
   ...
   [/block]
7. Enter the key for the custom role you wish to assign to this group. This connects one role to the selected group.
   [block:image]
   {
   "images": [
   {
...
8. at 4.05.56 PM.png",
   ...
   [/block]
9. Add more custom roles to this group by clicking **Add Another** and repeating step 6.
