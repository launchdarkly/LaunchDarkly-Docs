...
- A Microsoft Server instance with ADFS installed and configured.
  ...
  <Callout intent="alert">
    ...
    <CalloutDescription>
      This topic will not tell you how to set up ADFS. For information about setting up ADFS, see [Microsoft's
      documentation](
...
![The Edit Claim Issuance Policy field is called out.](../../../../images/)

4. Click **Add Rule**.

![The Edit Claim Issuance Policy screen.](../../../../images/)
