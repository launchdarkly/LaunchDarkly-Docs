...
5. Click "Continue". A confirmation screen with recovery codes appears.
   ...
   <Callout intent="alert">
     ...
     <CalloutDescription>
       **Store your recovery codes in a safe location other than your mobile device**. If you lose your recovery codes
       and cannot access your account, you must contact a LaunchDarkly administrator for help. They can send you a new
       recovery code.
     </CalloutDescription>
   </Callout>
