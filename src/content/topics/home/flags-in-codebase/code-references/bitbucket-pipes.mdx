  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        ...
        must have a unique <code>LD_PROJ_KEY</code> and <code>LD_REPO_NAME</code> combination so it displays correctly in the flags list. Defaults to the current Bitbucket repository.
      </TableCell>
