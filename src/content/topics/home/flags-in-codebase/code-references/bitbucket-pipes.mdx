...
Alternatively, you can give the access token access to a custom role with the `code-reference-repository` resource specifier. To learn more, read [Custom roles](/home/team/custom-roles).
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        A LaunchDarkly project key. Find it in **Account settings > Projects**.
      </TableCell>
      <TableCell>Yes</TableCell>
    </TableRow>
    <TableRow>
