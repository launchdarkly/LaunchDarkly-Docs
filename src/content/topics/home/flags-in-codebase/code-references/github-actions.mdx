...
<Callout intent="primary">
  <CalloutTitle>Code references is a Pro and Enterprise feature</CalloutTitle>
  <CalloutDescription>

Code references is available to customers on a Pro or Enterprise plan. To learn more, [read about our pricing](https://launchdarkly.com/pricing/). To upgrade your plan, [contact Sales](https://launchdarkly.com/contact-sales/).
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        ...
        dashboard. Defaults to the current Github repository.
      </TableCell>
