...
Include both the `LD_ACCESS_TOKEN` as a secret and a new environment variable containing your LaunchDarkly project key. Find the project key in **Account Settings > Projects** in the flag dashboard.
...
You can also use the [`.launchdarkly/coderefs.yaml`](https://github.com/launchdarkly/ld-find-code-refs/blob/master/docs/CONFIGURATION.md#advanced-yaml-configuration) file for advanced configuration options, such as configuring custom delimiters and aliases for your flag keys.
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        A LaunchDarkly project key. Found under Account Settings > Projects in the flag dashboard.
      </TableCell>
      <TableCell>Yes</TableCell>
    </TableRow>
    <TableRow>
      ...
      <TableCell>
        ...
        must have a unique <code>LD_PROJ_KEY</code> and <code>LD_REPO_NAME</code> combination so it displays correctly in the flag
