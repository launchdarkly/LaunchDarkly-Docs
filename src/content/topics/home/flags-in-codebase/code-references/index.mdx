...
## Using ld-find-code-refs in environments requiring FIPS 140-2 validated encryption

If you are using the ld-find-code-refs in an environment that requires the use of FIPS 140-2 
