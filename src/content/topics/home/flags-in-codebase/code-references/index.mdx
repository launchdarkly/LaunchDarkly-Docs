...
<Callout intent="info">
  <CalloutTitle>The creator of the API access token must have an appropriate role</CalloutTitle>
  <CalloutDescription>
...
<CodeSample>
<CSTab label="Example flag variable">
