...
If you do not remove a flag from your code after you archive it, then all end users encountering the feature will receive the flag's fallback value. To learn more about fallback values, read [Configuring variations](/sdk/features/evaluating#configuring-variations).
