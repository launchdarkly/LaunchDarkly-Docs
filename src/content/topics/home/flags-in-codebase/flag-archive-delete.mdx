...
When you archive a flag in LaunchDarkly, you should also remove the flag from your code. If you do not remove an archived flag from your code, then all end users encountering the feature will receive the fallback value. To learn more about fallback values, read [Configuring variations](/sdk/features/evaluating#configuring-variations).
