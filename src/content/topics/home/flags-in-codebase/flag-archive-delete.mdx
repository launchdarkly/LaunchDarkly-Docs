...
![A flag that cannot be archived due to dependencies.](../../images/flag-cannot-archive.png)
...
![A flag with no dependencies that prevent it from being archived.](../../images/flag-can-archive.png)
...
![An archived flag.](../../images/flag-archived.png)


You can also archive a flag from the flag's Settings page:

![The archive option on a flag's Settings page.](../../images/flag-settings-archive.png)
...
![The "Archive this flag?" screen with dependencies that block it from being archived.](../../images/flag-cannot-archive.png)
...
![A flag with dependencies that do not block it from being archived.](../../images/flag-archive-mixed-dependencies.png)
...
![The "View archived flags" option.](../../images/flag-compare-archive-menu.png)


Archived flags appear on their own dashboard, which is indicated with grey and white stripes:

![The "Archived feature flags" screen.](../../images/flag-archived.png)
...
![An archived flag with the "Restore" button called out.](../../images/flag-archive-restore-callout.png)
...
![The "Restore this flag?" screen.](../../images/flag-archive-restore-confirm.png)


You can also restore an archived flag from the flag's Settings page:

![The "Restore flag" section of the flag's Settings page.](../../images/flag-settings-restore.png)
...
![The Edit menu with the **View archived flags** option selected.](../../images/flag-compare-archive-menu.png)

3. Find the flag you wish to delete.
4. Click **Delete**. The "Delete this flag?" screen appears:

![The "Archived feature flags" screen with the Delete button called out.](../../images/flag-archive-restore-callout.png)
