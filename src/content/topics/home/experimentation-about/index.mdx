...
![An active experiment.](experiment-card.png)
...
3. You must email support@launchdarkly.com to have audience allocation enabled on your account.
...
Experiment data is collected on an experiment's **Results** tab, which displays experiment data in near-real time.
...
To learn more, read [Analyzing experiments](/home/analyzing-experiments).
