...
You can run experiments on boolean, string, and number flags, but not JSON flags. To learn about Experimentation use cases, read [Example experiments](/guides/experimentation/example-experiments).
