...
description: 'This topic explains some of the configuration options you can use to increase user privacy in LaunchDarkly. Using these features can impact certain features in the LaunchDarkly UI.'
published: false
---
