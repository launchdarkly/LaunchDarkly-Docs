...
description: 'This topic explains what aspects of LaunchDarkly you can customize to decrease or eliminate the amount of user data LaunchDarkly receives. Some aspects of LaunchDarkly may not work as expected if you choose more restrictive user data constraints.'
---
