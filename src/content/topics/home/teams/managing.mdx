...
4. Click **Upload CSV**. The "Upload CSV" screen appears:

![The Upload CSV screen.](teams-upload-csv-modal.png)

5. Click **Select file**. A prompt to choose a file appears.
6. Choose a CSV file. You are returned to the "Upload CSV" screen.
7. Click **Upload file.**
...
<Table>
  ...
  <TableRow>
    ...
    <TableCell>All listed members are already on this team. No action needed.</TableCell>
  </TableRow>
  <TableRow>
...
<Table>
  ...
  <TableRow>
    ...
    <TableCell>This email address appears in the file twice. Click **Add valid entries** to skip the duplicated email.</TableCell>
  </TableRow>
  <TableRow>
  ...
  <TableRow>
    <TableCell>Email doesn’t belong to LaunchDarkly member</TableCell>
