...
You can also use the REST API: [Add a member to teams](https://apidocs.launchdarkly.com/tag/Account-members#operation/postMemberTeams), [Update a team](https://apidocs.launchdarkly.com/tag/Teams#operation/patchTeam)
...
<Callout intent="info">
<CalloutTitle>Adding members to a team in bulk is an Admin-only feature</CalloutTitle>
<CalloutDescription>

The bulk editing feature is only accessible if you're a LaunchDarkly Admin or Owner, or have a custom role that allows the <code>updateTeamMembers</code> action. To learn more, read [Understanding member roles](/home/members/managing#understanding-member-roles) and [Team actions](/home/members/role-actions#team-actions).
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        ...
        [Adding members to LaunchDarkly](/home/members/managing#adding-members-to-launchdarkly).
      </TableCell>
    </TableRow>
  </TableBody>
</Table>
