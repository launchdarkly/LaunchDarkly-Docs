...
5. Click the ellipsis button at the right of the row of the team you want to remove the member from.
8. Click **Remove member**. A confirmation modal appears.
7. Confirm by clicking **Remove member** again in the modal.
...
3. Find the "Teams" column. The teams of which that member is a part are listed here. There may be additional teams in the overflow menu. Click the overflow link to view the Teams tab on that member's page. It has a complete list of that member's teams, along with an indicator that shows any teams that they are assigned as a team maintainer.
