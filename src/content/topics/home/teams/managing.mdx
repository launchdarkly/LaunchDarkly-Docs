...
You can also use the REST API: [Add multiple members to team](https://apidocs.launchdarkly.com/tag/Teams-(beta)/#operation/postTeamMembers)
...
You can also use the REST API: [Delete team](https://apidocs.launchdarkly.com/tag/Teams-(beta)/#operation/deleteTeam)
