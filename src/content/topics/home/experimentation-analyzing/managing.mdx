...
5. Choose a new randomization unit as needed. To learn more, read [Randomization units](/home/creating-experiments/allocation#randomization-units).
...
![The targeting section of a flag's "Targeting" tab.](experiment-flag-targeting-tab.png)
...
Your winning variation is the flag variation that has the most positive impact compared to the baseline. You can roll the winning variation out to 100% of your end users from the flag's **Targeting** tab. To learn how, read [Percentage rollouts](/home/flags/rollouts).
