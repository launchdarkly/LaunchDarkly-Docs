...
<Callout intent="info">
<CalloutTitle>These columns may be in your experiment's Statistics details tab</CalloutTitle>
<CalloutDescription>

If you have access to attribute filters, these columns will appear in an experiment's results table under the <strong>Statistics details</strong> tab.
