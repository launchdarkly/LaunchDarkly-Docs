...
- **Mean**: The mean is the average value of the variation. It doesn’t capture the uncertainty in the measurement, so it should not be the only measurement you use to make decisions.
