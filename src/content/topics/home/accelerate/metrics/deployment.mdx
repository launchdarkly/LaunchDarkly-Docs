...
This topic explains how to use LaunchDarkly's deployment frequency metric view. To learn how to configure this metric, read [Send deployment information to Accelerate](/home/accelerate/config-deployment-accelerate).
