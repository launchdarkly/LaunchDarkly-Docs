...
If you do not need to uniquely identify your anonymous users, you can use a shared key for them. If you do this, you can still target users by their attributes, but you will not be able to target specific sets of users unless they have unique keys.
