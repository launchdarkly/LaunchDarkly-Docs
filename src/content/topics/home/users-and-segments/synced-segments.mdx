...
<CodeTabs
  defaultValue="json"
  values={[
    { label: 'Example policy', value: 'json', },
  ]
}>
...
You can view your synced Amplitude cohort as a segment in LaunchDarkly. It appears on the **Segments** dashboard with the Amplitude logo in its name:

![The "Segments" dashboard with the Amplitude-driven segment called out.](segments-amplitude-dashboard-callout.png)

Click into that segment's **Targeting** tab to see details about its targeting:
