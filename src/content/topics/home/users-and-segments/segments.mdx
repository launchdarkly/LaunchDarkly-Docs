...
You can view segments and Big Segments on the **Segments** dashboard. From the dashboard you can filter segments to display only those synced from Amplitude.
