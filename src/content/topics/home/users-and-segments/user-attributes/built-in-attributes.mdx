...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>This attribute must be an absolute URL to a profile picture for the user. The profile picture appears on the <strong>Users</strong> list.</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
        <code>firstName</code>
