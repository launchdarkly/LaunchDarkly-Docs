...
You should not set the value of a custom attribute to a JSON object. If you do, it won't appear on the **Users** dashboard. To learn more, read [Using custom attributes](/sdk/concepts/flag-types#using-custom-attributes).
