...
If you set the value of a custom attribute to a JSON object, it won't appear on the **Users** dashboard.

You can set custom attributes by configuring user objects within your SDK. To learn how, read [User configuration](/sdk/features/user-config).
