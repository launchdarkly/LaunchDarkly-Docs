...
If you initially mark an attribute as private, LaunchDarkly will continue to treat the attribute as private in subsequent evaluations. If you no longer want LaunchDarkly to treat the attribute as private, delete the user from the Users dashboard and re-evaluate the user with the non-private attribute.
