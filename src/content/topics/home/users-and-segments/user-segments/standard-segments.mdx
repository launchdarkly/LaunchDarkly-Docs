...
This topic explains how to customize and manage standard user segments. Standard segments let you target groups of users by attribute. 

To learn how to build standard segments, read [Creating user segments](/home/users/segments#creating-user-segments).
