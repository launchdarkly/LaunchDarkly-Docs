...
A Big Segment is a kind of segment that is backed by an external data store. Big Segments can support massive numbers of targets. The limit is based on the limits of the data store you configure.
A standard user segment is capped at 50,000 users. To use Big Segments, you must meet additional prerequisites.
...
You can also target individual users for inclusion in a Big Segment.
