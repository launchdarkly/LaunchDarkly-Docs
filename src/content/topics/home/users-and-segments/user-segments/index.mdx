...
- Segment targeting can reference another segment if both segments exist in the same environment. You cannot create a circular reference, for example, having segment A target segment B and segment B target segment A.
