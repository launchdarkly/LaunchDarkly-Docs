...
7. Select the **Under 15,000 users** option to create a standard segment, or the **15,000 or more users** option to create a Big Segment. You cannot convert a segment from one kind to another after you create it.
