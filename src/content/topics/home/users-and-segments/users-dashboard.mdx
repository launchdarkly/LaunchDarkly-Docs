...
1. From the **Users** dashboard click the user you wish to modify. Their user page appears, with their unique attributes on the left and their expected flag variations on the right.
