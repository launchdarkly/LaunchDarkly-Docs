...
You can remove users you don't need anymore by clicking the **Delete** button on their user card. Customers on a Pro or Enterprise plan can also remove users using the LaunchDarkly API. To learn more, read [Removing a user](/home/users/users-dashboard#removing-a-user).
