...
If you are interested in developing an OAuth application, [Register a new OAuth application](https://support.launchdarkly.com/hc/en-us/requests/new) to get started developing your own.
