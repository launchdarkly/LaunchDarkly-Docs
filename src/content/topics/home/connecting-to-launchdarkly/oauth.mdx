...
description: 'This topic explains the workflow to authorize or revoke access of an OAuth app. You can connect your LaunchDarkly account to external applications using the OAuth 2.0 protocol. Some applications can act on your behalf, such as by turning feature flags on and off.'
published: true
---
...
<Callout intent="alert">
  ...
  <CalloutDescription>
    It is critically important to only authorize applications you trust to use your LaunchDarkly account. Read the
    permissions required by the app carefully and use your own best judgment about whether you trust an app enough to
    use it.
  </CalloutDescription>
</Callout> 
...
If you are interested in developing an OAuth application,
[Register a new OAuth application](https://support.launchdarkly.com/hc/en-us/requests/new) to get started developing
your own.
...
<Callout intent="info">
  ...
  <CalloutDescription>
    For example, if you are a Writer and authorize an app, and then are downgraded to a Reader, your app will only have
...
<Callout intent="info">
  ...
  <CalloutDescription>
    If you are a LaunchDarkly administrator, you can revoke access of any app added to LaunchDarkly, regardless of which
    team member added it.
  </CalloutDescription>
</Callout>
...
![The Application access screen.](../images/oauth-app-access.png) 
...
![The confirmation dialog with "yes" entered in the confirmation text box.](../images/oauth-app-access-revoke.png) 
