...
If you are interested in developing your own OAuth application, read [Registering a LaunchDarkly OAuth client](/integrations/partner-integrations/oauth-client-registration).
