...
Once SSO is turned on, the LaunchDarkly login procedure defers to your identity provider for authentication. Members will no longer be able to log in with their existing LaunchDarkly password, and members logging in to LaunchDarkly for the first time will need to log in through their IdP.
...
Team sync with IdP is only available to customers on an Enterprise plan. To learn more, [read about our pricing](https://launchdarkly.com/pricing/). To upgrade your plan, [contact Sales](https://launchdarkly.com/contact-sales/).
...
* You can only make changes to your synced teams' names and memberships through your IdP. You can still maintain unsynced teams can in the LaunchDarkly UI.
* You can still manage team permissions in LaunchDarkly. To learn how to add custom roles to a team, read [Managing team permissions](/home/teams/managing#managing-team-permissions).
...
4. Click **Turn on team sync**. 
   ![Turn on team sync within the "SSO management" section of the "Security tab".](settings-security-turn-on-team-sync.png)

You can now manage teams within the admin panel of Okta.
Teams you have synced with an IdP have limited team management permissions in LaunchDarkly. You can tell which teams you have synced with an IdP on the **Teams** tab in the "Team sync with IdP" column.
![The "Team sync with IdP" column on the "Teams" tab.](teams-synced-with-idp-PLACEHOLDER.png)
