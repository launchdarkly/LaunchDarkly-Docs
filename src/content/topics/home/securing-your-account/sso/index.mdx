...
When you're satisfied with the SSO integration and are ready to turn it on it for all account members in LaunchDarkly, turn on SSO by following the procedure below.
...
Once SSO is turned on, the LaunchDarkly login procedure defers to your identity provider for authentication. Users will no longer be able to log in with their existing LaunchDarkly password, and users logging in to LaunchDarkly for this first time will need to log in through their IdP.
