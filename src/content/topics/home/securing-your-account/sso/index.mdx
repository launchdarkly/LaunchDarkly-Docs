...
1. Enable SAML SSO in your account. Configure LaunchDarkly to use your IdP when account members request access. To learn how to do this, read [Configuring SAML SSO](/home/account-security/sso/saml).
2. (Optional) Configure SCIM to enable the automation of user and group provisioning. To learn how to do this, read [Enabling SCIM provisioning](/home/account-security/sso/scim).
