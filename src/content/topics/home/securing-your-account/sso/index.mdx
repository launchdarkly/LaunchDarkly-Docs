...
If you have not specified a role or custom role for new LaunchDarkly members through your IdP, LaunchDarkly sets the default role to Reader. Certain Enterprise customers can change the default role to No access. To learn how, read the configuration guidance for your IdP.
