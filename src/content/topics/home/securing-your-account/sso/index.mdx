...
ADFS and Azure are available to customers on a Starter or Pro plan with the SSO add-on. However, support for ADFS and Azure from our Support team is available only to customers on an Enterprise plan. To learn more, [read about our pricing](https://launchdarkly.com/pricing/). To upgrade your plan, [contact Sales](https://launchdarkly.com/contact-sales/).
