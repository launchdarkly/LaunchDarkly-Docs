...
Once SCIM is configured, administrators can optionally turn on and configure team sync with SCIM. Team sync with SCIM allows administrators to sync groups in their IdP with teams in LaunchDarkly to automate team member provisioning.
