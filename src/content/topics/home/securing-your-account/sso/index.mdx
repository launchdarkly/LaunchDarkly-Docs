...
When you're satisfied with the SSO integration and are ready to turn it on for all account members in LaunchDarkly, you can turn on SSO.
...
After you turn on SSO, the LaunchDarkly login procedure defers to your identity provider for authentication. Members will no longer be able to log in with their existing LaunchDarkly password, and members logging in to LaunchDarkly for the first time will need to log in through their IdP.
...
You can turn off SSO at any time. When you turn off SSO, any existing members will still be able to sign into LaunchDarkly with their previous passwords, or reset their passwords.

LaunchDarkly will require users that were provisioned through SSO to reset their password to sign into LaunchDarkly.
