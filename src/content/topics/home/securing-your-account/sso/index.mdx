...
Team sync with IdP is only available to customers on an Enterprise plan and requires SCIM to be configured. To learn more, [read about our pricing](https://launchdarkly.com/pricing/). To upgrade your plan, [contact Sales](https://launchdarkly.com/contact-sales/).

</CalloutDescription>
</Callout>

LaunchDarkly allows you to sync groups from your IdP to teams within your account. This feature will create a new team, or link an existing one, with the same name and membership as the IdP group. Once team sync is turned on, any changes to your synced teams' memberships can only be made through your IdP.
