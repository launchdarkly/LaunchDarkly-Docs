...
You can now manage teams within the admin panel of Okta. Teams you have synced with Okta have limited team management permissions in LaunchDarkly. 

You can tell which teams you have synced on the **Teams** tab in the "Synced with (IdP)" column:
