...
2. Optionally configure SCIM to enable the automation of user and group provisioning. To learn how to do this, read [Enabling SCIM provisioning](/home/account-security/sso/scim).
