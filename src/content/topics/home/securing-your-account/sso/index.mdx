...
Teams you have synced with an IdP have limited team management permissions in LaunchDarkly. You can tell which teams you have synced with an IdP on the **Teams** tab in the "Synced with IdP" column.
![The "Synced with IdP" column on the "Teams" tab.](teams-synced-with-idp.png)
