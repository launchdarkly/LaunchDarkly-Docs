  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        ...
        <br />
        Find the endpoint in Service, then Endpoints. Search for an endpoint with the <code>
...
You can map LaunchDarkly custom role attributes to ADFS using a claim issuance policy. To learn more about SSO provisioning for roles and custom roles, read [Custom roles](/home/members/custom-roles).
...
After you successfully complete the procedures in this topic, you can log in through ADFS when test-drive mode is enabled. To learn more, read [Test-drive mode](/home/account-security/sso/saml#test-drive-mode).

If you are able to successfully log in with test-drive mode enabled, you can enable SSO for the rest of your organization. To learn more, read [Single sign-on](/home/account-security/sso).
