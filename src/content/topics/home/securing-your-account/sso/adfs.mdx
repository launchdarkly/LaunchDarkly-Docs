...
This topic does not tell you how to set up ADFS. To learn more about setting up ADFS, read [Microsoft's documentation](https://docs.microsoft.com/en-us/previous-versions/dynamicscrm-2016/deployment-administrators-guide/)
