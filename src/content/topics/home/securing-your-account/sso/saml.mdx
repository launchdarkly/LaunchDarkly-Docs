...
* [Azure AD](/home/account-security/azure)
...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>SSO and SCIM</TableCell>
      <TableCell>
        One of the built-in LaunchDarkly roles: <code>reader</code>, <code>writer</code>, <code>admin</code>, and for some customers, <code>no_access</code>. If unspecified, the default role is <code>reader</code>. <br/><br/>SCIM attribute name: <code>urn:ietf:params:scim:schemas:extension:launchdarkly:2.0:User:role</code>
      </TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>
        ...
        To learn more about Teams, read [Teams](/home/teams). To learn about managing teams with SCIM, read [Team sync with SCIM](/home/account-security/sso/scim#team-sync-with-scim).
      </TableCell>
    </TableRow>
  </TableBody>
</Table>
