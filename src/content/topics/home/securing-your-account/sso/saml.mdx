...
<Callout intent="alert">
<CalloutTitle>Managing Teams with SAML SSO and SCIM</CalloutTitle>
<CalloutDescription>

The `teamKey` attribute is **only available for SAML SSO**. To learn more about managing teams with SCIM, read [Team sync with SCIM](/home/account-security/sso/scim#team-sync-with-scim).
