...
### Unlinking and Deactivating Group Push in Okta

![Unlink and deactivate group push in Okta.](okta-deactivate-groups.png)

Once a team has been synced to an Okta group, it is unable to be unsynced. We therefore recommend that you choose the "Unlink pushed group" option and then choose to "Delete the group in the target app" when you wish to remove a synced team from LaunchDarkly.

![Unlink pushed group in Okta.](okta-unlink-push-group.png)

Deactivating group push or unlinking a group while leaving the group in the target app will result in an orphaned team in LaunchDarkly that cannot be managed or maintained within the LaunchDarkly UI.