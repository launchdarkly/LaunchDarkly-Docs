...
<Callout intent="alert">
  ...
  <CalloutDescription>
    You can assign either a role or a custom role in this step, but not both. If you enter values in both the R ole and customRole fields, Okta ignores the customRole field.
  </CalloutDescription>
</Callout>
