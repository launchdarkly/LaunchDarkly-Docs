...
![The Browse App Integration Catalog screen with search results populating.](okta-ld-app.png)
...
3. Click **Configure API Integration**:
    ...
    ![The Integration page with the API integration button called out.](okta-configure-api-integration.png)
...
![The "Assign" dropdown.](okta-assignments-assign-dropdown.png)
...
![The Okta LaunchDarkly Attribute Mappings screen with custom roles available.](okta-ld-attribute-mappings.png)
