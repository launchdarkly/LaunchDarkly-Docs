...
Once the push status in Okta is "Active", you can confirm the new team was created and synced with Okta on the **Teams** tab in LauncDarkly.

![The "Teams" tab showing teams synced with Okta.](teams-synced-with-idp-PLACEHOLDER.png)
