...
You can connect the LaunchDarkly app to Okta by using SCIM. This allows you to provision, manage, and deprovision LaunchDarkly account members in Okta.
...
- You must have [turned on team sync with SCIM](/home/account-security/sso#team-sync-with-scim).
