...
You can now [manage teams within the admin panel of Okta](/home/account-security/okta#using-okta-to-manage-launchdarkly-teams-with-scim). Teams you have synced with Okta have limited team management permissions in LaunchDarkly.
