...
You can also use the REST API: [OAuth2 Clients](https://apidocs.launchdarkly.com/tag/OAuth2-Clients)
...
<Callout intent="primary">
<CalloutTitle>Team sync is available for Okta</CalloutTitle>
<CalloutDescription>
