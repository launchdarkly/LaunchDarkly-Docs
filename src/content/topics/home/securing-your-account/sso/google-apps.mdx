...
3. Click on the GSuite user that you want to assign roles to and choose **Account** to bring up the user's account settings.
...
The next time this user logs into LaunchDarkly through GSuite, their roles will update. If this is a brand new LaunchDarkly account member, an account will be created automatically with the roles you specified.
