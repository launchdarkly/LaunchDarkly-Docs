...
In order to follow these instructions, you must have a LaunchDarkly account that does not have SSO enabled.

If you sign in to LaunchDarkly though a single sign-on (SSO) provider, such as Okta, Google, or your organization's SSO, you can reset your password through that provider. To learn more, read [Single sign-on](/home/account-security/sso).
