...
1. From the LaunchDarkly dashboard, navigate to **Account Settings**.
2. Click **Profile**. The "Profile" screen appears.

 a. Alternatively, click your user icon. A popup menu appears. <br/>
 b. Choose **User profile**.
