...
5. In the "Reset token?" dialog, enter the number of hours to keep the old token active.
6. Enter the name of the access token to confirm the reset. Then click **Reset**.
