...
![The Enable MFA section of a user profile.](../../images/mfa.png)
...
![The Enable MFA screen, with an obscured QR code.](../../images/mfa-qr.png)
...
![The Enable MFA screen, with an obscured six digit code called out.](../../images/mfa-qr-callout.png)

5. Click "Continue". A confirmation screen with recovery codes appears.

![The success screen, with obscured recovery codes displayed.](../../images/mfa-recovery-codes.png)
