...
Administrators can also require all newly invited team members on the team to enable MFA when they first log in.
...
Here is an image of the Multi-factor authentication screen:
...
To follow the procedures in the next section, you must be a LaunchDarkly Admin or Owner. If you're a LaunchDarkly administrator or account owner, you can require all newly invited team members to enable MFA.

</CalloutDescription>
</Callout>

To require multi-factor authentication, click the checkbox labeled **Require multi-factor authentication for new members** under **Multi-factor authentication** on your [Security](https://app.launchdarkly.com/settings#/security) page.
