...
3. In the **Session duration** fields, enter a number and choose a unit for the session length.
4. (Optional) Check the **Refresh sessions automatically** checkbox to reset the session start time every time an account member accesses LaunchDarkly.
5. Click **Save**.
