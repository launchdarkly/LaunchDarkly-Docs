...
You cannot use scheduled flag changes to schedule user removal dates because of potential date and time conflicts between the scheduled flag and the scheduled user removal. To learn more about scheduling, read [Scheduling user removal from segments](/home/users/segments#scheduling-user-removal-from-segments).
