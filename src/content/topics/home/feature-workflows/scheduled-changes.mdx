...
3. Click the **dropdown icon** in the **Save changes** button and select "Schedule changes":
...
6. Click **Apply**.
7. Review and confirm the changes displayed in the dialog. If you need to make changes, click **Edit**, change what you need, and then click **Done**:

![The "Edit changes" dialog.](workflows-edit-changes.png)
