...
You can delete your own approval requests. To learn more, read [Deleting an approval request](#deleting-an-approval-request).
...
3. Review the flag changes and choose to approve or decline the changes. Optionally, you can leave a comment summarizing your decision.
  ...
  b. (Optional) Click into the dropdown and choose **Approve changes**. If you approve an approval request but do not apply it, the original requester, or any team member with a writer, owner / admin, or custom role can apply the  changes you approved.
...
![The overflow menu expanded with the "Delete request" option selected.](../../images/approvals-delete-overflow.png)
