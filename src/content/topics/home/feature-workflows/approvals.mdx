...
3. Review the flag changes and choose to approve or decline the changes. Optionally, you can leave a comment summarizing your decision.
  ...
  b. (Optional) Click into the menu and choose **Approve changes**. If you approve an approval request but do not apply it, the original requester, or any account member with a writer, owner / admin, or custom role can apply the  changes you approved.
