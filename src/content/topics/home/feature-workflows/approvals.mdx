...
You can also use the REST API: [Get approval request (beta)](https://apidocs.launchdarkly.com/tag/Approvals-(beta)#operation/getApprovalRequest), [Get approval requests (beta)](https://apidocs.launchdarkly.com/tag/Approvals-(beta)#operation/getApprovalRequests)
...
You can also use the REST API: [Review approval request](https://apidocs.launchdarkly.com/tag/Approvals/#operation/postApprovalRequestReview)
