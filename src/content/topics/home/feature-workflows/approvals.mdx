...
You can request approval on changes to a flag's targeting at any point after creation, from any member or team within your LaunchDarkly organization. Members that do not have permission to approve requests can still view the change.
...
Reviewers will receive an email, an in-app inbox notification, and a Slack notification, if applicable, asking them to approve your flag changes.
...
2. Click **Pending changes** icon on the flag's **Targeting** tab. The Pending changes panel opens.
