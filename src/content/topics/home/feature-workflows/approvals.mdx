...
title: Approvals
description: This topic explains how to use LaunchDarkly's approvals feature to request reviews for changes you plan to make to a flag. It also explains how to review approval requests.
published: true
...
This topic explains how to use LaunchDarkly's approvals feature to request reviews for changes you plan to make to a flag. It also explains how to review approval requests.
...
You can customize an environment's approval settings in the **Environments** tab of a project under the **Account settings** page. To learn more, read [Configuring approvals for an environment](/home/feature-workflows/environment-approvals).
...
To view approval notifications from a flag:
...
### Viewing approval requests from Slack
