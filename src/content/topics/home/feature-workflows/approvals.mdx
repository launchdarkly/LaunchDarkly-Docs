...
You can customize an environment's approval settings in the **Environments** tab of a project under the **Account settings** page. To learn more, read [Configuring approvals by environment](/home/feature-workflows/environment-approvals).
