...
* After any change to flag configuration on the flag's **Targeting** tab, the **Save changes** button changes to **Request approval**. When you click it, the "Request approval" dialog appears.
