...
* **Require approvals for this environment**: Select this checkbox to require flag targeting changes in this environment.
...
* **Allow modifying and deleting pending changes without approval**: Select this checkbox to stop creating approval requests when a team member deletes or modifies a pending change. 
