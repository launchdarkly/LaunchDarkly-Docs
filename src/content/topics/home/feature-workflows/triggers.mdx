...
If you lose a trigger's URL, you can reset it from the trigger's **three-dot** overflow menu. To learn more, read [Managing existing flag triggers](#managing-existing-flag-triggers).
