...
If you lose a trigger's URL, you can reset it from the trigger's **three-dot** overflow menu. To learn more, read [Managing existing triggers](#managing-existing-triggers).
...
If you use custom roles to manage your team, every team member who needs to manage triggers must be able to use the `updateTriggers` action. To learn more, read [Custom roles](/home/team/custom-roles).
