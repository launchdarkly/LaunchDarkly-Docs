...
You can also use the REST API: [List approval requests](https://apidocs.launchdarkly.com/tag/Approvals/#operation/getApprovalRequests), [List approval requests for a flag](https://apidocs.launchdarkly.com/tag/Approvals#operation/getApprovalForFlag), [Get approval request for a flag](https://apidocs.launchdarkly.com/tag/Approvals/#operation/getApprovalRequest)
