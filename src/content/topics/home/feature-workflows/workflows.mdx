...
You can also use the REST API: [Workflows (beta)](https://apidocs.launchdarkly.com/tag/Workflows/)
...
- [Progressive rollout workflows](#building-a-progressive-rollout-workflow) gradually increase the percentage of contexts targeted by a flag.
- [Maintenance windows](#building-a-maintenance-window-workflow) let you temporarily toggle a flag off or on.
- [Custom workflows](#building-a-custom-workflow) manage a specific rollout process that you define.

You can also save a workflow as a template to reuse later. To learn how, read [Workflow templates](/home/feature-workflows/workflow-templates).
