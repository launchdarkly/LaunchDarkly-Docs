...
4. Select the option to create a **Custom workflow**.

![Select the option to create a Custom workflow.](click-create-custom-workflow.png)

3. Build the workflow with the steps that you’d like each flag to follow.
4. Click **Save as template**.
5. Give the template a name, a key, and add an optional description. Then click **Next**.
6. Click **Start workflow** if you would also like to run the workflow on the flag.
...
4. Select the option to use a **Template**.

![Select the option to use a template.](click-templates.png)
...
Use the REST API: [Delete workflow template](https://apidocs.launchdarkly.com/tag/Workflow-templates-(beta)#operation/deleteWorkflowTemplate)
