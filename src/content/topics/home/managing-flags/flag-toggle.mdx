...
when. For example, you can serve `false` to deprecate a feature after a date of your choosing. To learn more
about targeting a flag to appear before or after a date, read [Targeting users](/home/managing-flags/targeting-users).
