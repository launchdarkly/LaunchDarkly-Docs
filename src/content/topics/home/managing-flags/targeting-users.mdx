...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        user is included or excluded by the targeting rules for the named segments. Read more about <a href="/home/managing-users/segments">Building user segments</a>.
      </TableCell>
    </TableRow>
    <TableRow>
