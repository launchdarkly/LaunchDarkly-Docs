...
When you edit an environment, you see the option to reset your SDK key for that environment. Click **Reset SDK Key** to bring up a confirmation screen. From there, you have the option to keep the old SDK key active for a period of time, up to a maximum of 720 hours (30 days).
...
In high volume PHP environments, we strongly recommend using our Relay Proxy. To learn more, read [The Relay Proxy](/home/advanced/relay-proxy).
