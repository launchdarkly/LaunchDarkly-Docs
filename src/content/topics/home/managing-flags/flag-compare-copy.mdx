...
5. Select checkboxes to choose which settings you would like to copy over from the source environment.
   ...
   [/block]
6. Click **Copy Settings** to save the changes.
   <Callout intent="alert">
     ...
     <CalloutDescription>
       ...
       rules references a segment that does not exist in the target environment, you cannot copy any targeting rules.
       You will still be able to copy Targeting state, Prequisites, Individual user targets, Default rule, and fallback
       rule (\"If targeting is off, serve\").
     </CalloutDescription>
   </Callout>
