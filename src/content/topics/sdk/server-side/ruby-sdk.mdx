...
Feature flag targeting and rollouts are all determined by the _user_ you pass to your `variation` calls. In our Ruby SDK, users are simply hashes. Here's an example:
[block:code]
{
"codes": [
{
