...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>[SDK API docs](https://launchdarkly.github.io/dotnet-server-sdk/)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>GitHub repository</TableCell>
      <TableCell>[dotnet-server-sdk](https://github.com/launchdarkly/dotnet-server-sdk)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Sample application</TableCell>
      <TableCell>[.NET (server-side)](https://github.com/launchdarkly/hello-dotnet-server)<br/> [OpenFeature .NET (server-side)](https://github.com/launchdarkly/hello-openfeature-dotnet-server)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Published module</TableCell>
      <TableCell>[NuGet](https://www.nuget.org/packages/LaunchDarkly.ServerSdk/)</TableCell>
    </TableRow>
  </TableBody>
</Table>
