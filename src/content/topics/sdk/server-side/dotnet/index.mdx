...
<Callout intent="info">
<CalloutTitle>Version requirements</CalloutTitle>
<CalloutDescription>

Version 6.0 and higher of the LaunchDarkly .NET SDK is compatible with .NET 5.0+, .NET Framework 4.5.2+, and .NET Core 2.1+.
