---
path: '/sdk/server-side/python-twisted/'
title: 'Python Twisted SDK Reference'
---

# Python Twisted SDK Reference
...
Custom attributes are one of the most powerful features of LaunchDarkly. They let you target users according to any data that you want to send to us-- organizations, groups, account plans-- anything you pass to us becomes available instantly on our dashboard. ## Anonymous users
...
<Callout intent="alert">
  ...
  <CalloutDescription>
    Note that unlike variation and identify calls, all_flags does not send events to LaunchDarkly. Thus, users are not
