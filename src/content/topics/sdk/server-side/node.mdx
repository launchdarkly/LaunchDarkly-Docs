...
If you're looking to use feature flags in JavaScript in a browser environment,
read [JavaScript SDK](/sdk/client-side/javascript).

If you're creating a *client-side* Node application, read
