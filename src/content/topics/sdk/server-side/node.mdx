...
* [Client configuration](/sdk/features/config#nodejs-server-side)
* [Database integrations](/sdk/features/database-integrations)
* [Evaluating flag variations](/sdk/features/variation#nodejs-server-side)
* [Flag evaluation reasons](/sdk/features/variationdetail#nodejs-server-side)
* [Flushing SDK events](/sdk/features/flush#nodejs-server-side)
* [Identify](/sdk/features/identify#nodejs-server-side)
* [Logging](/sdk/features/logging#nodejs-server-side)
* [Offline mode](/sdk/features/offline-mode#nodejs-server-side)
* [Secure mode hash](/sdk/features/secure-mode#nodejs-server-side)
* [Shutting down an SDK](/sdk/features/shutdown#nodejs-server-side)
* [Subscribing to flag changes](/sdk/features/flag-changes#nodejs-server-side)
* [Sending custom events](/sdk/features/track#nodejs-server-side)
