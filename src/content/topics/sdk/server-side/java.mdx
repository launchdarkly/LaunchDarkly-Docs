...
// If you are on version 4.9.0 or later of this SDK,
// and you use JSON arrays or objects in feature flag values or in custom user attributes, 
// add this import too:
...
<CodeTabItem value="java-pre-4.12">
...
// This call to ldClient.boolVariation will always return the default value (false).
```
