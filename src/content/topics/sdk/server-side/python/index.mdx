...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>[SDK API docs](https://launchdarkly-python-sdk.readthedocs.io/)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>GitHub repository</TableCell>
      <TableCell>[python-server-sdk](https://github.com/launchdarkly/python-server-sdk)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Sample applications</TableCell>
      <TableCell>[Python](https://github.com/launchdarkly/hello-python)<br/> [R](https://github.com/launchdarkly/hello-r)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Published module</TableCell>
      <TableCell>[PyPI](https://pypi.org/project/launchdarkly-server-sdk/)</TableCell>
    </TableRow>
  </TableBody>
</Table>
...
<CodeSample>
<CSTab label="Python uWSGI initialization">
...
* [Anonymous contexts and users](/sdk/features/anonymous#python)
* [Big Segments](/sdk/features/big-segments#python)
* [Configuration](/sdk/features/config#python), including
  * [Application metadata configuration](/sdk/features/app-config#python)
...
* [Private attributes](/sdk/features/private-attributes#python)
