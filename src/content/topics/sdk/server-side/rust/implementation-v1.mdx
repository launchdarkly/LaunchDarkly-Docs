...
Creating contexts and evaluating flags based on contexts is the primary feature in the Rust SDK 1.0 release.
...
<CodeSample>
<CSTab label="Beta syntax, user with key">

```rust
let user1 = User::with_key("user-key-123abc").build();
```
</CSTab>
<CSTab label="1.0 syntax, context with key">
...
<CodeSample>
<CSTab label="1.0 syntax, single context builder">
...
<CodeSample>
<CSTab label="1.0 syntax, multi-context">
...
<CodeSample>
<CSTab label="Beta syntax, user with attributes">
...
<CSTab label="1.0 syntax, context with attributes">
...
<CodeSample>
<CSTab label="1.0 syntax, two attributes marked private for all contexts">
...
<CodeSample>
<CSTab label="1.0 syntax, attribute marked private for one context">
