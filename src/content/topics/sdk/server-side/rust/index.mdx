...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>[SDK API docs](https://docs.rs/launchdarkly-server-sdk)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>GitHub repository</TableCell>
      <TableCell>[rust-server-sdk](https://github.com/launchdarkly/rust-server-sdk)</TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>[crates.io](https://crates.io/crates/launchdarkly-server-sdk)</TableCell>
    </TableRow>
  </TableBody>
</Table>
