...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>[SDK API docs](https://hexdocs.pm/launchdarkly_server_sdk/)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>GitHub repository</TableCell>
      <TableCell>[erlang-server-sdk](https://github.com/launchdarkly/erlang-server-sdk/)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Sample applications</TableCell>
      <TableCell>[Erlang](https://github.com/launchdarkly/hello-erlang/) <br/> [Elixir](https://github.com/launchdarkly/hello-elixir)<br/> [Phoenix](https://github.com/launchdarkly/hello-phoenix)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Published module</TableCell>
      <TableCell>[Hex](https://hex.pm/packages/launchdarkly_server_sdk)</TableCell>
    </TableRow>
  </TableBody>
</Table>
