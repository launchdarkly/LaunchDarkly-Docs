...
The Python SDK supports Redis, Consul, or DynamoDB as a persistent store of feature flag configurations. To learn more, read [Using a persistent feature store](/home/advanced/feature-store).
