...
Building on top of our [Quickstart](/home/getting-started) guide, the following steps will get you started with using the LaunchDarkly SDK in your Python application.
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell>feature_requester_class</TableCell>
      <TableCell>
...
The Python SDK supports Redis, Consul, or DynamoDB as a persistent store of feature flag configurations. For more information, see [Using a persistent feature store](/home/advanced/feature-store).
