...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell><a href="https://pkg.go.dev/gopkg.in/launchdarkly/go-server-sdk.v5">API docs</a></TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>Go: <a href="https://github.com/launchdarkly/hello-go">hello-go</a></TableCell>
    </TableRow>
  </TableBody>
</Table>
