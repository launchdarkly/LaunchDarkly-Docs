...
The Consul, DynamoDB, and Redis integrations are no longer bundled in the main SDK project. Instead, they are maintained in separate repositories: [`github.com/launchdarkly/go-server-sdk-redis`](github.com/launchdarkly/go-server-sdk-redis), [`github.com/launchdarkly/go-server-sdk-dynamodb`](github.com/launchdarkly/go-server-sdk-dynamodb), and [`github.com/launchdarkly/ldconsul`](github.com/launchdarkly/go-server-sdk-consul).
