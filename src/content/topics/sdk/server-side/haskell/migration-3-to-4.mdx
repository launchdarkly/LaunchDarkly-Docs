...
Creating contexts and evaluating flags based on contexts is the primary feature in the Haskell SDK 4.0 release. However, the ability to target flags or segments by context, or review context instances that have encountered flags in your application, is only available to members of LaunchDarkly's Early Access Program (EAP). To learn more or join the EAP, read [Contexts](/home/contexts).
...
<CodeTabs
  ...
  values={[
    { label: '4.0 syntax', value: 'variation', },
  ]
}>
...
<CodeTabs
  ...
  values={[
    { label: '4.0 syntax, single context shortcut', value: 'single-context', },
  ]
}>
<CodeTabItem value="single-context">
...
<CodeTabs
  ...
  values={[
    { label: '4.0 syntax, all attributes marked private', value: 'private-all', },
    { label: '4.0 syntax, two attributes marked private', value: 'private-some', },
  ]
}>
