...
<Callout intent="info">
  ...
  <CalloutDescription>
    ...
    be strings, booleans (like true or false), numbers, or arrays or maps containing any of those types-- any type of value supported by JSON. In SDK versions 4.16.0 and later, these types are all represented by the [`ldvalue.Value`](https://godoc.org/gopkg.in/launchdarkly/go-sdk-common.v1/ldvalue#Value) type; earlier versions use the catch-all Go type  `interface{}`. If you enter a custom value on our dashboard that looks like a
