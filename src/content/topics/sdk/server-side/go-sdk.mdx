...
Feature flag targeting and rollouts are all determined by the _user_ you pass to your `Variation` calls. The Go SDK defines a `User` struct to make this easy. Here's an example:
[block:code]
{
"codes": [
{
