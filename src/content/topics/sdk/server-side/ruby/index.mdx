...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>[SDK API docs](https://launchdarkly.github.io/ruby-server-sdk/)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>GitHub repository</TableCell>
      <TableCell>[ruby-server-sdk](https://github.com/launchdarkly/ruby-server-sdk)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Sample applications</TableCell>
      <TableCell>[Ruby](https://github.com/launchdarkly/hello-ruby) <br/> [Rails with bootstrapping](https://github.com/launchdarkly/hello-bootstrap-rails)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Published module</TableCell>
      <TableCell>[RubyGems](https://rubygems.org/gems/launchdarkly-server-sdk)</TableCell>
    </TableRow>
  </TableBody>
</Table>
