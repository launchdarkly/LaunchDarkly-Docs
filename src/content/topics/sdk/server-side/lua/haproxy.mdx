---
path: '/sdk/server-side/lua/haproxy'
...
You can extend HAProxy with [Lua 5.3](https://www.lua.org/manual/5.3/), enabling complex control of [HAProxy functionality](https://www.arpalert.org/src/haproxy-lua-api/2.1/index.html). HAProxy has substantial [commercial adoption](https://www.haproxy.org/they-use-it.html).

Find a basic Dockerized app in our GitHub repository at [hello-haproxy](https://github.com/launchdarkly/hello-haproxy).
