...
<Callout intent="alert">
  ...
  <CalloutDescription>
    ...
    about our [client-side and server-side SDKs](./client-side-and-server-side). If you want to use LaunchDarkly in an
    Android application, see our [Android SDK Reference](./android-sdk-reference) Guide.
  </CalloutDescription>
</Callout>
<Callout intent="info">
