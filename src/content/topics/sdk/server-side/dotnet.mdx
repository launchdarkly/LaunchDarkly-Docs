...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        A default <a href="https://msdn.microsoft.com/en-us/library/system.NET.http.httpclienthandler.aspx"><code>HttpClientHandler</code></a>.
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
...
Note that the flush interval is configurable-- if you need to change the interval, you can do so with the `Configuration` class.
