...
Make `client` a singleton. The client instance maintains an internal state that allows LaunchDarkly to serve feature flags without making any remote requests.
