...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell><a href="https://launchdarkly.github.io/haskell-server-sdk/">API docs</a></TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>Haskell: <a href="https://github.com/launchdarkly/hello-haskell-server">hello-haskell-server</a></TableCell>
    </TableRow>
  </TableBody>
</Table>
