...
In the example above, we've customized the event queue capacity and flush interval parameters. To learn more about the specific user properties that are available in this SDK, read the [SDK's API docs](https://launchdarkly.github.io/haskell-server-sdk/LaunchDarkly-Server-Config.html).
...
This method is useful when you're passing feature flags to your front end. Specifically, you can use it to provide bootstrap flag settings for our JavaScript SDK.
