...
* [Client configuration](/sdk/features/config#erlang)
* [Evaluating flag variations](/sdk/features/variation#erlang)
* [Flag evaluation reasons](/sdk/features/variationdetail#erlang)
* [Identify](/sdk/features/identify#erlang)
* [Offline mode](/sdk/features/offline-mode#erlang)
* [Persistent feature store](/sdk/features/database-integrations#erlang)
* [Shutting down an SDK](/sdk/features/shutdown#erlang)
* [Sending custom events](/sdk/features/track#erlang)