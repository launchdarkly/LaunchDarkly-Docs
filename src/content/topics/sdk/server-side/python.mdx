...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell><a href="https://launchdarkly-python-sdk.readthedocs.io/">API docs</a></TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>Python: <a href="https://github.com/launchdarkly/hello-python">hello-python-server</a> <br/> R: <a href="https://github.com/launchdarkly/hello-r">hello-r</a></TableCell>
    </TableRow>
  </TableBody>
</Table>
