...
<CodeTabs
  ...
  values={[
    { label: 'Java', value: 'variation', },
  ]
}>
<CodeTabItem value="variation">

```java
boolean value = client.boolVariation("your-flag-key", context, false);
```
</CodeTabItem>
</CodeTabs>
...
To learn more, read [`privateAttributes`](https://launchdarkly.github.io/java-server-sdk/com/launchdarkly/sdk/server/integrations/EventProcessorBuilder.html#privateAttributes).
