...
Code samples on this page are from the two most recent SDK versions where they differ. To learn more about upgrading, read [Java SDK 5.x to 6.0 migration guide](/sdk/server-side/java/migration-5-to-6).
...
<CodeTabs
  defaultValue="java"
  values={[
    { label: 'Java SDK v6', value: 'java', },
    { label: 'Java SDK v5', value: 'java-v5', },
  ]
}>
<CodeTabItem value="java">
