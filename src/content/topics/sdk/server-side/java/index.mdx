...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell><a href="http://launchdarkly.github.io/java-server-sdk/">API docs</a></TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>Java: <a href="https://github.com/launchdarkly/hello-java">hello-java</a> <br/> Scala: <a href="https://github.com/launchdarkly/hello-scala">hello-scala</a> <br/> You can also use this SDK with Kotlin</TableCell>
    </TableRow>
  </TableBody>
</Table>
