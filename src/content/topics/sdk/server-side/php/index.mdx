...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell><a href="https://launchdarkly.github.io/php-server-sdk/">API docs</a></TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>PHP: <a href="https://github.com/launchdarkly/hello-php">hello-php</a></TableCell>
    </TableRow>
  </TableBody>
</Table>
