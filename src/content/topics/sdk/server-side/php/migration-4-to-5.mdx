...
title: PHP (server-side) SDK 4.x to 5.0 migration guide
...
In your flag or segment targeting, use `/` as the delimiter to refer to specific object fields. For example, you can use `/address/city` in your targeting. To learn more, read [Targeting contexts](/flags/targeting-contexts/SC-163845).
