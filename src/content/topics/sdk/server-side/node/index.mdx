...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell><a href="https://launchdarkly.github.io/node-server-sdk/">API docs</a></TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>JavaScript: <a href="https://github.com/launchdarkly/hello-node-server">hello-node-server</a> <br/> TypeScript: <a href="https://github.com/launchdarkly/hello-node-typescript">hello-node-typescript</a> <br/> JavaScript: <a href="https://github.com/launchdarkly/hello-bootstrap">hello-bootstrap</a> (server-side bootstrapping example)</TableCell>
    </TableRow>
  </TableBody>
</Table>
...
```js
client.once("ready", () => {
  client.variation("your.flag.key", user, false,
    (err, showFeature) => {
      if (showFeature) {
...
const value = await client.variation("any.feature.flag", user, false);
```
...
```ts
// Using the .then() method to add a continuation handler for a Promise
client.variation('any.feature.flag', user, false).then(
  (value) => {
    // application code
});
