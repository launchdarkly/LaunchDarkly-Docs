...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell><a href="https://github.com/launchdarkly/hello-node-server">Node.js (server-side)</a> <br/> <a href="https://github.com/launchdarkly/hello-node-typescript">Node.js (server-side), TypeScript</a> <br/> <a href="https://github.com/launchdarkly/hello-bootstrap">Node.js (server-side) with bootstrapping</a> <br/> <a href="https://github.com/launchdarkly/hello-openfeature-node-server">OpenFeature Node.js (server-side)</a></TableCell>
    </TableRow>
    <TableRow>
