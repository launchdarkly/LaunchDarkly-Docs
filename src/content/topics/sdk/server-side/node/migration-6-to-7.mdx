...
<CodeTabs
  ...
  values={[
    { label: 'JavaScript', value: 'variation', },
  ]
}>
...
<CodeTabs
  ...
  values={[
    { label: 'Single context with key, JavaScript', value: 'single-context', },
    { label: 'Single context with key, TypeScript', value: 'single-context-ts', },
...
<CodeTabs
  ...
  values={[
    { label: 'JavaScript', value: 'multi-context', },
    { label: 'TypeScript', value: 'multi-context-ts', },
  ]
}>
...
<CodeTabs
  ...
  values={[
    { label: 'JavaScript: Context with attributes', value: 'context', },
    { label: 'Typescript: Context with attributes', value: 'context-ts', },
    { label: 'v6.x, user with attributes', value: 'user', },
  ]
}>
...
<CodeTabs
  defaultValue="context"
  values={[
    { label: 'JavaScript', value: 'context', },
    { label: 'TypeScript', value: 'context-ts', },
  ]
}>
<CodeTabItem value="context">
...
<CodeTabs
   ...
   values={[
     { label: 'JavaScript', value: 'private-config', },
     { label: 'TypeScript', value: 'private-config-ts', },
   ]
 }>
...
<!-- TKTK Needs final API docs link SC-178150 -->
...
<CodeTabs
  ...
  values={[
    { label: 'JavaScript', value: 'private', },
    { label: 'TypeScript', value: 'private-ts', },
  ]
}>
...
<!-- For a full list of deprecated types and methods, read [TKTK](/LINK/TO/SDK/API/DEPRECATION/LIST). SC-178150 -->
