...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>[SDK API docs](https://github.com/launchdarkly/apex-server-sdk/blob/master/doc.md)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>GitHub repository</TableCell>
      <TableCell>[apex-server-sdk](https://github.com/launchdarkly/apex-server-sdk)</TableCell>
    </TableRow>
    <TableRow>
...
<Callout intent="info">
<CalloutTitle>The Apex SDK uses an SDK key</CalloutTitle>
<CalloutDescription>

The Apex SDK uses an SDK key. Your environment's SDK key is available in the **Projects** tab of your [**Account settings**](https://app.launchdarkly.com/settings#/projects) page. To learn more about key types, read [Keys](/sdk/concepts/client-side-server-side#keys).
...
* [Anonymous contexts and users](/sdk/features/anonymous#apex)
...
* [Identifying and changing contexts](/sdk/features/identify#apex)
* [Private attributes](/sdk/features/private-attributes#apex)
* [Sending custom events](/sdk/features/events#apex)
* [Service endpoint configuration](/sdk/features/service-endpoint-configuration#apex)
* [User and context configuration](/sdk/features/user-context-config#apex)
