---
path: /sdk/server-side/cloudflare/migration-1-to-2
...
published: true
tags: ['cloudflare', 'migration', 'sdk', 'server-side', 'context']
---

## Overview

This topic explains the changes in the Cloudflare SDK 2.0 release and how to adapt code that uses a 1.0 version of the [Cloudflare SDK](/sdk/server-side/cloudflare) to use version 2.0 or later.
