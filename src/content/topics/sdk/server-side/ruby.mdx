...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell><a href="https://launchdarkly.github.io/ruby-server-sdk/">API docs</a></TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>Ruby: <a href="https://github.com/launchdarkly/hello-ruby">hello-ruby</a> <br/> Rails: <a href="https://github.com/launchdarkly/hello-bootstrap-rails">hello-bootstrap-rails</a> (server-side bootstrapping example)</TableCell>
    </TableRow>
  </TableBody>
</Table>
