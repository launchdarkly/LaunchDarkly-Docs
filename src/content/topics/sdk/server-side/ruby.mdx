...
* [Client configuration](/sdk/features/config#ruby)
* [Evaluating flag variations](/sdk/features/variation#ruby)
* [Flag evaluation reasons](/sdk/features/variationdetail#ruby)
* [Flushing SDK events](/sdk/features/flush#ruby)
* [Identify](/sdk/features/identify#ruby)
* [Logging](/sdk/features/logging#ruby)
* [Offline mode](/sdk/features/offline-mode#ruby)
* [Persistent feature store](/sdk/features/database-integrations#ruby)
* [Secure mode hash](/sdk/features/secure-mode#ruby)
* [Shutting down an SDK](/sdk/features/shutdown#ruby)
* [Sending custom events](/sdk/features/track#ruby)
