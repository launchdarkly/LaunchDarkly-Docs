...
To learn more about the specific configuration options that are available in this SDK, read the [SDK's API docs](https://www.rubydoc.info/gems/launchdarkly-server-sdk/LaunchDarkly/Config).
