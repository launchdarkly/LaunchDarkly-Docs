...
This SDK is intended for use in *multi-user* C/C++ server applications. If you have a C/C++ application and want to set up LaunchDarkly in a desktop or embedded application, read the [C/C++ client-side SDK reference](/sdk/client-side/c-c--).
