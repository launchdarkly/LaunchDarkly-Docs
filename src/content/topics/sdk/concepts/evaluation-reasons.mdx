...
An example is depicted below for some of LaunchDarkly's SDKs:
...
<CodeTabs
  ...
  values={[
    { label: 'Go', value: 'go', },
    { label: 'Java', value: 'java', },
    { label: 'C# (.NET or Xamarin)', value: 'dotnet', },
    { label: 'Ruby', value: 'ruby', },
    { label: 'Python', value: 'py', },
...
*To learn more, read [`EvaluationReason`](http://launchdarkly.github.io/dotnet-server-sdk/html/T_LaunchDarkly_Client_EvaluationReason.htm).*
