...
*To learn more, read [`EvaluationDetail`](https://pkg.go.dev/gopkg.in/launchdarkly/go-server-sdk.v4#EvaluationDetail), [`BoolVariationDetail`](https://pkg.go.dev/gopkg.in/launchdarkly/go-server-sdk.v4#LDClient.BoolVariationDetail).*
...
*To learn more, read [`EvaluationDetail`](https://javadoc.io/static/com.launchdarkly/launchdarkly-android-client-sdk/2.12.0/com/launchdarkly/android/EvaluationDetail.html), [`boolVariationDetail`](https://javadoc.io/static/com.launchdarkly/launchdarkly-android-client-sdk/2.12.0/com/launchdarkly/android/LDClient.html#boolVariationDetail-java.lang.String-java.lang.Boolean-).*
...
*To learn more, read [`EvaluationReason`](https://pkg.go.dev/gopkg.in/launchdarkly/go-server-sdk.v4#EvaluationReason).*
