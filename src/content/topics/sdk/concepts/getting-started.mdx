...
1. **Determine what kind of SDK you need to use.**
   - Depending on your use case, you may need a server-side, client-side, mobile, or edge SDK.
...
2. **Identify the language you want to use**. In some cases, we support multiple SDKs for a language. To learn more, read [Available SDKs](/sdk#available-sdks). We may also provide a sample application in your preferred language or framework, even if we don't have a dedicated SDK. To learn more, read [Sample applications](/sdk/concepts/sample-applications).
