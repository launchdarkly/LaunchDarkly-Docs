...
2. **Identify the language you wish to use**. In some cases, we support multiple SDKs for a language. To learn more, read about our [Available SDKs](/sdk).
...
4. (Optional) **Determine if you need to use the Relay proxy.** To learn more, read [The Relay proxy](/home/relay-proxy).
