...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell>Other end user contact info</TableCell>
      <TableCell>Not collected by default.</TableCell>
      <TableCell></TableCell>
    </TableRow>
  </TableBody>
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell>Other end user content</TableCell>
      <TableCell>Not collected by default.</TableCell>
      <TableCell></TableCell>
    </TableRow>
  </TableBody>
...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>LaunchDarkly collects a unique identifier, as provided by your application code, for each of your contexts.</TableCell>
      <TableCell><ul>
          <li>This data is used for product personalization.</li>
          <li>This data may be linked to a user context depending on how your application specifies context IDs.</li>
        </ul></TableCell>
    </TableRow>
    <TableRow>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell><ul>
          ...
          <li>This data is not linked to end users.</li>
        </ul></TableCell>
    </TableRow>
  </TableBody>
</Table>
    ...
    <TableRow>
      ...
      <TableCell>LaunchDarkly collects:
        <ul>
            ...
            <li>metrics about LaunchDarkly context indexing.</li>
        </ul>
      </TableCell>
      <TableCell><ul>
          <li>This data is used for analytics.</li>
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell><ul>
          <li>This data is used for product personalization.</li>
          <li>This data is linked to the context ID.</li>
        </ul></TableCell>
    </TableRow>
  </TableBody>
</Table>
