...
* [Client-side .NET](/sdk/client-side/dotnet)
...
This table explains the user content information LaunchDarkly SDKs collect by default:
...
This table explains the indentifier information LaunchDarkly SDKs collect by default:
