...
```
<!-- TKTK Check that the above two code samples are correct. The client-side one probably needs to change because key is set automatically for client-side SDKs? SC-178002 -->
