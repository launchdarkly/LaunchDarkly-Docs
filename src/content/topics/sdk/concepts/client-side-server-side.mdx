...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        These SDKs are designed for edge layers in content delivery networks (CDNs). LaunchDarkly supports <a href="/sdk/edge/cloudflare">Cloudflare</a> and <a href="/sdk/edge/vercel">Vercel</a>.
        <br />
