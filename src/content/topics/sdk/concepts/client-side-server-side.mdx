...
The SDK key should be kept a secret. If an SDK key is exposed, you can reset it from the **Account settings** page by clicking on **Projects**, clicking the overflow menu next to your environment, selecting **Edit environment**, and clicking **Reset SDK key**. To learn more, read [Resetting an environment's key](/home/organize/environments#resetting-an-environments-key).
...
The mobile key does not need to be kept a secret. However, if you wish to reset a mobile key, you can do so from the **Account settings** page by clicking on **Projects**, clicking the overflow menu next to your environment, selecting **Edit environment**, and clicking **Reset Mobile key**.
