...
The mobile key is not considered confidential and does not need to be kept a secret. However, if you wish to reset a mobile key, you can do so from the **Account Settings** page by clicking on **Projects**, clicking the overflow menu next to your environment, selecting **Edit environment**, and clicking **Reset Mobile key**.
...
Unlike a mobile key, the client-side ID for an environment never changes. The client-side ID is not considered confidential and does not need to be kept a secret.
