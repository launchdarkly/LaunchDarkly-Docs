...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell>
        <a href="/sdk/client-side/ios-objective-c/">iOS (Objective-C)</a>
      </TableCell>
      <TableCell>Client-side (mobile)</TableCell>
      <TableCell>Mobile key</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
        <a href="/sdk/client-side/ios-swift/">iOS (Swift)</a>
      </TableCell>
      <TableCell>Client-side (mobile)</TableCell>
      <TableCell>Mobile key</TableCell>
    </TableRow>
    ...
    <TableRow>
      <TableCell>
        <a href="/sdk/client-side/react-native/">React Native</a>
      </TableCell>
      <TableCell>Client-side (mobile)</TableCell>
      <TableCell>Mobile key</TableCell>
    </TableRow>
