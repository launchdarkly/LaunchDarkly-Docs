...
Our SDKs primarily for mobile devices, known as our "mobile SDKs", are categorized as client-side SDKs because, like our client-side SDKs, most mobile applications have a single-user context. This includes our Android, iOS, Flutter, React Native, and client-side .NET SDKs. Each of these SDKs also has some mobile-specific functionality. To learn more, read [Functional differences between SDKs](#functional-differences-between-sdks).
