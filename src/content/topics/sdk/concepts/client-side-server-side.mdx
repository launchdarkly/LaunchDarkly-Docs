...
like our client-side SDKs, most mobile applications have a single-user context. This includes our Android, iOS, Flutter,
...
The SDK key is considered confidential and should be kept a secret. If an SDK key is exposed, you can reset it from the project's Edit environment page under **Account Settings**. To learn more, read [Resetting an environment's SDK key](/home/organize/environments#resetting-an-environments-sdk-key).
