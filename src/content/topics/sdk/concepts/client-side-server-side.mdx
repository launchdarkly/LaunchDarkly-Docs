...
The SDK key is considered confidential and should be kept a secret. If an SDK key is exposed, you can reset it from the **Account Settings** page by clicking on **Projects**, clicking the three-dot menu next to your environment, selecting **Edit environment**, and clicking **Reset SDK key**. To learn more, read [Resetting an environment's key](/home/organize/environments#resetting-an-environments-key).
