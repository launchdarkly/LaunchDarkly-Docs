...
## Getting notifications on the LaunchDarkly web application

SDK notifications are available on the [Flags list](/home/organize/flags-list). You receive notifications when
SDK versions near their end of life, are past their end of life, and when major versions are available.
The notifications are based on SDK usage within each LaunchDarkly environment.
