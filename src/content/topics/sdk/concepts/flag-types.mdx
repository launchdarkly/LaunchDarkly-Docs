...
JSON flags can be objects or arrays. You can treat an optional array or object property as empty if there is no property value present. You can write an empty array as `[]`, an empty object as `{}`, or omit the property completely.

JSON flags have a size limit of 32KB.
