...
You can use multivariate flags in experiments to test different versions of a feature. To learn more, read [Experimentation](/home/experimentation).
...
Custom attributes follow the same patterns as LaunchDarkly flag types. The value of a custom attribute can be of any type that's allowed in JSON, including boolean, number, string, array, and object.
