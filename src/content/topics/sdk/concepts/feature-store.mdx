...
title: 'About persistent feature store'
...
To see code samples for specific SDKs, read [Persistent feature store](/sdk/features/database-integrations).
...
The LaunchDarkly SDKs use third-party open-source libraries to connect to Redis. Not all of these have the same level of support for advanced Redis configurations. Specifically, most of the SDKs and the [Relay Proxy](/home/relay-proxy) do not support connecting to a Redis cluster or using Redis Sentinel for service discovery.
