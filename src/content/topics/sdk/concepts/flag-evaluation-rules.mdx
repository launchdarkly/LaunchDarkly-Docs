...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>String parsed as semantic version</TableCell>
      <TableCell>The user attribute value precedes the clause value.<br/><br/>If negated, corresponds to the user attribute being greater than or equal to the clause value.</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
      ...
      <TableCell>String parsed as semantic version</TableCell>
      <TableCell>The clause value precedes the user attribute value.<br/><br/>If negated, corresponds to the user attribute being less than or equal to the clause value.</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
