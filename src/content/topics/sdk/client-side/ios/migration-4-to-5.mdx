...
<CSTab label="4.x syntax (Objective-C)">
...
<CSTab label="5.0 syntax (Objective-C)">
...
```swift
let flagValue = LDClient.get()!.variation(forKey: "flag-key-123abc", defaultValue: false)
```
...
```objectivec
BOOL flagValue = [[LDClient sharedInstance] boolVariationForKey:@"flag-key-123abc" fallback:NO];
```
...
```objectivec
BOOL flagValue = [[LDClient get] boolVariationForKey:@"flag-key-123abc" defaultValue:NO];
```
...
```swift
let flagValueDetail: LDEvaluationDetail<Bool> = LDClient.get()!.variationdetail(forKey: "flag-key-123abc", defaultValue: false)
```
...
```objectivec
ObjCBoolEvaluationDetail *flagValueDetail = [[LDClient sharedInstance] boolVariationDetailForKey:@"flag-key-123abc" fallback:NO];
```
...
```objectivec
LDBoolEvaluationDetail *flagValueDetail = [[LDClient get] boolVariationDetailForKey:@"flag-key-123abc" defaultValue:NO];
```
