...
* The SDK now has support for multiple LDClient instances that are tied to separate mobile keys, allowing the evaluation of flags in multiple environments. See the [multiple environments](/sdk/features/multiple-environments#ios) section of the reference guide for more information on this feature.
