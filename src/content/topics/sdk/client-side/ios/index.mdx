...
description: 'This topic explains all of the methods available in the iOS SDK, and explains how these methods work.'
published: true
---

## Overview

This reference guide documents all of the methods available in the iOS SDK, and explains how these methods work. LaunchDarkly's SDKs are open source. The source is available in its [GitHub repository](https://github.com/launchdarkly/ios-client-sdk/tree/v5) and its generated [API reference](https://launchdarkly.github.io/ios-client-sdk/). 

You can also use this SDK to clone and run a sample application with [iOS](https://github.com/launchdarkly/hello-ios-swift), [macOS](https://github.com/launchdarkly/hello-macos), and [tvOS](https://github.com/launchdarkly/hello-tvos).
...
// start supports an optional completion that the SDK triggers when it
// retrieves flags for the configured user.
LDClient.start(config: config, user: user) {
...
Using the `LDClient` instance, you can check which variation the configured user will receive for a given feature flag:
