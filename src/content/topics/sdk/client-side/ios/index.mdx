...
Code samples on this page are from the two most recent SDK versions where they differ. To learn more about upgrading, read the iOS SDK 7.x to 8.0 migration guides for [Swift](/sdk/client-side/ios/migration-7-to-8-swift) or [Objective-C](/sdk/client-side/ios/migration-7-to-8-objc).
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell><a href="https://github.com/launchdarkly/ios-client-sdk/tree/v8">ios-client-sdk</a></TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Sample applications</TableCell>
      <TableCell><a href="https://github.com/launchdarkly/hello-ios">iOS (Objective-C)</a><br/> <a href="https://github.com/launchdarkly/hello-ios-swift">iOS (Swift)</a> <br/><a href="https://github.com/launchdarkly/hello-macos">macOS</a><br/><a href="https://github.com/launchdarkly/hello-tvos">tvOS</a></TableCell>
    </TableRow>
    <TableRow>
...
<CodeTabs
  defaultValue="swift"
  values={[
    { label: 'Swift, iOS SDK v8', value: 'swift', },
    { label: 'Objective-C, iOS SDK v8', value: 'objc', },
    { label: 'Swift, iOS SDK v7', value: 'swift-v7', },
    { label: 'Objective-C, iOS SDK v7', value: 'objc-v7', },
  ]
}>
<CodeTabItem value="swift">
