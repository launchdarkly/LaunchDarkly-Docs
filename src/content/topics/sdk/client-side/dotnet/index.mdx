...
Code samples on this page are from the two most recent SDK versions where they differ. To learn more about upgrading, read [.NET (client-side) SDK 2.x to 3.0 migration guide](/sdk/client-side/dotnet/migration-2-to-3) and [Best practices for upgrading users to contexts](/guides/flags/upgrading-contexts).
...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>
        [SDK API docs](https://launchdarkly.github.io/dotnet-client-sdk/)
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>GitHub repository</TableCell>
      <TableCell>
        [dotnet-client-sdk](https://github.com/launchdarkly/dotnet-client-sdk)
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Sample applications</TableCell>
      <TableCell>
        [.NET (client-side)](https://github.com/launchdarkly/hello-dotnet-client) <br />
    ...
    <TableRow>
      ...
      <TableCell>
        [NuGet](https://www.nuget.org/packages/LaunchDarkly.ClientSdk/)
      </TableCell>
    </TableRow>
  </TableBody>
</Table>
...
- [Anonymous contexts and users](/sdk/features/anonymous#net-client-side)
...
- [Private attributes](/sdk/features/private-attributes#net-client-side)
