...
<Callout intent="alert">
  ...
  <CalloutDescription>
    ...
    SDKs](/sdk/concepts/client-side-server-side). For using LaunchDarkly in C / C++ server-side applications, refer to our [C /
    C++ server-side SDK](/sdk/server-side/c-c--).
  </CalloutDescription>
</Callout>

## Getting started

Building on top of our [Quickstart](/home/getting-started) guide, the following steps will get you started with using the LaunchDarkly SDK in your C application.
