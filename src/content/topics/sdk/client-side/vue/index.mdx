...
The SDK provides a Vue plugin that you can add to your app. You can pass configuration options to the plugin when it loads, or to the `ldInit` function if you are using the `deferInitialization` option. To learn more, read [Initializing the client](#initializing-the-client). To learn more about the available configuration options, read [LDPluginOptions](https://launchdarkly.github.io/vue-client-sdk/types/LDPluginOptions.html).
