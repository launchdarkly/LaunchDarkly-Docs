...
<CodeTabs
  ...
  values={[
    ...
    { label: 'Version 3.x, user with key', value: 'user', },
  ]
}>
<CodeTabItem value="single-context">

```java
LDContext context = LDContext.create("context-key");
```
</CodeTabItem>
<CodeTabItem value="user">

```java
LDUser user = new LDUser("user-key");
```
</CodeTabItem>
</CodeTabs>
...
<CodeTabs
  defaultValue="single-context"
  values={[
    { label: 'Single context shortcut', value: 'single-context', },
  ]
}>
<CodeTabItem value="single-context">
...
<CodeTabs
  ...
  values={[
    ...
    { label: 'Version 3.x, user with several attributes', value: 'user', },
  ]
}>
...
LDValue addressData = LDValue.buildObject()
  ...
  .build();
LDContext context = LDContext.builder("user3-key")
...
The `privateAttributeNames` attribute that existed in a user object in version 3.x has been renamed to `privateAttributes` in `LDContext`. To learn more, read [`privateAttributes`](https://launchdarkly.github.io/android-client-sdk/com/launchdarkly/sdk/ContextBuilder.html#privateAttributes(java.lang.String...)). <!-- TKTK confirm during SC-178150 -->
...
<CodeTabs
  defaultValue="device"
  values={[
    { label: 'Setting device and os', value: 'device', },
  ]
}>
...
<CodeTabs
  defaultValue="java"
  values={[
    { label: 'Configuring the SDK to generate keys', value: 'java', },
  ]
}>
...
<CodeTabs
  defaultValue="java"
  values={[
    { label: 'Building an anonymous context', value: 'java', },
  ]
}>
<CodeTabItem value="java">
...
<CodeTabs
  defaultValue="java"
  values={[
    { label: 'An anonymous context in a multi-context', value: 'java', },
  ]
}>
<CodeTabItem value="java">
...
```java
LDContext context1 = LDContext.create("user1-key");
LDContext context2 = LDContext.create(ContextKind.of("device"), "device1-key");
