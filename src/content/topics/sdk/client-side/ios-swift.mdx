...
This reference guide documents all of the methods available in our
...
Building on top of our [Quickstart](/home/getting-started) guide, the following steps will get you started with using the LaunchDarkly SDK in your iOS application.
...
```swift
github "launchdarkly/ios-client" "4.4.0"
```
...
<Callout intent="alert">
  ...
  <CalloutDescription>The lifetime of the `LDObserverOwner` must extend for at least as long as you wish to receive flag change notifications.</CalloutDescription>
</Callout>
