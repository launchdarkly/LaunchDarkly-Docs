...
This documentation is for the LaunchDarkly SDK for Swift iOS versions 4.0.0 and later. Earlier versions of the SDK support [Objective-C](/sdk/client-side/ios-objective-c).
...
<CalloutDescription>
Since V4.3.0</CalloutDescription>
</Callout>
...
<CalloutDescription>
The lifetime of the `LDObserverOwner` must extend for at least as long as you wish to receive flag change notifications.</CalloutDescription>
</Callout>
...
<Callout intent="info">
  <CalloutTitle>Availability</CalloutTitle>
<CalloutDescription>
Since version 4.2.0</CalloutDescription>
</Callout>
