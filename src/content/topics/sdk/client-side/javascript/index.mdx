...
After you install the dependency, initialize the LaunchDarkly client. To create a client instance, you need your environment's client-side ID, available in the Projects tab of your [Account settings page](https://app.launchdarkly.com/settings#/projects). 
