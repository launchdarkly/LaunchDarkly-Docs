...
<CodeTabs
  ...
  values={[
    ...
    { label: 'Version 2.x, user with key', value: 'user', },
  ]
}>
...
<CodeTabs
  ...
  values={[
    ...
    { label: 'Version 2.x, user with several attributes', value: 'user', },
  ]
}>
...
<CodeTabs
  defaultValue="js"
  values={[
    { label: 'Context with object attributes', value: 'js', },
  ]
}>
...
<CodeTabs
  defaultValue="js"
  values={[
    { label: 'Attributes marked private for particular context', value: 'js', },
  ]
}>
<CodeTabItem value="js">
...
The `privateAttributeNames` attribute that existed in a user object in version 2.x has been renamed to `privateAttributes` in version 3.0. It has moved from the top level of a user object into the `_meta` object within a context. To learn more, read [`privateAttributes`](https://launchdarkly.github.io/js-client-sdk/interfaces/_launchdarkly_js_client_sdk_.ldcontext.html#privateattributes). <!-- TKTK confirm during SC-178150 -->
...
<CodeTabs
  defaultValue="js"
  values={[
    { label: 'Working with anonymous contexts', value: 'js', },
  ]
}>
<CodeTabItem value="js">
...
<CodeTabs
  defaultValue="js"
  values={[
    { label: 'Identifying a multi-context', value: 'js', },
  ]
}>
<CodeTabItem value="js">
