...
If you are using the React SDK, another option is to use the `asyncWithLDProvider` function. See the [React SDK reference](/sdk/client-side/react/react-web#initializing-using-asyncwithldprovider) for more information.
