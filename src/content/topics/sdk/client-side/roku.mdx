...
A custom logging back end can be provided. This will be different depending on if you are using the SceneGraph API or the Legacy API.
...
A user can be marked as [anonymous](/home/users/anonymous-users) with:
