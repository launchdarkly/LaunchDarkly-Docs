...
This reference guide documents basic usage of our Roku SDK, and explains in detail how these features work. LaunchDarkly's SDKs are open source. The source is available in its [GitHub repository](https://github.com/launchdarkly/roku-client-sdk) and its generated [API reference](https://github.com/launchdarkly/roku-client-sdk). 

You can also use this SDK to clone and run a [sample application](https://github.com/launchdarkly/hello-roku).
