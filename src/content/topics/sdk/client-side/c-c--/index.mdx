...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>
        [SDK API docs](https://launchdarkly.github.io/c-client-sdk/)
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>GitHub repository</TableCell>
      <TableCell>
        [c-client-sdk](https://github.com/launchdarkly/c-client-sdk)
      </TableCell>
    </TableRow>
    <TableRow>
      ...
      <TableCell>
        ...
        <br /> [C++ (client-side)](https://github.com/launchdarkly/hello-cpp-client)
      </TableCell>
    </TableRow>
    <TableRow>
...
6. Specify your _mobile key_ to authorize your application to connect to a particular environment within LaunchDarkly:
...
- [Anonymous contexts and users](/sdk/features/anonymous#cc-client-side)
...
- [Identifying and changing contexts](/sdk/features/identify#cc-client-side)
- [Private attributes](/sdk/features/private-attributes#cc-client-side)
...
- [User and context configuration](/sdk/features/user-context-config#cc-client-side)
