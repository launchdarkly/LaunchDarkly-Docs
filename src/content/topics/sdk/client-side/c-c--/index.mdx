...
description: 'This topic explains all of the methods available in the client-side C/C++ SDK, and explains how these methods work.'
published: true
---

## Overview

This reference guide documents all of the methods available in the client-side C/C++ SDK, and explains how these methods work. LaunchDarkly's SDKs are open source. The source is available in its [GitHub repository](https://github.com/launchdarkly/c-client-sdk) and its generated [API reference](https://github.com/launchdarkly/c-client-sdk). 

You can also use this SDK to clone and run a [sample C application](https://github.com/launchdarkly/hello-c-client) or a [sample C++ application](https://github.com/launchdarkly/hello-cpp-client).
...
Your environment's mobile key is available in the Projects tab of your [account settings page](https://app.launchdarkly.com/settings#/projects). Mobile keys are not secret and you can expose them in your client-side code without risk. Never embed a server-side SDK key into a mobile application.
