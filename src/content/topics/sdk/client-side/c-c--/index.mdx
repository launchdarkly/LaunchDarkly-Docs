...
All LaunchDarkly SDKs are open source. Clone this SDK from its [GitHub repository](https://github.com/launchdarkly/c-client-sdk) or read its [API reference](https://launchdarkly.github.io/c-client-sdk/).
...
Your environment's mobile key is available in the Projects tab of your [account settings page](https://app.launchdarkly.com/settings#/projects). Be sure to use a mobile key. Never embed a server-side SDK key into a mobile application.
