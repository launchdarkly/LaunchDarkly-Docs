...
* [Client configuration](/sdk/features/config#cc-client-side)
* [Flushing SDK events](/sdk/features/flush#cc-client-side)
* [Identify](/sdk/features/identify#cc-client-side)
* [Offline mode](/sdk/features/offline-mode#cc-client-side)
* [Shutting down an SDK](/sdk/features/shutdown#cc-client-side)
...
* [Evaluating flag variations](/sdk/features/variation#cc-client-side)
