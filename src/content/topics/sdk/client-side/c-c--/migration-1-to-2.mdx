...
For more advanced `cmake` usage, or if you use another platform, read this [cmake guide](https://preshing.com/20170511/how-to-build-a-cmake-based-project/). The SDK is exported as the `ldclientapi` target.

The repository organization of source files should not be considered stable. If you want to build your own artifacts, and use them outside of a cmake project you should `cmake install` to your directory of choice which will copy the required headers and binary.
