...
<Callout intent="info">
<CalloutTitle>Version 3 of the Node.js SDK replaces users with contexts</CalloutTitle>
<CalloutDescription>
...
Code samples on this page are from the two most recent SDK versions where they differ. To learn more about upgrading, read [Node.js SDK 2.x to 3.0 migration guide](/sdk/client-side/node-js/migration-2-to-3).
...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>[SDK API docs](https://launchdarkly.github.io/node-client-sdk/)</TableCell>
    </TableRow>
    <TableRow>
...
<CodeSample>
<CSTab label="Node.js SDK v3 (JavaScript)">
...
<CSTab label="Node.js SDK v3 (TypeScript)">
...
* [Anonymous contexts and users](/sdk/features/anonymous#nodejs-client-side)
* [Bootstrapping](/sdk/features/bootstrapping#nodejs-client-side)
* [Configuration](/sdk/features/config#nodejs-client-side), including
  * [Application metadata configuration](/sdk/features/app-config#nodejs-client-side)
  * [Service endpoint configuration](/sdk/features/service-endpoint-configuration#nodejs-client-side)
...
* [Identifying and changing contexts](/sdk/features/identify#nodejs-client-side)
* [Logging configuration](/sdk/features/logging#nodejs-client-side)
* [Private attributes](/sdk/features/private-attributes#nodejs-client-side)
...
* [User and context configuration](/sdk/features/user-context-config#nodejs-client-side)
