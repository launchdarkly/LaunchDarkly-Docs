...
```dart
LDConfig config = LDConfigBuilder(MOBILE_SDK_KEY)
...
To learn more, read [`LDConfig`](https://launchdarkly.github.io/flutter-client-sdk/launchdarkly_flutter_client_sdk/LDConfig-class.html)
