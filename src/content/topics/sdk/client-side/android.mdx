...
This reference guide documents all of the methods available in our Android SDK, and explains in detail how these methods work. If you want to dig even deeper, our SDKs are open source. To learn more, read [Android SDK GitHub repository](https://github.com/launchdarkly/android-client-sdk) or our [JavaDocs](https://javadoc.io/doc/com.launchdarkly/launchdarkly-java-server-sdk/). Additionally you can clone and run a [sample application](https://github.com/launchdarkly/hello-android) using this SDK.
