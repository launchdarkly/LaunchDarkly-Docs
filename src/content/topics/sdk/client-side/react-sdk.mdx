...
Customizing your client can be done via the `options` field. To learn more, read the [JavaScript SDK reference](https://docs.launchdarkly.com/docs/js-sdk-reference#customizing-your-client).
