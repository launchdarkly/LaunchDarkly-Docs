...
a complete client-side JavaScript SDK reference, please refer to our
[documentation](https://docs.launchdarkly.com/docs/js-sdk-reference).
...
version if you wish to additionally use the Hooks API -- see the "Hooks" section below for more information.
...
Building on top of our [Quickstart](/home/getting-started) guide, the following steps will get you started with using the LaunchDarkly SDK in your React code.
...
[`withLDProvider`](https://docs.launchdarkly.com/docs/react-sdk-reference#-withldprovider-) function if you prefer
