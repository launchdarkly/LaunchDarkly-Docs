...
- `user`: A LaunchDarkly [user](/sdk/client-side/javascript#users) object. This property is optional. If a user object is not specified, the React SDK proceeds with an anonymous user by default.
