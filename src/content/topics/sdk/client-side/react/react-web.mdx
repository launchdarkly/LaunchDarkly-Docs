...
Setting `reactOptions.sendEventsOnFlagRead: false` could prevent experimentation events from recording correctly. Always check to see if this option is disabled when troubleshooting experiments.
