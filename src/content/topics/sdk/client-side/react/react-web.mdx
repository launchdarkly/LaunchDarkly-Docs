...
The LaunchDarkly React SDK versions 3.0 and higher use optional chaining. You can ensure support for optional chaining by using Webpack 5. If you are using Webpack 4, you must manually update your `package.json` file. To learn more, read [Identifying supported React versions and dependencies for the v3 SDK](/sdk/client-side/react/web-migration-2-to-3#identifying-supported-react-versions-and-dependencies-for-the-v3-sdk).
