...
The LaunchDarkly React Native client-side SDK is not compatible with the Expo managed workflow because the SDK uses native modules. Consider using the [bare workflow](https://docs.expo.dev/bare/overview/) instead.
