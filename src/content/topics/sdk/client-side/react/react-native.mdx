...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell><a href="https://github.com/launchdarkly/hello-react-native">React Native</a> <br/> <a href="https://github.com/launchdarkly/hello-react-native-typescript">React Native, TypeScript</a></TableCell>
    </TableRow>
    <TableRow>
...
You must make feature flags available to mobile SDKs before the SDK can evaluate those flags. If an SDK tries to evaluate a feature flag that is not available, LaunchDarkly serves the default value for that flag.
