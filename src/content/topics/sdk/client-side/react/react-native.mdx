...
<Callout intent="info">
 ...
 <CalloutDescription>
When `LDClient` initializes for the first time at app launch, users receive feature flag default values until a connection to LaunchDarkly completes for the first time. Read the section above for various ways to initialize the client.</CalloutDescription>
</Callout>
...
To learn more about the return types, read the API documentation about [`LDConnectionMode`](https://launchdarkly.github.io/react-native-client-sdk/enums/_launchdarkly_react_native_client_sdk_.ldconnectionmode.html) and [`LDFailureReason`](https://launchdarkly.github.io/react-native-client-sdk/enums/_launchdarkly_react_native_client_sdk_.ldfailurereason.html).
