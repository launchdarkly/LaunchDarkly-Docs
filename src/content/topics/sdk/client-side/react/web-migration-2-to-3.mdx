...
The minimum React version for the LaunchDarkly React Web v3 SDK is 16.3.3. If you want to use hooks, the minimum version is 16.8. LaunchDarkly no longer supports earlier React Web versions, as stated in the [End of Life policy](https://launchdarkly.com/policies/end-of-life-policy/).
...
To learn more, read the [unit tests migration guide](/guides/infrastructure/unit-tests#migrating-from-users-to-contexts).
