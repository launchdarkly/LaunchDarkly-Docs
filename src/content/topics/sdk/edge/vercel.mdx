...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>
        [SDK API docs](https://launchdarkly.github.io/js-core/packages/sdk/vercel/docs/)
      </TableCell>
    </TableRow>
    <TableRow>
...
After you complete the [Creating a Vercel integration](/integrations/vercel#creating-a-vercel-integration) process, follow these instructions to start using the LaunchDarkly Vercel SDK.
...
After you install and import the SDK, create an edge client using your [Edge Config ID](https://vercel.com/docs/storage/edge-config). Then, initialize an `LDClient` using your LaunchDarkly client-side SDK key and this edge client.
...
const ldClient = init('sdk-key-123abc', edgeClient);
