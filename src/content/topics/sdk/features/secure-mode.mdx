...
Secure mode works by having you configure your JavaScript SDK to include a server-generated HMAC SHA256 hash of your context key or user key. This hash is signed with the SDK key for your environment.
