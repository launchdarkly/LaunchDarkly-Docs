...
The [`SecureModeHash`](http://launchdarkly.github.io/dotnet-server-sdk/html/M_LaunchDarkly_Client_LdClient_SecureModeHash.htm) method computes an HMAC signature of a user signed with the client's SDK key.
