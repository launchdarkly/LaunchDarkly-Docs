...
<CodeTabs
  defaultValue="swift"
  values={[
    { label: 'Swift for iOS SDK v8.0', value: 'swift', },
    { label: 'Objective-C for iOS SDK v8.0', value: 'objc', },
...
To learn more, read [`EvaluationDetail`](https://pkg.go.dev/github.com/launchdarkly/go-sdk-common.v3/ldreason#EvaluationDetail) and [`BoolVariationDetail`](https://pkg.go.dev/github.com/launchdarkly/go-server-sdk/v6#LDClient.BoolVariationDetail).
...
To learn more, read [`EvaluationReason`](https://pkg.go.dev/github.com/launchdarkly/go-sdk-common.v3/ldreason#EvaluationReason).
...
details = boolVariationDetail client user "flag-key-123abc" False
```
...
To learn more, read [`EvaluationDetail`](https://launchdarkly.github.io/java-server-sdk/com/launchdarkly/sdk/EvaluationDetail.html) and [`boolVariationDetail`](https://launchdarkly.github.io/java-server-sdk/com/launchdarkly/sdk/server/LDClient.html#boolVariationDetail(java.lang.String,com.launchdarkly.sdk.LDUser,boolean)).
...
<!-- TKTK Verify endpoint names haven't changed. SC-178150 -->
