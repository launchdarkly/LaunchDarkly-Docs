...
bool value = LDBoolVariationDetail(client, "your.feature.key", false, &details);
...
To learn more about the `LDVariationDetails` structure, inspect [`client.h`](https://launchdarkly.github.io/c-client-sdk/structLDVariationDetails.html).
</Details>
