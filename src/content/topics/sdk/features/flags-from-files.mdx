...
<CodeTabs
  ...
  values={[
    ...
    { label: '.NET SDK 5.x and earlier', value: 'dotnet-pre-6.0', },
  ]
}>
...
<CodeTabs
  ...
  values={[
    ...
    { label: 'Java SDK 4.x and earlier', value: 'java-pre-5.0', },
  ]
}>
...
To learn more, read [`FileDataSource`](https://launchdarkly.github.io/node-server-sdk/index.html#filedatasource).
