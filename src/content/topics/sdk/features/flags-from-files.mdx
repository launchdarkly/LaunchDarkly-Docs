...
*If you want to use YAML instead of JSON, you must [provide a YAML parser](http://launchdarkly.github.io/dotnet-server-sdk/html/M_LaunchDarkly_Client_Files_FileDataSourceFactory_WithParser.htm).*
