...
Every LaunchDarkly SDK lets you configure user objects to return specific data to LaunchDarkly. Any attributes you pass to LaunchDarkly become available on the **Users** dashboard.
...
Feature flag targeting and rollouts are determined by the user you pass to your `variation` calls. In the Ruby SDK, users are simply hashes.
...
Feature flag targeting and rollouts are determined by the user you pass to your `variation` calls. The Rust SDK defines a [`User`](https://docs.rs/launchdarkly-server-sdk/latest/launchdarkly_server_sdk/struct.User.html) struct and a [`UserBuilder`](https://docs.rs/launchdarkly-server-sdk/latest/launchdarkly_server_sdk/struct.UserBuilder.html) to accomplish this.
