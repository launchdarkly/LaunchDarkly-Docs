...
This topic explains how to configure user objects in LaunchDarkly SDKs. This feature is available for both client-side and server-side SDKs.

## Configuring user objects

Every LaunchDarkly SDK lets you configure user objects to return specific data to LaunchDarkly. Some SDKs let you designate anonymous users, users with private attributes, or users united under an alias.
...
Aliased users connect two user objects when multiple LaunchDarkly users represent one person, such as before and after a user logs in. The SDK can associate these two LaunchDarkly users by sending an alias event.
...
<Table>
  <TableHeader>
    <TableHeadCell>Client-side SDK</TableHeadCell>
    <TableHeadCell>Additional features</TableHeadCell>
  </TableHeader>
  <TableBody>
    <TableRow>
      <TableCell><a href="#android">Android</a></TableCell>
      <TableCell>

<a href="#private-user-attributes-in-the-android-sdk">Private user attributes</a><br/>
<a href="#anonymous-users-in-the-android-sdk">Anonymous users</a>

</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#cc-client-side">C/C++</a></TableCell>
      <TableCell>

<a href="#private-user-attributes-in-the-cc-sdk">Private user attributes</a><br/>
<a href="#anonymous-users-in-the-cc-sdk">Anonymous users</a><br/>
<a href="#aliased-users-in-the-cc-sdk">Aliased users</a>

</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#electron">Electron</a></TableCell>
      <TableCell>

<a href="#aliased-users-in-the-electron-sdk">Aliased users</a><br/>

</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#flutter">Flutter</a></TableCell>
      <TableCell>

<a href="#private-user-attributes-in-the-flutter-sdk">Private user attributes</a><br/>
<a href="#anonymous-users-in-the-flutter-sdk">Anonymous users</a>

</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#ios">iOS</a></TableCell>
      <TableCell>

<a href="#private-user-attributes-in-the-ios-sdk">Private user attributes</a><br/>
<a href="#anonymous-users-in-the-ios-sdk">Anonymous users</a><br/>
<a href="#aliased-users-in-the-ios-sdk">Aliased users</a>

</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#javascript">JavaScript</a></TableCell>
      <TableCell>

<a href="#private-user-attributes-in-the-javascript-sdk">Private user attributes</a><br/>
<a href="#anonymous-users-in-the-javascript-sdk">Anonymous users</a><br/>
<a href="#aliased-users-in-the-javascript-sdk">Aliased users</a>

</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#nodejs-client-side">Node.js</a></TableCell>
      <TableCell>

<a href="#private-user-attributes-in-the-nodejs-sdk">Private user attributes</a><br/>
<a href="#anonymous-users-in-the-nodejs-sdk">Anonymous users</a><br/>
<a href="#aliased-users-in-the-nodejs-sdk">Aliased users</a>

</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#react-native">React Native</a></TableCell>
      <TableCell>
<a href="#private-user-attributes-in-the-react-native-sdk">Private user attributes</a><br/>
<a href="#anonymous-user-attributes-in-the-react-native-sdk">Anonymous users</a>
    </TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#react-web">React Web</a></TableCell>
      <TableCell>
The React Web SDK relies on the JavaScript SDK for user-related functionality.<br/>
<a href="#private-user-attributes-in-the-javascript-sdk">Private user attributes</a><br/>
<a href="#anonymous-users-in-the-javascript-sdk">Anonymous users</a><br/>
<a href="#aliased-users-in-the-javascript-sdk">Aliased users</a>
    ...
    <TableRow>
      <TableCell><a href="#roku">Roku</a></TableCell>
      <TableCell>

<a href="#private-user-attributes-in-the-roku-sdk">Private user attributes</a><br/>
<a href="#anonymous-users-in-the-roku-sdk">Anonymous users</a>

</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#xamarin">Xamarin</a></TableCell>
      <TableCell>

<a href="#private-user-attributes-in-the-xamarin-sdk">Private user attributes</a><br/>
<a href="#anonymous-users-in-the-xamarin-sdk">Anonymous users</a>
...
Feature flag targeting and rollouts are determined by the user you pass to your client. In the Android SDK, we use a [builder pattern](https://en.wikipedia.org/wiki/Builder_pattern) to construct users. Here's an example:
...
Here is information about user configuration in the Electron SDK.

### Aliased users in the Electron SDK
...
### Aliased users in the iOS SDK

There are situations in which multiple LaunchDarkly users can represent one person. For example, this can happen when a person initially logs into an application. The person might be represented by an anonymous user before they log in, and a different user after they log in. In that case, that one person is identified by two different users as denoted by different user keys.

The SDK can associate these two LaunchDarkly users by sending an alias event.

The SDK automatically sends an alias event when `identify` is called with a known user if the previous user was anonymous. You can disable this behavior if necessary. To learn more, read [Client configuration options](#configuration-options).
...
### Aliased users in the JavaScript SDK
...
### Aliased users in the Node.js SDK
...
<Table>
  <TableHeader>
    <TableHeadCell>Server-side SDK</TableHeadCell>
    <TableHeadCell>Additional features</TableHeadCell>
  </TableHeader>
  <TableBody>
    <TableRow>
      <TableCell><a href="#net">.NET</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-net-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-net-sdk">Anonymous users</a>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#apex">Apex</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-apex-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-apex-sdk">Anonymous users</a><br/>
      <a href="#aliased-users-in-the-apex-sdk">Aliased users</a>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#cc-server-side">C/C++</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-cc-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-cc-sdk">Anonymous users</a><br/>
      <a href="#aliased-users-in-the-cc-sdk">Aliased users</a>
    ...
    <TableRow>
      <TableCell><a href="#erlang">Erlang</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-erlang-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-erlang-sdk">Anonymous users</a>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#go">Go</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-go-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-go-sdk">Anonymous users</a><br/>
      <a href="#aliased-users-in-the-go-sdk">Aliased users</a>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#haskell">Haskell</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-haskell-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-haskell-sdk">Anonymous users</a><br/>
      <a href="#aliased-users-in-the-haskell-sdk">Aliased users</a>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#java">Java</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-java-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-java-sdk">Anonymous users</a>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#lua">Lua</a></TableCell>
      <TableCell><a href="#aliased-users-in-the-lua-sdk">Aliased users</a></TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#nodejs">Node.js</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-nodejs-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-nodejs-sdk">Anonymous users</a><br/>
      <a href="#aliased-users-in-the-nodejs-sdk">Aliased users</a>
    ...
    <TableRow>
      <TableCell><a href="#php">PHP</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-php-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-php-sdk">Anonymous users</a>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#python">Python</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-python-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-python-sdk">Anonymous users</a><br/>
      <a href="#aliased-users-in-the-python-sdk">Aliased users</a>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell><a href="#ruby">Ruby</a></TableCell>
      <TableCell>
      <a href="#private-user-attributes-in-the-ruby-sdk">Private user attributes</a><br/>
      <a href="#anonymous-users-in-the-ruby-sdk">Anonymous users</a><br/>
      <a href="#aliased-users-in-the-ruby-sdk">Aliased users</a>
      </TableCell>
    </TableRow>
  </TableBody>
</Table>
...
Most of our built-in attributes, like names and email addresses, expect string values. Custom attributes values can be strings, booleans like true or false, numbers, or objects. The SDK uses the [`LdValue`](http://launchdarkly.github.io/dotnet-server-sdk/html/T_LaunchDarkly_Client_LdValue.htm) type to represent arrays and objects. If you enter a custom value that looks like a number or a boolean, it is interpreted that way. The .NET SDK is strongly typed, so be aware of this distinction.
...
- When creating the LaunchDarkly `Configuration` object, you can call the [`AllAttributesPrivate`](http://launchdarkly.github.io/dotnet-server-sdk/html/M_LaunchDarkly_Client_IConfigurationBuilder_AllAttributesPrivate.htm) method, which takes in a boolean parameter. If `true`, all user attributes except the key for all users are removed before the SDK sends the user to LaunchDarkly.
- When creating the LaunchDarkly `Configuration` object, you can call the [`PrivateAttribute`](http://launchdarkly.github.io/dotnet-server-sdk/html/M_LaunchDarkly_Client_IConfigurationBuilder_PrivateAttribute.htm) method, which takes in a string attribute nameas a parameter and adds it to an internally managed list of private attributes. This method may be called multiple times to mark additional attributes as private. If any user has a custom or built-in attribute named in the private attributes list, it are removed before the SDK sends the user to LaunchDarkly.

You can also mark attributes as private when building the user object by calling [`AsPrivateAttribute()`](http://launchdarkly.github.io/dotnet-server-sdk/html/M_LaunchDarkly_Client_IUserBuilderCanMakeAttributePrivate_AsPrivateAttribute.htm) after setting the attribute on the user builder. For example:
...
The SDK can associate these two LaunchDarkly users by sending an alias event. You can manually tell the SDK to send an alias event with the `LDClientAlias` function.
...
Feature flag targeting and rollouts are determined by the user you pass to your `Variation` calls. The Go SDK defines a [`User`](https://pkg.go.dev/gopkg.in/launchdarkly/go-sdk-common.v2/lduser#User) struct and a [`UserBuilder`](https://pkg.go.dev/gopkg.in/launchdarkly/go-sdk-common.v2/lduser#UserBuilder) to make this easy. Here's an example:
...
### Aliased users in the Haskell SDK
...
You can also mark attributes as private when building the user object by calling the equivalent "private" [`LDUserBuilder`](http://launchdarkly.github.io/php-server-sdk/classes/LaunchDarkly-LDUserBuilder.html) method. For example:
...
### Aliased users in the Python SDK
