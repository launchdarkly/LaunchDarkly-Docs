...
<CSTab label="Node.js v6.x and older (JavaScript)">
...
<CSTab label="Node.js v6.x and older (TypeScript)">
...
<CSTab label="Node.js SDK v6.x and older (JavaScript)">
...
<CSTab label="Node.js SDK v6.x and older (TypeScript)">
...
<CSTab label="Node SDK v6.x and older (JavaScript)">
...
<CSTab label="Node SDK v6.x and older (TypeScript)">
