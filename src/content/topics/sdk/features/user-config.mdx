...
In the 6.x versions of the SDK, the user key is required when building anonymous users. To learn more, read [Understanding changes to anonymous users](/sdk/client-side/react/react-native-migration-6-to-7#understanding-changes-to-anonymous-users) in the [React Native SDK 6.x to 7.0 migration guide](/sdk/client-side/react/react-native-migration-6-to-7).
</Details>
