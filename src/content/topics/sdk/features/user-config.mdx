...
You can optionally configure the PHP SDK to treat some or all attributes as [private attributes](/home/contexts/attributes#using-private-user-attributes). Private attributes can be used for targeting purposes, but are removed from the data sent back to LaunchDarkly.
