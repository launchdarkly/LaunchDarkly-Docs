...
To learn more about the return types, read the API documentation about [`LDConnectionMode`](https://launchdarkly.github.io/react-native-client-sdk/interfaces/_launchdarkly_react_native_client_sdk_.ldconnectionmode.html) and [`LDFailureReason`](https://launchdarkly.github.io/react-native-client-sdk/interfaces/_launchdarkly_react_native_client_sdk_.ldfailurereason.html).
...
<Callout intent="info">
  <CalloutTitle>Supported versions</CalloutTitle>
<CalloutDescription>
This feature is available in the .NET SDK's versions 6.0.0 and later.</CalloutDescription>
</Callout>
