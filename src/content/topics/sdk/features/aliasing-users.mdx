...
In version 3 and newer of the Node.js SDK, aliasing is no longer supported or required. To learn more, read [JavaScript SDK 2.x to 3.0 migration guide](/sdk/client-side/javascript/migration-2-to-3).
