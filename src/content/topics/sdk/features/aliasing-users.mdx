...
In version 7 and newer of the React Native SDK, aliasing is no longer supported or required. To learn more, read [React Native SDK 6.x to 7.0 migration guide](/sdk/client-side/react/native-migration-6-to-7).
