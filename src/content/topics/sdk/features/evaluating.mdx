...
- [`jsonValueVariation`](https://launchdarkly.github.io/java-server-sdk/com/launchdarkly/sdk/server/LDClient.html#jsonValueVariation(java.lang.String,com.launchdarkly.sdk.LDContext,com.launchdarkly.sdk.LDValue)) can be of any JSON type.

The `variation` methods take the feature flag key, an [`LDContext`](http://launchdarkly.github.io/java-server-sdk/com/launchdarkly/sdk/LDContext.html), and a default value.
