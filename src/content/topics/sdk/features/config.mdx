...
You can disable the publication of events, but we strongly recommend against it. Many features such as targeting rules, flag statuses, and the Users dashboard depend on regularly receiving analytics events. To learn more, read [Analytics events](/sdk/concepts/events).
