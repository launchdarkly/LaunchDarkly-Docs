...
<CodeTabs
  defaultValue="js"
  values={[
    { label: 'Node.js SDK 3.0, single context', value: "js" },
    { label: 'Node.js SDK 3.0, multi-context', value: "js-multi" },
    { label: 'Node.js SDK 2.x', value: "js-2.x" },
  ]
}>
<CodeTabItem value="js">
...
<CodeTabs
  ...
  values={[
    ...
    { label: 'Python SDK v7.x', value: 'python', },
  ]
}>
