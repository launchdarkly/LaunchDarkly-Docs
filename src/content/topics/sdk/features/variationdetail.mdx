...
To learn more, read [`EvaluationDetail`](https://launchdarkly.github.io/xamarin-client-sdk/html/T_LaunchDarkly_Client_EvaluationDetail_1.htm) and [`BoolVariationDetail`](https://launchdarkly.github.io/xamarin-client-sdk/html/M_LaunchDarkly_Xamarin_ILdClient_BoolVariationDetail.htm).
...
To learn more, read [`EvaluationDetail`](http://launchdarkly.github.io/dotnet-server-sdk/html/T_LaunchDarkly_Client_EvaluationDetail_1.htm) and [`BoolVariationDetail`](http://launchdarkly.github.io/dotnet-server-sdk/html/M_LaunchDarkly_Client_ILdClient_BoolVariationDetail.htm).
