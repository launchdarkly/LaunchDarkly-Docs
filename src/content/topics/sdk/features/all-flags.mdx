...
The all flags feature does not create users in your LaunchDarkly account. Unlike `variation` and `identify`, the all flags feature does not send events that would create a user to LaunchDarkly.
