...
In most of the client- and server-side SDKs, getting all flags does not create contexts, users, or other analytics events in your LaunchDarkly account. Additionally, getting all flags usually does not send events that create a context or user within LaunchDarkly or populate the flag evaluations graph for a flag.
...
To learn more, read the [API documentation](https://launchdarkly.github.io/java-server-sdk/com/launchdarkly/sdk/server/interfaces/LDClientInterface.html#allFlagsState(com.launchdarkly.sdk.LDContext,com.launchdarkly.sdk.server.FlagsStateOption...)).
</Details>
