...
To use either the Redis integration (as shown above) or the DynamoDB integration in the Ruby SDK, you must also install additional packages. To learn more, read [Storing data: Redis](/sdk/features/storing-data/redis#python) and [Storing data: DynamoDB](/sdk/features/storing-data/dynamodb#python).
...
To use either the Redis integration (as shown above) or the DynamoDB integration in the Ruby SDK, you must also install additional gems. To learn more, read [Storing data: Redis](/sdk/features/storing-data/redis#ruby) and [Storing data: DynamoDB](/sdk/features/storing-data/dynamodb#ruby).
