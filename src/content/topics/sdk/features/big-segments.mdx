...
![The "Targeting" tab of a feature flag targeting a Big Segment.](flag-targeting-big-segment.png)
...
<CSTab label="Node.js SDK v6.2.0 -  v7.x (JavaScript)">
...
<CSTab label="Node.js SDK v6.2.0 - v7.x (TypeScript)">
...
To learn more about the available Big Segments configuration options, read [`LDBigSegmentsOptions`](https://launchdarkly.github.io/js-core/packages/sdk/server-node/docs/interfaces/LDBigSegmentsOptions.html).
