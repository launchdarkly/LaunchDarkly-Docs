...
To use either the Redis integration, as shown above, or the DynamoDB integration in the Java SDK, you must also install additional packages. To learn more, read [Using Redis as a persistent feature store](/sdk/features/storing-data/redis#java) and [Using DynamoDB as a persistent feature store](/sdk/features/storing-data/dynamodb#java).
...
To use either the Redis integration, as shown above, or the DynamoDB integration in the Python SDK, you must also install additional packages. To learn more, read [Using Redis as a persistent feature store](/sdk/features/storing-data/redis#python) and [Using DynamoDB as a persistent feature store](/sdk/features/storing-data/dynamodb#python).
...
To use either the Redis integration, as shown above, or the DynamoDB integration in the Ruby SDK, you must also install additional gems. To learn more, read [Using Redis as a persistent feature store](/sdk/features/storing-data/redis#ruby) and [Using DynamoDB as a persistent feature store](/sdk/features/storing-data/dynamodb#ruby).
