...
The track feature lets you record actions your users take in your application as events. You can connect these events to metrics in experiments in the flag dashboard.
