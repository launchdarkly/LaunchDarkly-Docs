...
You can also attach custom data to your event by calling [`track`](https://launchdarkly.github.io/flutter-client-sdk/launchdarkly_flutter_client_sdk/LDClient/track.html) with optional parameters.
</Details>
