...
The Node.js SDK can use [Consul](/sdk/features/storing-data/consul#nodejs), [DynamoDB](/sdk/features/storing-data/dynamodb#nodejs-server-side), or [Redis](/sdk/features/storing-data/redis#nodejs-server-side) to hold flag data.
...
The PHP SDK can use [Consul](/sdk/features/storing-data/consul), [DynamoDB](/sdk/features/storing-data/dynamodb), or [Redis](/sdk/features/storing-data/redis) to hold flag data.
