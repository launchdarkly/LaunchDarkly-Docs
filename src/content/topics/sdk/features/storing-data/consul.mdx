...
To view the JSON representations of all flags and segments, query <code>https://sdk.launchdarkly.com/sdk/latest-all</code> with your SDK key in the `Authorization` header.
...
The Node.js (server-side) SDK v8.0 does not include Consul support. If you have questions or want to request this, [contact Support](https://support.launchdarkly.com/hc/en-us/requests/new).
