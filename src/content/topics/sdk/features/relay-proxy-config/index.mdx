...
* In **daemon** mode, the SDK connects directly to the Relay Proxy's datastore. We recommend this configuration when you're using LaunchDarkly with PHP or in a serverless environment.
...
To learn more about analytics events, read [The Users dashboard](/home/users/users-dashboard).
