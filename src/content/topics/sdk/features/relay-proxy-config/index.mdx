...
Regardless of whether you are using proxy mode or daemon mode, you also need to determine how to handle your analytics events, so that you can configure the SDK appropriately. The SDK sends data from analytics events to the **Users** list.
...
* The SDK can send events to the Relay Proxy. In this situation, the SDK connects to the Relay Proxy for the events service. To configure this you must:
  ...
  - Enable event forwarding in the Relay Proxy. To learn how, read [Event forwarding](https://github.com/launchdarkly/ld-relay/blob/v6/docs/events.md).
