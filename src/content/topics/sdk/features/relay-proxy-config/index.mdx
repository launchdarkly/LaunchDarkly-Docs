...
The Relay Proxy is a small Go application that lets multiple servers connect to a local stream instead of making a large number of outbound connections to LaunchDarkly's streaming service. To learn more, read [The Relay Proxy](/home/relay-proxy).
