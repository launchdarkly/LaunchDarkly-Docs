...
This configuration means that the device gets near real-time updates for feature flag values when the app is in the foreground. You can configure these settings if needed. To learn more, read [Configuration](/sdk/features/config#xamarin)
