...
Use the `mockFlags` function to mock flags. Pass an [LDFlagSet](https://launchdarkly.github.io/js-client-sdk/interfaces/LDFlagSet.html) containing the flag keys and values you want to mock. You can use camelCase, snake_case, kebab-case, or unchanged flag keys when mocking flags.
