...
- You want to [increase startup speed in your serverless functions](/home/relay-proxy/use-cases#reducing-initialization-latency-in-a-serverless-environment).
