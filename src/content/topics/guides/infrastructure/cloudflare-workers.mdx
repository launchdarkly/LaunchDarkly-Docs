...
This guide explains how to connect LaunchDarkly to Cloudflare Workers using [LaunchDarkly's Cloudflare SDK](/sdk/server-side/cloudflare).
...
5. Copy and store the namespace ID as you'll need it to enable LaunchDarkly's Cloudflare integration.
  ...
  If you plan to use the [Cloudflare Workers preview service](https://cloudflareworkers.com/), you will need to create a preview namespace as well. To set this up, follow the [Cloudflare integration docs](/integrations/cloudflare#creating-a-cloudflare-worker-with-the-@launchdarkly/cloudflare-server-sdk).
