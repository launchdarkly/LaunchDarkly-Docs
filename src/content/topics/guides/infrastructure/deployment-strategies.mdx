...
These releases are useful when you cannot run a beta program, or there is little variation in your targeted user base. If you run a small B2B application with the same 1,000 monthly active users (MAU), a percentage-based release is likely to give you an accurate estimate of whether the full rollout is likely to have positive or negative impact on your user base.
