...
2. Find any context instances with exposed PII using the [search context instances API endpoint](https://apidocs.launchdarkly.com/tag/Contexts-(beta)#operation/searchContextInstances).
3. Delete the affected context instances from the **Contexts** list in one of two ways:
  ...
  - [using the API with the delete context instances endpoint](https://apidocs.launchdarkly.com/tag/Contexts-(beta)#operation/deleteContextInstances). If you want to delete all context instances out of an environment, you can find them using the [search context instances API endpoint](https://apidocs.launchdarkly.com/tag/Contexts-(beta)#operation/searchContextInstances).
