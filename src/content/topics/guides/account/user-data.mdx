...
To learn more about the built-in attributes LaunchDarkly suggests you collect, read [Targeting based on built-in attributes](/home/flags/targeting-rules#targeting-based-on-built-in-attributes) and [Setting user attributes](/home/users/attributes).
