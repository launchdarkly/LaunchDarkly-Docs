...
* You must know how to [create feature flags](/home/flags/feature-flags)
...
Flags with no specified end date, or "permanent" flags, are part of the everyday operation of the application. They don't have a determined lifespan, so you shouldn't remove them as you would a temporary flag. In LaunchDarkly, you can designate a flag as “permanent” when you create it. To learn more, read [Creating a feature flag](/home/flags/feature-flags#creating-a-feature-flag).
