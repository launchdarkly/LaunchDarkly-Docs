...
import { StaticSiteDemo } from '@/components/flags/StaticSiteDemo'
...
- Know how to make a flag available to client-side SDKs. To learn more, read [Making flags available to client-side and mobile SDKs](/home/flags/feature-flags#making-flags-available-to-client-side-and-mobile-sdks).
...
Try it in your SDK: [Getting all flags](/sdk/features/all-flags)
...
Configure your SDK: [Bootstrapping with JavaScript](/sdk/features/bootstrapping#javascript)
...
Configure your SDK: [Subscribing to flag changes](/sdk/features/flag-changes#javascript)
