...
<CalloutTitle>Flags must be in the same project to use one as a prerequisite of the other</CalloutTitle>
<CalloutDescription>
...
<CodeSample>
<CSTab label="Flag code structure">
...
<CodeSample>
<CSTab label="Flag code structure with dependencies">
...
Flag rules are evaluated top-to-bottom, as shown in the flag's **Targeting** tab. You can drag and drop flag rules to change the order of evaluation. _Prerequisites always apply before flag rules._
