...
<Details summary="Expand Circuit breakers flags example">

### Circuit breaker flags

Circuit breaker flags are permanent safety mechanisms used to shut off functionality or third-party tools in an emergency.

Here is a table of circuit breaker flag example names, keys, and human-language interpretations:
...
<Table>
  ...
  <TableBody>
  <TableRow>
    <TableCell>Circuit breaker: disable Acme integration</TableCell>
    <TableCell><code>circuit-breaker-disable-acme-integration</code></TableCell>
    <TableCell>Circuit breaker for the Acme integration</TableCell>
  </TableRow>
  <TableRow>
    <TableCell>Circuit breaker: social media auto posts</TableCell>
    <TableCell><code>circuit-breaker-social-media-auto-posts</code></TableCell>
    <TableCell>Circuit breaker for all automated social media posts</TableCell>
  </TableRow>
  </TableBody>
</Table>
