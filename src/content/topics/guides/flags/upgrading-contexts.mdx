...
<!-- TKTK Update this section at GA SC-178188 -->
...
Then, consider if you want to customize your application metadata. You can view your default application metadata on a context's details page under "From app/SDK:" as context instance versions. To learn more, read [The context details page](/home/contexts/context-details).
