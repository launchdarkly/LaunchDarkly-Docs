...
Try it in your SDK: [Identifying and changing contexts](/sdk/features/identify)
...
When you add contexts to your code, you can specify various attributes to differentiate them. We recommend including the <code>name</code> attribute, which will let you target flags by a person's full name. To learn more, read [Built-in attributes](/home/contexts/built-in-attributes).
...
Configure your SDK: [Application metadata configuration](/sdk/features/app-config)
