...
When you add contexts to your code, you can specify various attributes to differentiate them. We recommend including the <code>name</code> attribute, which will let you target flags by a person's full name. To learn more, read (/home/contexts/built-in-attributes)[Built-in attributes].
