...
* Sending HTML with flag information to the server

### Using localStorage

If you use localStorage, the client can initialize itself without an additional delay from fetching the flags from the LaunchDarkly servers.
