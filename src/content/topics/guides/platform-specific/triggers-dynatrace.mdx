---
path: '/guides/platform-specific/triggers-dynatrace'
...
3. Choose "Dynatrace" from the **Trigger type** dropdown.
...
For another example of how you can use flag triggers with APM tools, read [Automating application performance management](/guides/best-practices/integrations-use-cases#automating-application-performance-management).
