...
The SDK communicates evaluation and diagnostic data back to the server as part of normal usage. The LaunchDarkly user interface displays this data in several places, including the [flag dashboard](/home/organize/dashboard), the [flag Insights tab](/home/flags/insights), and in [Experimentation](/home/experimentation).
