---
path: /guides/platform-specific/svelte
...
- `getClient()` checks to see if the client has already initialized and, if not, initializes it. In either case, it returns an instance of the SDK client.
...
- `getClient()` checks to see if the client has already been initialized and, if not, initializes it. In either case, it returns an instance of the SDK client.
