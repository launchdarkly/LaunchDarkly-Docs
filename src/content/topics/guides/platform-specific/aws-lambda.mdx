...
7. Toggle the flag **on** and save again. If you don't turn targeting on, the percentage rollout will not run and you'll only get the default variation.
...
1. Go to the flag dashboard and click into the "rebrand" flag.
