...
These are the practices we recommend to avoid conflicts that can arise when some of your flags are managed through Terraform and others are managed through the flag dashboard:
