...
1. In LaunchDarkly, navigate to **Integrations** and go to the "Webhooks" section.
2. Click **+ Integration** to add a new webhook.
...
2. Paste this code into the advanced editor. Change the project key from `brian-test` to your LaunchDarkly project key. You can get the project key in the LaunchDarkly dashboard under **Account settings** > **Projects**.
...
To test this policy, create a flag and tag it with `build-impact`. Now change its value and then go to your Netlify or Vercel dashboard. You should see a new build starting. Next, create a flag and do not tag it. Change its value and check your Netlify or Vercel dashboard. Nothing will change.
