...
2. Paste this code into the advanced editor. Change the project key from `brian-test` to your LaunchDarkly project key. You can get the project key in the flag dashboard under **Account settings** > **Projects**.
