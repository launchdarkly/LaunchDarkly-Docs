...
* Avoid, unless necessary, using Terraform to make changes to flag targeting rules or flag variations. The benefit of managing these actions in the UI is the ability to use LaunchDarkly's comment, audit log, scheduling, flag trigger, and approval workflow features.
