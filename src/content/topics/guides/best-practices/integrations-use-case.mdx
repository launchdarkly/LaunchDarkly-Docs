...
You can create a similar workflow in other apps. To learn how to set up chat integrations with policy filters in Microsoft Teams, read [Configuring LaunchDarkly to work with Teams](/integrations/microsoft-teams#configuring-launchdarkly-to-work-with-teams).
