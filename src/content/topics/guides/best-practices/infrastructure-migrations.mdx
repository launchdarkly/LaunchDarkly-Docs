...
<Callout intent="info">
  <CalloutDescription>
    The <code>ldclient.BoolVariation()</code> function retreives the feature flag value from LaunchDarkly and accepts 3 parameters:
    feature flag name, user account object, and default flag value
  </CalloutDescription>
</Callout>
...
<LearnMore>
  <LearnMoreLink to="/home/managing-flags/targeting-users#percentage-rollouts">Percentage rollouts</LearnMoreLink>
</LearnMore>
