...
Learn more: [Percentage rollouts](/home/flags/targeting-rules#percentage-rollouts)

</LearnMore>

Once you're comfortable with the performance metrics and error counts you're receiving with reads and writes, you can now turn off the read and write flags for `db1`, remove all references to all four flags in your code, and you are left with just `db2`.
