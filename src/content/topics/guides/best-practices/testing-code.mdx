...
To learn more, read [Creating targeting rules](/home/flags/targeting-rules#creating-targeting-rules) and our guide [Getting started: Flag rules and targeting](/guides/tutorials/rules-and-targeting).
