...
Statistical significance can vary over the course of an experiment. You may choose to run the experiment for slightly longer to learn if that changes the results.
...
To learn more about how LaunchDarkly displays experiment data, read [Analyzing experiment data](/home/experimentation/analyzing).
...
To learn more about setting metrics for experiments in LaunchDarkly, read [Creating metrics](/home/experimentation/metrics/index).
