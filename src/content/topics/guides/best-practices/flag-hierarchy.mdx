...
![A flag's Targeting tab with the prerequisites menu expanded.](../../images/guide-hierarchy-prereq.png)
...
![In this example Student Discount Pricing is dependent on Pricing Tier 3](../images/flag-deps.png)
