...
To learn more about how LaunchDarkly manages different environments, read [Environments](/home/managing-flags/environments).
...
Feature flags are control points we use to change how software acts after it's deployed. You can think of the ability to feature flag as a tool, and the ways feature flags get implemented as patterns. Feature flags are tools that we implement in specific patterns with the objective of achieving a business goal, like controlling who can access a certain feature or testing UI changs on a website. 
...
- [Flag prerequisites](#flag-prerequisites)
...
### Prerequisite, or "keystone," flags
...
You can set prerequisite flags in the "Prerequisite" section of the dependent flag's Targeting tab.

![A flag's Targeting tab with the prerequisite menu expanded.](../../images/guide-hierarchy-prereq.png)
...
If want to create a flag that is a prerequisite of other flags, you can do this by setting that flag as a prerequisite in each dependent flag's Targeting tab.

![Example: Student Discount Pricing is dependent on Pricing Tier 3](../images/flag-deps.png)
...
![A flag with a prerequisite and multiple rules.](../images/flag-deps2.png)
...
decommissioning software, it may make sense to restrict which team members can change the flag
