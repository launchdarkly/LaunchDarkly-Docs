...
Rollout flags are temporary. After you verify the new code is stable and roll out the feature to 100% of users, you should delete the flag. To learn more, read [Percentage rollouts](/home/flags/targeting-rules#percentage-rollouts).
