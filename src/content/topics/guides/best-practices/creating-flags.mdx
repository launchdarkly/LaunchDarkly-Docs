...
You create a temporary flag when you know you can remove it after a feature is fully deployed or the flag is no longer needed. Temporary flags can include flags used for experimentation, rollout, testing, and feature releases.
...
You can also create flags with dependencies on each other. Flags can depend on other flags being true or false, or on the features controlled by different flags.
