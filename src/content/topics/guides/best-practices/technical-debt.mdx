...
Test the fallback values of permanent flags periodically to ensure they are up to date and delivering valid states. To learn more about fallback values, read [Changing default flag variations](/home/flags/variations#changing-default-flag-variations).
