...
<Callout intent="alert">
  ...
  <CalloutDescription>
    Further hardening the privacy of your LaunchDarkly projects may require some LaunchDarkly features to stop working or cause performance degradation. To learn more, read [Impacted features](#impacted-features).
  </CalloutDescription>
</Callout>
