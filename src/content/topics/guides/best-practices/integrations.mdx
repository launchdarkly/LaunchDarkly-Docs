...
This guide explains how managing your applications with feature flags helps your team be more productive by detaching the deployment and release of your features. Using LaunchDarkly in concert with other tools enhances your team's workflow and ability to react when issues arise.
...
You can use our integrations to enhance collaboration, change management, and many other business areas.

# Learning about different types of integrations

LaunchDarkly's integrations span a variety of categories. We'll discuss several of them here.
...
## Handling project and change management
...
When teams are distributed, it is useful to be able to centralize information about your feature flags in tools many teams in your organization use.
...
Developer tools are the place where developers spend most of their day and do most of their work, so it makes sense that we built integrations that allow them to schedule ring deployments or performa internal testing directly from their tool.
