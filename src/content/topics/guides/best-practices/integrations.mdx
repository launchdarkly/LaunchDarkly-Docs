...
as Amazon Kinesis, Google PubSub, or others.
...
If you want to build an integration yourself, or request one from us, [contact Support](https://support.launchdarkly.com/hc/en-us/requests/new) or your LaunchDarkly account representative.
