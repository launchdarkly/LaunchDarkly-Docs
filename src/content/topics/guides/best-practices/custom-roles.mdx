...
Before you configure SSO to use custom roles, scope the different roles, teams, and permissions your organization uses. Defining your roles will help you create a policy structure that’s scalable and easy to implement.
...
With your custom roles designed and built, you can now manage them using your IdP provider.
