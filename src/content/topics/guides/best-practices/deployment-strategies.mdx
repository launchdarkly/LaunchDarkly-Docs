...
To help you know when a flag should be removed, LaunchDarkly has indicators on the flag dashboard that show whether a flagged feature is fully active. An active flag has been rolled out to 100% of your userbase, so it may be safe to remove it.
