...
You should understand the follwing concepts before you read this guide.

## Deployment and release

It’s easy to use deployment and release interchangeably, but in a feature-flagging or continuous-delivery environment, they have distinct meanings. It’s useful to understand the differences between them so you can
...
To learn more, read [Flag statuses](/home/organize/dashboard#flag-statuses).
