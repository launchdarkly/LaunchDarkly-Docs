---
path: /guides/best-practices/designing-experiments
...
To learn more about Experimentation, read [About Experimentation](/home/about-experimentation).
...
To learn more about metric types, read [Creating metrics](/home/experimentation/metrics).
...
One of the advantages of feature-flag-based experimentation is that your engineering team can immediately roll out the winning variation to the appropriate audiences. The winning variation for a completed experiment is the variation that is most likely to be the best option out of all of the variations you tested. To learn more, read [Winning variations](/home/analyzing-experiments/winning-variations).
...
To complete an exercise in which you create an experiment and assess its results, read [Getting started: Experimenting with feature flags](/guides/tutorials/experimentation).
