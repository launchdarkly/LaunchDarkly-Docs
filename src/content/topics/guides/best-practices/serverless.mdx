...
title: 'Using LaunchDarkly in serverless functions'
description: 'This guide provides best practice advice for using LaunchDarkly with Function-as-a-Service (also known as serverless) platformas, such as AWS Lambda.'
published: true
---
...
<CalloutDescription>Both of the examples below use AWS Lambda, but you can use this approach for other FaaS platforms as well.</CalloutDescription>
</Callout>
...
Now that both the feature store and the store update function are ready, add a webhook to the LaunchDarkly Project. To learn more, read [Webhooks](/integrations/webhooks).
...
![Creation of a LaunchDarkly webhook which will send flag updates to a Lambda function](../../lambda-webhook.png)
...
To learn more, read [Using a persistent feature store without connecting to LaunchDarkly](/sdk/concepts/feature-store#using-a-persistent-feature-store-without-connecting-to-launchdarkly).
