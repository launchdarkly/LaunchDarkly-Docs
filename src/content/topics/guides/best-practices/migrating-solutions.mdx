...
- If flag A is on, the user sees a read background
- If flag B is on, the user sees a blue background
- If neither flag A nor B is on, the user sees a yellow background
