...
It is not required that you complete any of the other tutorials before reviewing this one. If you have completed the [Getting started: Configuring an SDK and creating a flag](/guides/tutorials/sdk-flag) or [Getting started: Flag rules and targeting](/guides/tutorials/rules-and-targeting) tutorials, you can use the same projects and flags in the exercises below.
...
If no users have encountered your flag, the `totalCount` is zero. To see what the response looks like with several users, complete the [Getting started: Flag rules and targeting](/guides/tutorials/rules-and-targeting) tutorial and repeat this request using the account, project, and flag you used in those exercises.
