...
During the exercises in the [Getting started: Configuring an SDK and creating a flag](/guides/tutorials/sdk-flag) guide, you created a LaunchDarkly project, and configured your app to use the SDK key from an environment in that project. This new app will use the same SDK key.
...
1. Click on the name of the project which you created for the [Getting started: Configuring an SDK and creating a flag](/guides/tutorials/sdk-flag) guide. The **Environments** tab appears.
...
The **Users** dashboard displays all users who have been included in user objects so far. Access the **Users** dashboard in the sidenav of your LaunchDarkly project.
