...
1. Find the project which you created for the <a href="/guides/tutorials/sdk-flag">Your first flag</a> guide.
...
6. A targeting circle appears next to the selector. This indicates that you are adding analysis explicit targeting rule for this user.
