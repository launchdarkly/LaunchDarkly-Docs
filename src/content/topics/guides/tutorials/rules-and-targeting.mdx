...
<CalloutTitle>You must have completed prerequisites to do this exercise</CalloutTitle>
<CalloutDescription>This exercise relies on flags and SDK keys you created in the <a href="/guides/tutorials/first-flag">Your first flag</a> guide.<br/><br/> If you have not completed that guide, do so now and return to this section.</CalloutDescription>
</Callout>
