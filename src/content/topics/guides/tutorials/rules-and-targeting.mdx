...
* You must have completed the exercises in [Getting started: Configuring an SDK and creating a flag](/guides/tutorials/sdk-flag). The exercises in this guide rely on apps and flags you create in that guide.
* The SDK key for the environment you created in [Getting started: Configuring an SDK and creating a flag](/guides/tutorials/sdk-flag).
...
The exercises in this guide rely on the flags and SDK keys you created in the <a href="/guides/tutorials/sdk-flag">Getting started: Configuring an SDK and creating a flag</a> guide.<br/><br/> If you have not completed that guide, do so now and return to this section.
...
During the exercises in the [Getting started: Configuring an SDK and creating a flag](/guides/tutorials/sdk-flag) guide, you created a LaunchDarkly project, and configured your app to use the SDK key from that project. This new app will use the same SDK key.
...
1. Find the project which you created for the [Getting started: Configuring an SDK and creating a flag](/guides/tutorials/sdk-flag) guide.
...
When you completed the exercises in [Getting started: Configuring an SDK and creating a flag](/guides/tutorials/sdk-flag), you created a flag named Pricing Tier 3.
...
In [Getting started: Configuring an SDK and creating a flag](/guides/tutorials/sdk-flag), you learned about the `variation()` method, which application code uses to evaluate flags.
