...
To learn more about metrics in experiments, read [Creating metrics](/home/creating-experiments/metrics).
...
1. In LaunchDarkly, select **Experiments** from the sidenav.
