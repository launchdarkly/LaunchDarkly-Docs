...
Metrics let you measure user behaviors affected by a flag. The three types of metrics are click, pageview, and custom metrics.

To learn more about metrics in experiments, read [Creating metrics](/home/experimentation/creating-metrics).
