...
* You should be familiar with the concept of experimentation for software products, and know what results you want to determine. To learn more, read [Introduction to experimentation](/guides/best-practices/experimentation).
...
You can re-use the project and environment you created in [Getting started with your first
flag](/guides/tutorials/first-flag), or create a new one. 

![Project and environments](../../../images/space-camp-projects.png)
...
![.env file](../../../images/dot-env-experimentation.png)
...
4. Enter a description of the flag to help team members understand what the flag is for.
...
6. Under "Flag variations", choose **Number**.
...
8. Click the 'Make this flag available to client-side SDKs' checkbox.
9. Save your new flag.

<iframe src="https://drive.google.com/file/d/1Oy65DBNWBjl48R7RGPaXt9wAvOI5TXOT/preview" width="100%" height="410" style="margin-bottom:24px" allowfullscreen></iframe>
...
![Targeting rules configuration](../../../targeting-rules.png)
...
<Callout intent="alert">
 <CalloutTitle>Remember to disable "Do not track"</CalloutTitle>
 <CalloutDescription>If you have not disabled "Do not track," you will not be able to log in to the Glitch app. If "Do not track" is disabled, but the login still fails, try disabling ad blockers or popup blockers in your browser as well.</CalloutDescription>
</Callout>
...
1. Select **Metrics** from the sidebar menu.
...
1. Click into the flag's **Experiments** tab.
1. Click **+ Create an Experiment**. The "Update experiment settings for all environments" menu appears.
1. Choose the metric you created from the "Add a new metric" dropdown.
1. Select Variation 4, "No discount," as the baseline.
1. Click **Save Experiment Settings**. You return to the flag's **Experiments** tab.

You've created the experiment and it's ready to go. Now you have to start it.

<iframe src="https://drive.google.com/file/d/1xkmRnVqeLzCx4K-7ssEmLJBUQqfKFnsC/preview" width="100%" height="410" style="margin-bottom:24px"></iframe>
...
<Callout intent="info">
  ...
  <CalloutDescription>
    Data can take up to 10 minutes to appear in LaunchDarkly after your
    experiment starts.
  </CalloutDescription>
</Callout>

After you press `!`, 100 .com email addresses and 100 .edu email addresses will try to access your app. None of the .com email addresses will receive a reduced price. The .edu addresses will randomly receive
