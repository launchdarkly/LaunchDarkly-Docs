...
7. In the "Flag variations" dropdown choose **Number**.
...
![The "Create a feature flag" screen for the Student Discount Pricing flag.](starlight-travel-student-discount-flag.png)
...
1. Click **Run an experiment on this rule**.
1. In the "Select an attribute" dropdown choose `email`.
1. In the "Select an operator" dropdown choose `ends with`.
1. In the "Enter some values" field enter `.edu`.
1. In the last dropdown choose `a percentage rollout`. 
...
1. In the "Target URL" dropdown, choose **Substring Match**.
...
![The Experiment setup screen.](starlight-travel-experiment-setup.png)
...
![An experiment's results page.](starlight-travel-experiment-results.png)
