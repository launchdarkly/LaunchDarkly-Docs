...
To learn more about how to create an effective experiment, read [Designing experiments](/guides/best-practices/experimentation).
...
* You should be familiar with the concept of experimentation for software products, and know what results you want to determine. To learn more, read [Designing experiments](/guides/best-practices/experimentation).
