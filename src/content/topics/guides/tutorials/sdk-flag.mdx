---
path: '/guides/tutorials/sdk-flag'
title: 'Configuring an SDK and creating a flag'
...
To learn more, read [Targeting users](/docs/targeting-users) and [Variations](/home/flags/variations).
...
![The Space Camp pricing page, running in Glitch.](../../../space-camp-pricing-page-0.png)
...
To remix the app, select this [Glitch remix link](https://glitch.com/edit/#!/remix/ld-space-camp-0), or follow the instructions below.
...
3. Give your project a human-readable **Name**. In the example below, the project is called `Space Camp`.
...
![The Create flag button on the flags dashboard.](../../images/flag-new-callout.png)
...
![The pricing-tier-3 flag](../../images/pricing-tier-3-flag.png)
...
Now you wrap the HTML for the new pricing page in the flag you just created. This prevents anyone who is not targeted by the flag from seeing the new pricing page.
...
1. From the LaunchDarkly app, click **Feature flags**.
2. Navigate to the `pricing-tier-3` flag.
3. Click the Targeting toggle to toggle the flag to `on`.
4. Enter a comment.
5. Click **Save changes**.
6. Refresh the browser with your Glitch app in it again to verify that the new pricing tier is available.
