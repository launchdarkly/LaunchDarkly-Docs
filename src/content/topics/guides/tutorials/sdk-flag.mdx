...
3. Give your project a human-readable **Name**. In the example below, the project is called `Starlight Travel`.
...
To learn more about environment variables in Glitch, read [Glitch's documentation](https://help.glitch.com/kb/article/18-how-do-i-store-secrets-credentials-or-private-data/).
