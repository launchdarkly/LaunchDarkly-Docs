...
5. Click **Save project**. You are returned to the **Projects** tab.
6. Click the new project's SDK key to copy it to your clipboard:
...
1. In LaunchDarkly, navigate to the **Feature flags** dashboard.
2. Click **Create flag**:

![The Create flag button on the flag dashboard.](flag-new-callout.png)
