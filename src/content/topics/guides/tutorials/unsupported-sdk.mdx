...
Another option if there is not a supported SDK for your tech stack is to use the SDK microservice. LaunchDarkly does not officially support this option.
...
#### Supported features of the SDK microservice
----
<br/>
...
The SDK microservice is a wrapper around the Go SDK, so it supports several additional features available in that SDK. The following table summarizes the features and how to learn more about them.
