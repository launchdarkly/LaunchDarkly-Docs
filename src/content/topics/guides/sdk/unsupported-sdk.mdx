...
<CodeSample>
<CSTab label="GET request">

```bash
curl -X GET https://your-relay-proxy.com:8030/sdk/eval/users/eyJrZXkiOiAiYTAwY2ViIn0= \
  -H "Authorization: sdk-key-123abc"
```

</CSTab>
<CSTab label="REPORT request">

```bash
curl -X REPORT https://your-relay-proxy.com:8030/sdk/eval/user \
...
```bash
curl -X GET https://your-relay-proxy.com:8030/sdk/evalx/users/eyJrZXkiOiAiYTAwY2ViIn0= \
  -H "Authorization: sdk-key-123abc"
```
...
<CodeSample>
<CSTab label="Build SDK microservice">
...
<CodeSample>
<CSTab label="Evaluate a flag for a user">
