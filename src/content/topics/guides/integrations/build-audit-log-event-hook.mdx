...
7. [Creating integration user documentation and README](/integrations/partner-integrations/getting-started#7-create-your-integration-user-documentation-and-readme).
