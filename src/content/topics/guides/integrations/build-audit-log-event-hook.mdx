...
5. [Defining the integration's capabilities](/integrations/partner-integrations/getting-started#5-define-the-integrations-capabilities). 
  - For this integration, define an [`auditLogEventsHook`](https://github.com/launchdarkly/integration-framework/blob/main/docs/capabilities.md#audit-log-events-hook-auditlogeventshook) integration.
...
- If you use OAuth, configured it in the root of the manifest as described in our [OAuth Documentation](https://github.com/launchdarkly/integration-framework/blob/main/docs/capabilities.md#audit-log-events-hook-auditlogeventshook) for additional information.
