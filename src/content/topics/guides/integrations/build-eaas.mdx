...
You can also use the REST API: [Create a LaunchDarkly environment](https://apidocs.launchdarkly.com/tag/Environments#operation/postEnvironment)
...
You can also use the REST API: [Delete a LaunchDarkly environment](https://apidocs.launchdarkly.com/tag/Environments#operation/deleteEnvironment)
