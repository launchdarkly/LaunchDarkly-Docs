...
published: true
tags: ['experimentation', 'mutually exclusive', 'tutorial']
---
...
9. In the **serve** menu, select “a percentage rollout.”
...
You will now have three related flags on your dashboard. Next, you will include the two dependent flags in two separate experiments.
...
For this tutorial, you will create two custom metrics, one for each of your experiments. To learn more, read [Custom metrics](/home/creating-experiments/metrics/custom).
