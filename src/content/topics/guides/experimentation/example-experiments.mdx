...
You will use a click conversion metric to track when customers opt-in to notifications. To learn how to create a click conversion metric, read [Click conversion metrics](/home/creating-experiments/metrics/click).
...
You want to include only customers who have newly downloaded the app. To accomplish this, you can build a rule on your flag to exclude customers that have already made an opt-in decision. To learn how, read [Targeting rules](/home/flags/targeting-rules).
...
You will use a custom conversion metric to track conversions to paid accounts. To learn how to create a custom conversion metric, read [Custom conversion metrics](/home/creating-experiments/metrics/custom-conversion).
...
In this experiment, you do not want to include students who may be using your trial service for school projects, so you will exclude customers with email addresses that end with `.edu`. To accomplish this, you can build a rule on your flag. To learn how, read [Targeting rules](/home/flags/targeting-rules).
