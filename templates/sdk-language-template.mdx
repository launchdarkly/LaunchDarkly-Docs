...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell><a href="GENERATED SDK API DOCS">API docs</a></TableCell>
    </TableRow>
    <TableRow>
      <TableCell>GitHub repository</TableCell>
      <TableCell><a href="https://github.com/launchdarkly/SDK-REPO">SDK-REPO</a></TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Sample application</TableCell>
      <TableCell>LANGUAGE NAME: <a href="https://github.com/launchdarkly/hello-SAMPLE-APP">hello-SAMPLE-APP</a></TableCell>
    </TableRow>
  </TableBody>
</Table>
