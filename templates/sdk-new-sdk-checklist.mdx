...
When someone adds a new SDK to LaunchDarkly, there are quite a few places in the documentation that they need to update. This checklist is for authors and reviewers of the git-gatsby PRs associated with new SDKs, to make sure we've added everything.
...
- [ ] Add a new .svg icon to `/assets/icons/`. Name it with the name of the language for your new SDK.
...
- [ ] Update the "Supported versions" section in the [Versioning policy](https://docs.launchdarkly.com/sdk/concepts/versioning#supported-versions) topic.
...
- [ ] If necessary, update the callout at the end of the "Flag events" section of the [Debugger](https://docs.launchdarkly.com/home/flags/debugger#flag-events) topic to describe the minimum required version of the SDK to use `summary` events.
